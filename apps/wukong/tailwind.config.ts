  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "golden-pulse": { "0%, 100%": { boxShadow: "0 0 20px hsl(45 100% 58% / 0.3)" }, "50%": { boxShadow: "0 0 40px hsl(45 100% 58% / 0.6)" } },
      },
      animation: {
      ...
      fontFamily: { traditional: ["Cinzel", "Georgia", "serif"], mystical: ["Crimson Text", "Georgia", "serif"] },
    },
  },
