  ...
  return (
    <OptionalElement className="absolute top-[1rem] right-4 z-100">
      <div className="relative origin-top-right group">
        <div className="bg-black/60 backdrop-blur-md rounded-3xl border shadow-xl text-white border-white/30 px-2 flex items-center gap-1 p-2">
          Editor Mode
        </div>
            ...
            <div className="space-y-3">
              <div className="flex justify-between space-x-2">
                ...
                <span className="text-white/70">
                  <span className="w-5 h-5 bg-gray-500 p-1 shadow-[2px_2px_white] mr-1 rounded-xs">
                    ⌘
                  </span>{" "}
                  + click (on text)
                </span>
