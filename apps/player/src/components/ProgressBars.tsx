          ...
          >
            <motion.div
              ...
              style={{
                scaleX: chapterX,
                background:
                  "linear-gradient(to right, color-mix(in srgb, var(--bg-content-light, #CD853F) 80%, white), color-mix(in srgb, var(--bg-content-light, #F4A460) 60%, white))",
                opacity: 0.7,
              }}
            />
          </motion.div>
          ...
          >
            <motion.div
              ...
              style={{
                scaleX: furthestX,
                background:
                  "linear-gradient(to right, color-mix(in srgb, var(--bg-content-light, #666666) 30%, white), color-mix(in srgb, var(--bg-content-light, #999999) 50%, white))",
                opacity: 0.3,
              }}
            />
          </motion.div>
          ...
          >
            <motion.div
              ...
              style={{
                scaleX: bookX,
                background:
                  "linear-gradient(to right, color-mix(in srgb, var(--bg-content-light, #A0522D) 80%, white), color-mix(in srgb, var(--bg-content-light, #CD853F) 60%, white))",
                opacity: 0.7,
              }}
            />
          </motion.div>
