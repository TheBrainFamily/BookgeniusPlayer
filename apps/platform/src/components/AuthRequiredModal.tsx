      ...
      <div className="relative max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <Card className="bg-card/95 backdrop-blur border-library-gold/20">
          <CardHeader className="text-center space-y-4">
            ...
            <CardTitle id="auth-modal-title" className="text-2xl font-bold">
              Sign In to Use Reader Assistant
            </CardTitle>
            <p id="auth-modal-desc" className="text-muted-foreground text-base max-w-xl mx-auto">
              You need to be signed in to access the live AI assistant.
            </p>
          </CardHeader>
...
const AuthRequiredModal: React.FC<Props> = ({ onClose }) => {
  ...
  return <AuthRequiredModalInner onClose={onClose} authMod={authMod} />;
};
