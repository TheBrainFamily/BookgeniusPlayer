...
const AuthProviderInner: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [idToken, setIdToken] = useState<string | null>(() => (typeof window !== "undefined" ? sessionStorage.getItem(KEY_ID_TOKEN) : null));
...
const AuthProviderSafe: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  if (import.meta.env.SSR) {
    return <Ctx.Provider value={{ ready: false, isSignedIn: false, openSignIn: () => {}, signOut: () => {} }}>{children}</Ctx.Provider>;
  }
