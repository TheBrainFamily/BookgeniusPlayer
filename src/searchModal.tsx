...
export const renderSearchModal = () => {
  return <div className="modal-overlay search-modal tutej" id="search-modal">
    <div className="modal-content">
      ...
      <div className="modal-body">
        ...
        <div id="search-loader" className="search-loader hidden">
