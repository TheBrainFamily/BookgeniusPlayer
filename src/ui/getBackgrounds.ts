...
export const getBackgrounds = (): Background[] => {
  ...
  if (CURRENT_BOOK === BOOK_SLUGS._1984 || CURRENT_BOOK === BOOK_SLUGS._1984_English) {
    const backgroundsInput = [
      { chapter: 1, startParagraph: 0, file: "1984-chapter-1.mp4" },
      { chapter: 1, startParagraph: 22, file: "chapter_8.mp4" },
      { chapter: 2, startParagraph: 0, file: "1984-chapter-2.mp4" },
      { chapter: 2, startParagraph: 26, file: "1984-chapter-2-2.mp4" },
      { chapter: 3, startParagraph: 0, file: "1984-chapter-3.mp4" },
      { chapter: 4, startParagraph: 0, file: "1984-chapter-4.mp4" },
      { chapter: 4, startParagraph: 13, file: "1984-chapter-4-2.mp4" },
      { chapter: 5, startParagraph: 0, file: "1984-chapter-5.mp4" },
      { chapter: 5, startParagraph: 36, file: "1984-chapter-5-2.mp4" },
      { chapter: 6, startParagraph: 0, file: "1984-chapter-6.mp4" },
      { chapter: 6, startParagraph: 10, file: "1984-chapter-6-2.mp4" },
      { chapter: 7, startParagraph: 0, file: "1984-chapter-7.mp4" },
