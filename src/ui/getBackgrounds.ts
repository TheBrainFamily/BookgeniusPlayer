...
export const getBackgrounds = (): Background[] => {
  ...
  const backgroundsInput = [
    ...
    { chapter: 50, file: "chapter50.mp4" },
    { chapter: 51, file: "chapter51.mp4" },
    { chapter: 52, file: "chapter52.mp4" },
    { chapter: 53, file: "chapter53.mp4" },
    { chapter: 54, file: "chapter54.mp4" },
    { chapter: 55, file: "chapter55.mp4" },
    { chapter: 56, file: "chapter56.mp4" },
    { chapter: 57, file: "chapter57.mp4" },
    { chapter: 58, file: "chapter58.mp4" },
    { chapter: 59, file: "chapter59.mp4" },
    { chapter: 60, file: "chapter60.mp4" },
    { chapter: 61, file: "chapter61.mp4" },
    { chapter: 62, file: "chapter62.mp4" },
    { chapter: 63, file: "chapter63.mp4" },
    { chapter: 64, file: "chapter64.mp4" },
    { chapter: 65, file: "chapter65.mp4" },
    { chapter: 66, file: "chapter66.mp4" },
    { chapter: 67, file: "chapter67.mp4" },
  ];
  ...
  if (CURRENT_BOOK === BOOK_SLUGS._1984) {
    const backgroundsInput = [
      ...
      { chapter: 4, file: "1984-chapter-4.mp4" },
      { chapter: 5, file: "1984-chapter-5.mp4" },
      { chapter: 6, file: "1984-chapter-6.mp4" },
    ];
