...
export function BottomInput({ placeholder = "Type something...", onSubmit, className, onShowDeepResearch }: BottomInputProps) {
  ...
  return (
    <footer
      className={cn(
        "flex flex-row gap-2 justify-center mx-auto px-4 max-w-[120rem] w-full",
    ...
    >
      ...
      <div
        ...
        style={{ "--footer-stop": isFocused ? "rgba(255,255,255,1)" : "rgba(255,255,255,0.4)", padding: "0.5em 2em" } as React.CSSProperties}
      >
        {isCollapsed ? (
          <motion.button
            type="button"
