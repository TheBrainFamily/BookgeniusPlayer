...
export const Chapter19: React.FC = () => {
  return (
    <section data-chapter="19">
      ...
      <p data-index="10">
        Prawie we środku ulicy stał zajazd Fenicjanina z Tyru, <span 
          className="character-highlighted" 
          data-character="Asarhadon" 
          data-src-listening="/Pharaon/asarhadon-listens.mp4"
        >
          Asarhadona
        </span>, w którym dla łatwiejszej kontroli byli obowiązani mieszkać wszyscy przyjeżdżający spoza granic Egiptu. Był to wielki dom kwadratowy, z każdego boku miał po kilkanaście okien i nie stykał się z innymi, więc można było obchodzić go i podglądać ze wszystkich stron. Nad główną bramą wisiał model okrętu, na frontowej ścianie były obrazy przedstawiające jego świątobliwość <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
          Ramzesa XII
        </span>, jak składa bogom ofiary lub roztacza opiekę nad cudzoziemcami, między którymi Fenicjanie odznaczali się dużym wzrostem i mocno czerwoną barwą.
      </p>
      <p data-index="11">
      ...
      <p data-index="14">
        Sam gospodarz zajazdu, sławetny <span 
          className="character-highlighted" 
          data-character="Asarhadon" 
          data-src-listening="/Pharaon/asarhadon-listens.mp4"
        >
          Asarhadon
        </span>, człowiek przeszło pięćdziesięcioletni, szpakowaty, ubrany w długą koszulę i muślinową narzutkę, chodził między gośćmi, aby dojrzeć, czy każdy ma, czego potrzebuje.
      </p>
      <p data-index="15">
        <span 
      ...
      <p data-index="27">
        Przedstawienie ciągnęło się z pół godziny. Gdy psyllowie opuścili dziedziniec, do gospodarza przybiegł Murzyn obsługujący pokoje gościnne i coś szeptał zafrasowany. Potem, nie wiadomo skąd, ukazał się dziesiętnik policyjny i zaprowadziwszy <span 
          className="character-highlighted" 
          data-character="Asarhadon" 
          data-src-listening="/Pharaon/asarhadon-listens.mp4"
        >
          Asarhadona
        </span> do odległej framugi długo z nim rozmawiał, a czcigodny właściciel zajazdu bił się w piersi, załamywał ręce albo chwytał się za głowę. Nareszcie kopnął Murzyna w brzuch, kazał podać dziesiętnikowi gęś pieczoną i dzban cypryjskiego, a sam zbliżył się do gościa z frontowej galerii, który wciąż zdawał się drzemać, choć oczy miał otwarte.
      </p>
      <p data-index="28">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="34">
        ...
        >
          Asarhadon
        </span> zaczął drapać się między łopatki.
      </p>
      <p data-index="35">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="39">
        <span 
          ...
          data-src-talking="/Pharaon/asarhadon-speaks.mp4" 
          data-is-talking="true"
        />\n— Pyta mnie — ciągnął gospodarz — pyta mnie dziesiętnik: „Co za jeden jest ten czarny, który dwie godziny siedzi nad garstką daktylów?…\' Mówię: Bardzo zacny człowiek, pan <span 
          className="character-highlighted" 
          data-character="Phut-Beroes" 
          data-src-listening="/Pharaon/phut-beroes-listens.mp4"
        >
          Phut
        </span>. — „Skąd on?…\' — Z kraju Chetii, z miasta Harranu; ma tam porządny dom o trzech piętrach i dużo pola. — „Po co on tu przyjechał?\' — Przyjechał, mówię, odebrać od jednego kapłana pięć talentów, które jeszcze jego ojciec pożyczył.
      </p>
      <p data-index="40">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/asarhadon-speaks.mp4" 
          data-is-talking="true"
        />\nA wiesz, zacny panie — prawił restaurator — co mi na to odpowiedział dziesiętnik?… Te słowa: „<span 
          className="character-highlighted" 
          data-character="Asarhadon" 
          data-src-listening="/Pharaon/asarhadon-listens.mp4"
        >
          Asarhadonie
        </span>, wiem, że jesteś wiernym sługą jego świątobliwości faraona, masz dobre jadło i niefałszowane wina, dlatego mówię ci — strzeż się!… Strzeż się cudzoziemców, którzy nie robią znajomości, unikają wina i wszelkich uciech i milczą. Ten <span 
          className="character-highlighted" 
          data-character="Phut-Beroes" 
          data-src-listening="/Pharaon/phut-beroes-listens.mp4"
        >
          Phut
        </span>, harrańczyk, może być asyryjskim szpiegiem.\'
      </p>
      <p data-index="41">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="42">
        ...
        >
          Asarhadonie
        </span> — rzekł po chwili gość — powierzyłem ci siebie i mój majątek. Pomyśl więc, aby mi oddano wory i skrzynię, gdyż w przeciwnym razie zaskarżę cię do tego samego dziesiętnika, który zjada gęś przeznaczoną dla ciebie.
      </p>
      <p data-index="43">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="48">
        ...
        >
          Asarhadonie
        </span>, i proś bogów, ażeby ci rozum przywrócili — odparł podróżny, zawsze z tym samym spokojem.
      </p>
      <p data-index="49">
      ...
      <p data-index="55">
        Gdy weszła do frontowej galerii, harrańczyk <span 
          className="character-highlighted" 
          data-character="Phut-Beroes" 
          data-src-listening="/Pharaon/phut-beroes-listens.mp4"
        >
          Phut
        </span> sięgnął do skórzanego worka i wydobył złoty pierścień mówiąc:
      </p>
      <p data-index="56">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="67">
        \n— Tylko strzeż się złodziei, którzy czyhają na twój majątek — zakończyła, widząc, że zacny <span 
          className="character-highlighted" 
          data-character="Asarhadon" 
          data-src-listening="/Pharaon/asarhadon-listens.mp4"
        >
      ...
      <p data-index="70">
        ...
        >
          Asarhadon
        </span> splunął po trzykroć i cicho odmówił zaklęcie przeciw złym wróżbom. Gdy zaś odsunął się w głąb galerii, kapłanka zaczęła kokietować harrańczyka. Dała mu różę ze swego wieńca, na pożegnanie uścisnęła go i poszła do innych stołów.
      </p>
      <p data-index="71">
      ...
      <p data-index="73">
        ...
        >
          Asarhadon
        </span> popatrzył mu w oczy, klasnął w ręce i wybuchnął śmiechem.
      </p>
      <p data-index="74">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="75">
        <span 
          ...
          data-src-talking="/Pharaon/phut-beroes-speaks.mp4" 
          data-is-talking="true"
        />\n— W takim razie ja pójdę do niej — odparł <span 
          className="character-highlighted" 
          data-character="Phut-Beroes" 
          data-src-listening="/Pharaon/phut-beroes-listens.mp4"
        >
          Phut
        </span>. — Albowiem jest to mądra i pobożna niewiasta i poradzi mi w wielu zdarzeniach. Po zachodzie słońca dasz mi przewodnika, ażebym idąc nie zbłąkał się.
      </p>
      <p data-index="76">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="77">
        <span 
          ...
          data-src-talking="/Pharaon/phut-beroes-speaks.mp4" 
          data-is-talking="true"
        />\n— A czy twoja córka pojedzie ze mną do Harranu? — spytał <span 
          className="character-highlighted" 
          data-character="Phut-Beroes" 
          data-src-listening="/Pharaon/phut-beroes-listens.mp4"
        >
      ...
      <p data-index="80">
        <span 
          ...
          data-src-talking="/Pharaon/phut-beroes-speaks.mp4" 
          data-is-talking="true"
        />\n— W takim razie opowiesz mi drogę do domu tej kapłanki — odparł <span 
          className="character-highlighted" 
          data-character="Phut-Beroes" 
          data-src-listening="/Pharaon/phut-beroes-listens.mp4"
        >
          Phut
        </span>. — Pamiętaj, ażebym po zachodzie słońca miał przewodnika, a jutro moje worki i skrzynię, bo inaczej poskarżę się do sądu.
      </p>
      <p data-index="81">
        ...
        >
          Phut
        </span> opuścił restaurację i poszedł do swego pokoju na górę.
      </p>
      <p data-index="82">
        Wściekły z gniewu <span 
          className="character-highlighted" 
          data-character="Asarhadon" 
          data-src-listening="/Pharaon/asarhadon-listens.mp4"
        >
          Asarhadon
        </span> zbliżył się do stolika, przy którym pili kupcy feniccy, i odwołał na stronę jednego z nich, Kusza.
      </p>
      <p data-index="83">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/asarhadon-speaks.mp4" 
          data-is-talking="true"
        />\n— Pięknych gości dajesz mi pod opiekę!… — rzekł gospodarz, nie mogąc pohamować drżenia głosu. — Ten <span 
          className="character-highlighted" 
          data-character="Phut-Beroes" 
          data-src-listening="/Pharaon/phut-beroes-listens.mp4"
        >
          Phut
        </span> prawie nic nie jada, każe mi wykupować od złodziei rzeczy, które mu skradziono, a teraz, jakby na urąganie z mego domu, wybiera się do egipskiej tancerki, zamiast obdarować moje kobiety.
      </p>
      <p data-index="84">
      ...
      <p data-index="86">
        ...
        >
          Asarhadonie
        </span>, wyglądasz jak arcykapłan, a jesteś tylko szynkarzem! Ława nie przestaje być ławą, choć ma na sobie lwią skórę.
      </p>
      <p data-index="87">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="88">
        \n— Złość i chciwość zamroczyły twój umysł — odrzekł z powagą Kusz. — Jesteś jak człowiek, który szukając dyni na figowym drzewie, nie widzi figi. Dla każdego kupca jest jasne, że jeżeli <span 
          className="character-highlighted" 
          data-character="Phut-Beroes" 
          data-src-listening="/Pharaon/phut-beroes-listens.mp4"
        >
          Phut
        </span> ma odebrać pięć talentów od kapłana, to musi skarbić sobie łaski u wszystkich, którzy kręcą się przy świątyniach. Ale ty już nic nie rozumiesz…
      </p>
      <p data-index="89">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="90">
        Kusz z pogardą patrzył na <span 
          className="character-highlighted" 
          data-character="Asarhadon" 
          data-src-listening="/Pharaon/asarhadon-listens.mp4"
        >
