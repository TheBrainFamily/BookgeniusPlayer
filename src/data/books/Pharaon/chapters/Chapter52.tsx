...
export const Chapter52: React.FC = () => {
  return (
    <section data-chapter="52">
      ...
      <p data-index="3">
        <span className="character-placeholder character-talking" data-character="Pentuer" data-src-talking="/Pharaon/pentuer-speaks.mp4" data-is-talking="true" />— Żyj wiecznie,
        wasza świątobliwość — odparł kapłan. — Nie ma w Egipcie człowieka, który nie poświęciłby się za ciebie i nie błogosławił twego imienia.
      </p>
      <p data-index="4">
      ...
      <p data-index="8">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />—
        Mianowałem cię naczelnikiem rady, która ma wyśledzić przyczyny nieustannych buntów w moim państwie. Chcę, ażeby karano tylko winnych, a czyniono sprawiedliwość
        nieszczęśliwym…
      </p>
      <p data-index="9">
        ...
        wspiera cię łaską swoją!… — szepnął kapłan. — Zrobię, panie, co każesz. Ale powody buntów znam i bez śledztwa…
      </p>
      <p data-index="10">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />—
        Powiedz.
      ...
      <p data-index="11">
        <span className="character-placeholder character-talking" data-character="Pentuer" data-src-talking="/Pharaon/pentuer-speaks.mp4" data-is-talking="true" />— Nieraz o tym
        mówiłem waszej świątobliwości: lud pracujący jest głodny, ma za dużo roboty i płaci za wielkie podatki. Kto dawniej robił od wschodu do zachodu słońca, dziś musi zaczynać
        na godzinę przed wschodem, a kończyć w godzinę po zachodzie. Nie tak dawno co dziesiąty dzień prosty człowiek mógł odwiedzać groby matki i ojca, rozmawiać z ich cieniami i
        składać ofiary. Ale dziś nikt tam nie chodzi, bo nie ma czasu.
      </p>
      <p data-index="12">
        Dawniej chłop zjadał w ciągu dnia trzy placki pszenne, dziś nie stać go na jęczmienny. Dawniej roboty przy kanałach, groblach i gościńcach liczyły się między podatkami;
        dziś podatki trzeba płacić swoją drogą, a roboty publiczne wykonywać darmo.
      </p>
      <p data-index="13">Oto przyczyny buntów.</p>
      <p data-index="14">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />—
      ...
      <p data-index="15">Więc co mam robić, powiedz, ty, który prosiłeś mnie, abym poprawił los chłopów?…</p>
      <p data-index="16">
        <span className="character-placeholder character-talking" data-character="Pentuer" data-src-talking="/Pharaon/pentuer-speaks.mp4" data-is-talking="true" />— Rozkazujesz,
        panie, abym powiedział?…
      </p>
      <p data-index="17">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />—
      ...
      <p data-index="18">
        <span className="character-placeholder character-talking" data-character="Pentuer" data-src-talking="/Pharaon/pentuer-speaks.mp4" data-is-talking="true" />— Błogosławione
        niech będą twoje rządy, prawdziwy synu Ozyrysa! — odparł kapłan. — A oto co czynić należy…
      </p>
      <p data-index="19">Przede wszystkim rozkaż, panie, aby płacono za roboty publiczne, jak było dawniej…</p>
      <p data-index="20">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />—
        Rozumie się.
      </p>
      <p data-index="21">
        <span className="character-placeholder character-talking" data-character="Pentuer" data-src-talking="/Pharaon/pentuer-speaks.mp4" data-is-talking="true" />— Dalej —
        zapowiedz, ażeby praca rolna trwała tylko od wschodu do zachodu słońca… Potem spraw, jak było za dynastii boskich, ażeby lud wypoczywał co siódmy dzień; nie co dziesiąty,
        ale co siódmy. Potem nakaż, aby panowie nie mieli prawa zastawiać chłopów, a pisarze bić i dręczyć ich według swego upodobania.
      </p>
      <p data-index="22">
        A nareszcie daj — dziesiątą lub choćby dwudziestą część ziemi chłopom na własność, aby nikt jej odebrać ani zastawiać nie mógł. Niechaj rodzina chłopa ma choćby tyle ziemi,
        co podłoga tej komnaty, a już nie będzie głodna. Daj, panie, chłopom pustynne piaski na własność, a w kilka lat wyrosną tam ogrody…
      </p>
      <p data-index="23">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />—
      ...
      <p data-index="26">
        Gdy chłopu leniwemu i chudemu dawano dobre jadło i odpoczynek co siódmy dzień, człowiek ten robił się tłustym, chętnym do pracy i więcej skopywał pola niż dawniej. Robotnik
        płatny jest weselszy i więcej wykonywa
        <a href="#fn23" className="link-note">
          [23]
        </a>{" "}
        roboty aniżeli niewolnik, choćby go bić żelaznymi prętami. Ludziom sytym rodzi się więcej dzieci niż głodnym i spracowanym; potomstwo ludzi wolnych jest zdrowe i silne, a
        niewolników — wątłe, ponure i skłonne do kradzieży i kłamstwa.
      </p>
      <p data-index="27">
        Przekonano się wreszcie, że ziemia, którą uprawia jej właściciel, daje półtora raza więcej ziarn
        <a href="#fn24" className="link-note">
          [24]
        </a>{" "}
        i jarzyn niż ziemia obsługiwana przez niewolników.
      </p>
      <p data-index="28">Ciekawszą rzecz powiem waszej świątobliwości: gdy oraczom przygrywa muzyka, ludzie i woły robią lepiej, prędzej i mniej męczą się aniżeli bez muzyki.</p>
      ...
      <p data-index="31">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />—
        Muszę ja na moich folwarkach i w kopalniach zaprowadzić muzykę — rzekł. — Jeżeli jednak kapłani przekonali się o takich dziwach, jakie mi opowiadasz, to dlaczego w swoich
      ...
      <p data-index="33">
        <span className="character-placeholder character-talking" data-character="Pentuer" data-src-talking="/Pharaon/pentuer-speaks.mp4" data-is-talking="true" />— Bo — odparł
        wzdychając — nie wszyscy kapłani są mędrcami i mają serca szlachetne…
      </p>
      <p data-index="34">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />—
        Otóż to!… — zawołał{" "}
      ...
      <p data-index="35">
        A teraz powiedz mi, ty, który jesteś synem chłopów i wiesz, że między kapłanami znajdują się hultaje i głupcy, powiedz: dlaczego nie chcesz mi służyć w walce przeciw nim?…
        Bo przecie rozumiesz, że ja nie poprawię losu chłopskiego, jeżeli pierwej nie nauczę kapłanów posłuszeństwa dla mojej woli…
      </p>
      <p data-index="36">
        <span className="character-highlighted" data-character="Pentuer" data-src-listening="/Pharaon/pentuer-listens.mp4">
          Pentuer
      ...
      <p data-index="40">
        <span className="character-placeholder character-talking" data-character="Pentuer" data-src-talking="/Pharaon/pentuer-speaks.mp4" data-is-talking="true" />— Od trzydziestu
        tysięcy lat święty stan kapłański pielęgnuje Egipt i on zrobił kraj tym, czym jest dziś: dziwem dla całego świata. A dlaczego kapłanom, pomimo ich wad, udało się tak
        zrobić?… Gdyż oni są kagańcem, w którym płonie światło mądrości.
      </p>
      <p data-index="41">Kaganiec może być brudny, nawet śmierdzący, niemniej jednak przechowuje boski ogień, bez którego między ludźmi panowałaby ciemność i dzikość.</p>
      <p data-index="42">
      ...
      <p data-index="43">
        Oto, panie mój, powody, dla których nie chcę mieszać się do twej walki ze świętym stanem kapłańskim… Czuję, że ona się zbliża, i cierpię, że taki robak, jakim jestem, nie
        mogę jej zapobiec. Ale wdawać się w nią nie będę, bo musiałbym zdradzić albo ciebie, albo Boga, który jest twórcą mądrości…
      </p>
      <p data-index="44">
        Słuchając tego,{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
      ...
      <p data-index="45">
        ...
        — rzekł bez gniewu — czyń, jak chcesz. Nie jesteś żołnierzem, więc nie mogę wyrzucać ci braku odwagi… Nie możesz być jednak moim doradcą… Choć proszę cię, abyś utworzył sąd
        do rozpatrzenia chłopskich buntów i gdy cię wezwę, mówił, co nakazuje mądrość.
      </p>
      <p data-index="46">
        <span className="character-highlighted" data-character="Pentuer" data-src-listening="/Pharaon/pentuer-listens.mp4">
          Pentuer
      ...
      <p data-index="49">Możesz odejść.</p>
      ...
      <p data-index="70">
        <span className="character-placeholder character-talking" data-character="Ramzes-XII" data-src-talking="/Pharaon/ramzes-xii-speaks.mp4" data-is-talking="true" />— Ja
        jestem, ja… Czyliżbyś już o mnie zapomniał?…
      </p>
      <p data-index="71">
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          Władca
      ...
      <p data-index="72">
        <span className="character-placeholder character-talking" data-character="Ramzes-XII" data-src-talking="/Pharaon/ramzes-xii-speaks.mp4" data-is-talking="true" />— Synu mój
        — mówił znowu głos — szanuj wolę bogów, jeżeli chcesz otrzymać ich błogosławioną pomoc… O, szanuj bogów, gdyż bez ich pomocy największa potęga ziemska jest jako proch i
        cień… O, szanuj bogów, jeżeli chcesz, ażeby gorycz twoich błędów nie zatruła mi pobytu w szczęśliwej krainie Zachodu…
      </p>
      <p data-index="73">
        Głos umilkł,{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
      ...
      <p data-index="82">
        <span className="character-placeholder character-talking" data-character="Kaplan-astrolog" data-src-talking="/Pharaon/kaplan-astrolog.png" data-is-talking="true" />— Wasza
        świątobliwość — spytał — raczy zrzekać się wskazówek, jakie władcom dają gwiazdy?…
      </p>
      <p data-index="83">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />—
        Dają? — powtórzył{" "}
      ...
      <p data-index="87">Kapłan opuścił sypialnię, potrząsając głową.</p>
      <p data-index="88">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />—
      ...
      <p data-index="92">
        ...
        w sali złotej. Sądził, że tam nikt nie podsłucha ich rozmowy.
      </p>
      <p data-index="93">
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          Pan
      ...
      <p data-index="95">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />— Czy
        zdarzyło się coś ważnego, matko, że trudzisz się o tej godzinie? — spytał.
      </p>
      <p data-index="96">
        <span className="character-placeholder character-talking" data-character="Nikotris" data-src-talking="/Pharaon/nikotris-speaks.mp4" data-is-talking="true" />— Nie spałam…
        modliłam się… — odparła. — O synu mój, mądrze odgadłeś, że sprawa jest ważną!… Słyszałam boski głos twego ojca…
      </p>
      <p data-index="97">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />—
        Doprawdy? — rzekł{" "}
      ...
      <p data-index="103">
        <span className="character-placeholder character-talking" data-character="Nikotris" data-src-talking="/Pharaon/nikotris-speaks.mp4" data-is-talking="true" />— Więc ty nie
        wierzysz, że duch ojca daje ci rady? — spytała coraz bardziej przerażona.
      </p>
      <p data-index="104">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />— Nie
        wiem. Ale mam prawo przypuszczać, że te głosy duchów, rozlegające się w różnych kątach naszego pałacu, są jakimś figlem kapłańskim. Tylko kapłani mogą lękać się mnie, nigdy
        bogowie i duchy… Więc nie duchy straszą nas, matko…
      </p>
      <p data-index="105">
        <span className="character-highlighted" data-character="Nikotris" data-src-listening="/Pharaon/nikotris-listens.mp4">
          Królowa
      ...
      <p data-index="107">
        ...
        oni mi na co?… Czy ażeby moja kuchnia i piwnica miały duże rozchody?… Czy może na to, ażeby słuchali, co mówię, i patrzyli, co robię?…
      </p>
      <p data-index="108">
      ...
      <p data-index="111">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />—
        Wszystko jedno, czyj wpływ; dość, że Egipt już nie uważa ani posągów, ani kapłanów za istoty nadludzkie… A gdybyś jeszcze, matko, posłuchała szlachty, oficerów, żołnierzy,
        zrozumiałabyś, że nadszedł czas postawienia władzy królewskiej na miejscu kapłańskiej, jeżeli wszelka władza nie ma upaść w tym kraju.
      </p>
      <p data-index="112">
      ...
      <p data-index="114">
        Już jasno widział, że między nim i kapłanami rozpoczęła się walka, a raczej coś wstrętnego, co nawet nie zasługiwało na nazwę walki i z czym on, wódz, w pierwszej chwili
