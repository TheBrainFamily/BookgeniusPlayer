...
export const Chapter57: React.FC = () => {
  return (
    <section data-chapter="57">
      ...
      <p data-index="2">
        Po obu brzegach rzeki, na tle zielonych pól, ciągnęły się nieprzerwanym szeregiem gliniane chłopskie chaty, ligowe gaje, bukiety palm. Co godzinę ukazywała się grupa
        białych domów jakiegoś miasteczka albo większe miasto z kolorowymi budowlami, z ogromnymi pylonami świątyń.
      </p>
      <p data-index="3">
        Od zachodu ściana gór libijskich rysowała się niezbyt wyraźnie; za to od wschodu pasmo arabskie coraz bardziej zbliżało się do rzeki. I można było widzieć strome,
        poszarpane skały barwy ciemnej, żółtej lub różowej przypominające kształtami zwaliska fortec czy świątyń zbudowanych przez olbrzymów.
      </p>
      <p data-index="4">
        Na środku Nilu spotykano wysepki, które jakby wczoraj wynurzyły się spod wody, a już dziś zostały pokryte bujną roślinnością i zamieszkałe przez niezliczone stada ptaków.
        Kiedy nadpływał burzliwy orszak faraona, wystraszone ptaki zrywały się i krążąc nad statkami, łączyły swoje krzyki z potężnym głosem ludu. Nad tym wszystkim unosiło się
        przeczyste niebo i światło tak pełne życia, że w jego powodzi czarna ziemia nabierała blasku, a kamienie barw tęczowych.
      </p>
      <p data-index="5">
        Schodził więc faraonowi czas wesoło. Z początku trochę drażniły go nieustanne krzyki, lecz później tak przywykł do nich, że już nie zwracał uwagi. Mógł odczytywać dokumenta
        <a href="#fn73" className="link-note">
          [73]
        </a>
      ...
      <p data-index="6">
        ...
        <a href="#fn74" className="link-note">
          [74]
        </a>
        , w którym{" "}
      ...
      <p data-index="7">
        Siut było jednym z bogatszych miast Górnego Egiptu. Tu wyrabiano słynne naczynia z białej i czarnej gliny i tkano płótna; tu było główne targowisko, na które przywożono
        towary z oaz rozrzuconych w pustyni. Tu wreszcie była sławna świątynia Anubisa, bożka z wilczą głową.
      </p>
      <p data-index="8">
      ...
      <p data-index="11">
        ...
        , które wydarła mu pustynia. Chcę, ażeby człowiek pracowity odpoczywał co siódmy dzień i ażeby każdy rolnik posiadał kawałek ziemi na własność…
      </p>
      <p data-index="12">
        <span className="character-highlighted" data-character="Pentuer" data-src-listening="/Pharaon/pentuer-listens.mp4">
          Pentuer{" "}
      ...
      <p data-index="23">
        ...
        <a href="#fn77" className="link-note">
          [77]
        </a>{" "}
        państwa.
      </p>
      ...
      <p data-index="28">
        O piętnaście mil od Siutu, w górę rzeki, dzikie skały arabskie prawie dotykają Nilu; natomiast góry libijskie odsunęły się od niego tak daleko, że tamtejsza dolina jest
        bodaj najszerszą w Egipcie.
      </p>
      <p data-index="29">
        W tym właśnie miejscu, tuż obok siebie, stały dwa czcigodne miasta: Tinis
        <a href="#fn78" className="link-note">
          [78]
        </a>{" "}
        i Abydos. Tam urodził się Menes, pierwszy faraon Egiptu; tam przed stoma tysiącami lat złożono do grobu święte zwłoki bożka Ozyrysa, którego w zdradziecki sposób zamordował
        brat Tyfon.
      </p>
      <p data-index="30">
        Tam wreszcie na pamiątkę owych wielkich wydarzeń wiekopomny faraon Seti
        <a href="#fn79" className="link-note">
          [79]
        </a>{" "}
        wybudował świątynię, do której zbiegali się pielgrzymi z całego Egiptu. Każdy prawowierny musiał choć raz w życiu dotknąć czołem tej błogosławionej ziemi. Prawdziwie zaś
        szczęśliwym był ten, czyja mumia mogła odbyć podróż do Abydos i choć z daleka zatrzymać się pod murami świątyni.
      </p>
      <p data-index="31">
        Mumia{" "}
      ...
      <p data-index="33">
        Grunta należące do świątyni zajmowały przestrzeń stu pięćdziesięciu morgów, na których były rybne sadzawki, ogrody kwiatowe, owocowe i warzywne, wreszcie domy, a raczej
        pałacyki kapłanów. Wszędzie rosły: palmy, figi, pomarańcze, topole, akacje, które tworzyły albo aleje idące w kierunku głównych okolic świata, albo łany drzew sadzonych
        regularnie i mających prawie jednakową wysokość.
      </p>
      <p data-index="34">
        Nawet świat roślinny, pod bacznym okiem kapłanów, nie rozwijał się według własnego popędu tworząc nieprawidłowe, ale malownicze skupienia; nawet on szykował się według
        linii prostych, linii równoległych albo skupiał się w geometryczne figury.
      </p>
      <p data-index="35">
        Palmy, tamaryndusy, cyprysy i mirty byli to żołnierze uszykowani szeregami lub kolumnami. Trawa był to dywan strzyżony i ozdobiony malowidłami z kwiatów, nie byle jakiej
        barwy, ale tej, która była potrzebna. Lud, z góry przypatrując się gazonom świątyń, widział na nich kwitnące obrazy bogów lub świętych zwierząt; mędrzec znajdował aforyzmy
        wypisane hieroglifami.
      </p>
      <p data-index="36">
        Środkową część ogrodów zajmował prostokąt na dziewięćset kroków długi a trzysta szeroki. Prostokąt ten był zamknięty niezbyt wysokim murem, który posiadał jedną bramę
        widoczną i kilkanaście ukrytych furtek. Przez tę bramę lud pobożny wchodził na dziedziniec otaczający przybytek Ozyrysa.
      </p>
      <p data-index="37">
        Dopiero na środku dziedzińca, który był wyłożony kamienną posadzką, stała świątynia: gmach prostokątny o czterystu pięćdziesięciu krokach długości i stu pięćdziesięciu
        szerokości.
      </p>
      <p data-index="38">
        Od bramy ludowej do świątyni prowadziła aleja sfinksów ze lwimi ciałami i ludzkimi głowami. Stały one w dwu szeregach, po dziesięciu w każdym, i patrzyły sobie w oczy.
        Między nimi przechodzić mogli tylko najwyżsi dostojnicy.
      </p>
      <p data-index="39">
        W końcu alei sfinksów, ciągle naprzeciw bramy ludowej, wznosiły się dwa obeliski, czyli cienkie a wysokie kolumny czworoboczne z granitu, na których wypisano historię
        faraona Seti.
      </p>
      <p data-index="40">
        Dopiero za obeliskami wznosiła się potężna brama świątyni mająca z obu boków olbrzymie gmachy w kształcie piramid ściętych, zwanych <strong>pylonami</strong>. Były to jakby
        dwie wieże barczyste, na których ścianach znajdowały się malowidła przedstawiające zwycięstwa Setiego albo ofiary, jakie składał bogom.
      </p>
      <p data-index="41">
        Tej bramy już nie wolno było przekraczać chłopom, tylko bogatemu mieszczaństwu i klasom uprzywilejowanym. Przez nią wchodziło się do <strong>perystylu</strong>, czyli
        dziedzińca otoczonego korytarzem wspartym na mnóstwie kolumn. Perystyl mógł pomieścić z dziesięć tysięcy pobożnych.
      </p>
      <p data-index="42">
      ...
      <p data-index="44">
        ...
        naczyniami i klejnotami bożka, który w swym niedostępnym ukryciu spał, kąpał się, namaszczał perfumami, jadał i pijał, a zdaje się, że nawet przyjmował odwiedziny młodych i
        ładnych kobiet.
      </p>
      <p data-index="45">Do sanktuarium wchodził tylko arcykapłan i panujący faraon, o ile otrzymał święcenia. Zwykły śmiertelnik, dostawszy się tam, mógł stracić życie.</p>
      <p data-index="46">
      ...
      <p data-index="49">
        Gdziekolwiek spojrzał: na pola, na rzekę, na dachy domów, nawet na konary fig i tamaryndusów, wszędzie tłoczyła się ciżba ludu i rozlegał się nie milknący okrzyk podobny do
        ryku burzy.
      </p>
      <p data-index="50">
        Dojechawszy do świątyni, faraon zatrzymał konie i wysiadł przed bramą ludową, co bardzo podobało się pospólstwu, a ucieszyło kapłanów. Piechotą przeszedł aleje sfinksów i
        powitany przez świętych mężów spalił kadzidło przed posągami Seti siedzącymi z obu stron bramy wielkiej.
      </p>
      <p data-index="51">
      ...
      <p data-index="58">
        W pół godziny, przy ogłuszającym dźwięku dzwonków, ukazała się w mroku komnaty złota łódź, okryta zasłonami, które niekiedy poruszały się, jakby za nimi siedziała żywa
        istota.
      </p>
      <p data-index="59">
      ...
      <p data-index="61">
        Rozpoczęła się procesja, ale tylko po wewnętrznej świątyni. Naprzód szli harfiarze i tancerki, potem biały wół ze złotą tarczą między rogami. Dalej dwa chóry kapłanów i
        arcykapłani niosący bożka, potem znowu chóry i nareszcie faraon w lektyce dźwiganej przez ośmiu kapłanów.
      </p>
      <p data-index="62">
      ...
      <p data-index="65">
        ...
        dziecko niepodobne do żadnego z egipskich? ani skąd ta nadludzka mądrość w jego oczach? ani — co to wszystko oznacza?…
      </p>
      <p data-index="66">Nagle przyszedł mu na myśl jego zamordowany synek, który mógł być równie pięknym, i władca Egiptu wobec stu tysięcy poddanych — rozpłakał się.</p>
      <p data-index="67">— Nawrócony!… nawrócony faraon!… — mówili kapłani. — Ledwie wstąpił do przybytku Ozyrysa, i oto poruszyło się jego serce!…</p>
      <p data-index="68">
        Tego samego dnia jeden ślepy i dwóch paralityków modlących się za murem świątyni odzyskało zdrowie. Więc rada kapłańska uchwaliła, ażeby dzień ten zaliczyć do rzędu
        cudownych i na zewnętrznej ścianie gmachu wymalować obraz przedstawiający zapłakanego faraona i uzdrowionych kaleków.
      </p>
      <p data-index="69">
        Dobrze po południu{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
      ...
      <p data-index="95">
        ...
        i wciąż biorę kije z polecenia bogobojnych kapłanów.
      </p>
      <p data-index="96">I za co dzieje mi się taka krzywda?</p>
      <p data-index="97">
        „W dzień obracam serce moje do książek, a w nocy czytam; bo głupiec, który opuszcza książki tak prędko jak uciekająca gazela, jest podłego umysłu, równy osłowi
        <a href="#fn83" className="link-note">
          [83]
        </a>
      ...
      <p data-index="99">
        ...
        milczę, bo wiem, że głuchymi jesteśmy dla tych, którzy wielu słów używają.
      </p>
      <p data-index="100">
        Mądrość uczy, że ciało człowieka podobne jest do spichrza, pełne rozmaitych odpowiedzi. Dlatego zawsze wybieram dobrą i mówię dobrą, a złą chowam zamkniętą w ciele moim.
        Cudzych też oszczerstw nie powtarzam, a już co się tyczy poselstwa, zawsze spełniam je jak najlepiej…
      ...
      <p data-index="162">
        ...
        świątynia. Oglądałem podziemne rzeki i jeziora, gmachy z kryształów, jaskinie zupełnie ciemne, w których nie było widać własnej ręki, albo znowu tak widne, jakby w nich
        świeciło drugie słońce…
      </p>
      <p data-index="163">
        Ile razy zbłąkałem się w niezliczonych przejściach, ile razy zgasła mi pochodnia, ile razy stoczyłem się w niewidzialną przepaść!… Bywało, żem po kilka dni spędzał w
        podziemiach, karmiąc się prażonym jęczmieniem, liżąc wilgoć z mokrych skał, niepewny, czy wrócę na świat.
      </p>
      <p data-index="164">
        Za to nabrałem doświadczenia, wzrok zaostrzył mi się i nawet polubiłem te piekielne krainy. A dziś, gdy pomyślę o dziecinnych skrytkach Labiryntu, śmiać mi się chce… Gmachy
        ludzkie są kretowiskami wobec niezmiernych budowli wzniesionych przez ciche i niewidzialne duchy ziemi.
      </p>
      <p data-index="165">Raz jednak spotkałem rzecz straszną, która wpłynęła na zmianę mego stanowiska.</p>
      <p data-index="166">
        Na zachód od kopalni Synaj leży węzeł wąwozów i gór, wśród których często odzywają się podziemne grzmoty, ziemia drży, a niekiedy widać płomienie. Zaciekawiony, wybrałem
        się tam na czas dłuższy, szukałem i dzięki niepozornej szczelinie odkryłem cały łańcuch olbrzymich pieczar, pod których sklepieniami mogłaby pomieścić się największa
        piramida.
      </p>
      <p data-index="167">
        Kiedy się tam błąkałem, doleciał mnie bardzo silny zapach zgnilizny, tak przykry, że chciałem uciec. Przemógłszy się jednak, wszedłem do pieczary, skąd pochodził, i
        zobaczyłem…
      </p>
      <p data-index="168">
        Racz wyobrazić sobie, panie, człowieka, który ma nogi i ręce o połowę krótsze niż my, ale grube, niezgrabne i zakończone pazurami. Dodaj temu kształtowi szeroki, z boków
        spłaszczony ogon, na wierzchu powycinany jak grzebień koguci; dodaj bardzo długą szyję, a na niej — psią głowę. Nareszcie ubierz tego potwora w zbroję pokrytą na grzbiecie
        zagiętymi kolcami…
      </p>
      ...
      <p data-index="178">
        Wówczas nawróciłem się do Seta, a przyjechawszy do Egiptu, osiadłem w jego świątyni. Gdym zaś opowiedział kapłanom o moim odkryciu, objaśnili mnie, że znają nierównie
      ...
      <p data-index="184">
        ...
        walczyć maczugami i kamieniami. Wówczas nie było koni ani wołów; ale słonie, nosorożce i lwy — trzy lub cztery razy przechodziły wzrostem dzisiejsze zwierzęta mające tę
        samą postać.
      </p>
      <p data-index="185">
        Lecz i olbrzymie słonie nie są najstarszymi potworami. Dawniej bowiem od nich żyły niezmierne gady: latające, pływające i chodzące. Przed gadami na tym świecie były tylko
        ślimaki i ryby, a przed nimi — same rośliny, ale takie, jakich dziś już nie ma
        <a href="#fn85" className="link-note">
          [85]
        </a>
        …
      </p>
      ...
      <p data-index="195">
        Jednych straszy ciemność, którą ja lubię, a nawet widzę wśród niej. Inni nie potrafią kierować się pomiędzy licznymi komnatami i kurytarzami
        <a href="#fn87" className="link-note">
          [87]
        </a>
        , ja robię to z łatwością. Jeszcze inni nie znają tajemnic otwierania drzwi utajonych, z czym ja jestem obeznany.
      </p>
      <p data-index="196">
        Gdybym nic więcej nie posiadał nad to, co wyliczyłem, już w ciągu miesiąca lub dwu odkryłbym drogi w Labiryncie. Ale ja mam jeszcze plan szczegółowy tych przejść i znam
