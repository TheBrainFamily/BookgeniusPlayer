...
export const Chapter57: React.FC = () => {
  return (
    <section data-chapter="57">
      ...
      <p data-index="5">
        Schodził więc faraonowi czas wesoło. Z początku trochę drażniły go nieustanne krzyki, lecz później tak przywykł do nich, że już nie zwracał uwagi. Mógł odczytywać dokumenta<a href="#fn73" className="link-note">[73]</a>, naradzać się, nawet spać.
      </p>
      <p data-index="6">
        O trzydzieści do czterdziestu mil od Piom, na lewym brzegu Nilu leżało duże miasto Siut<a href="#fn74" className="link-note">[74]</a>, w którym <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes XIII
        </span> parę dni odpoczął. Wypadało nawet zatrzymać się, gdyż mumia zmarłego króla jeszcze przebywała w Abydos, gdzie przy grobie Ozyrysa odprawiano uroczyste modły.
      </p>
      <p data-index="7">
      ...
      <p data-index="8">
        Drugiego dnia pobytu w tym miejscu zgłosił się do jego świątobliwości kapłan <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
          Pentuer
        </span>, naczelnik komisji badającej położenie ludu.
      </p>
      <p data-index="9">
        <span 
      ...
      <p data-index="11">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n    — Chcę — odparł faraon — ażeby moi poddani byli szczęśliwi, a lud odetchnął. Chcę, ażeby Egipt miał, jak niegdyś, osiem milionów ludności i odzyskał grunta<a href="#fn75" className="link-note">[75]</a>, które wydarła mu pustynia. Chcę, ażeby człowiek pracowity odpoczywał co siódmy dzień i ażeby każdy rolnik posiadał kawałek ziemi na własność…
      </p>
      <p data-index="12">
        <span 
          className="character-highlighted" 
        ...
        >
          Pentuer
        </span> upadł na twarz przed dobrotliwym panem.
      </p>
      <p data-index="13">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n    — Podnieś się — mówił <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span>. — Powiem ci jednak, że miałem godziny ciężkiego smutku. Widzę bowiem niedolę mego ludu, pragnę go podźwignąć, a jednocześnie donoszą mi, że skarb jest pusty. Sam zaś wiesz najlepiej, że nie posiadając kilkudziesięciu tysięcy talentów gotowizną, nie mógłbym ważyć się na podobne ulepszenia.
      </p>
      <p data-index="14">
      ...
      <p data-index="15">
        ...
        >
          Pentuer
        </span> spojrzał na władcę zdziwiony.
      </p>
      <p data-index="16">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="19">
        <span 
          ...
          data-src-talking="/Pharaon/pentuer-speaks.mp4" 
          data-is-talking="true"
        />\n    — Panie — rzekł — sześć milionów Egipcjan, a ja i moi przyjaciele przed innymi zgodzimy się, ażebyś czerpał z tamtego skarbca. Ale… nie łudź się, wasza świątobliwość!… Bo stu najwyższych dostojników państwa oprą<a href="#fn76" className="link-note">[76]</a> się temu, a wówczas Labirynt nic nie wyda…
      </p>
      <p data-index="20">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="23">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n    — Jeżeli tak jest, kochany <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
          Pentuerze
        </span>, jak mówisz, więc bądź spokojny — rzekł. — W tej chwili dokładnie zrozumiałem: w jakim celu Amon ustanowił władzę faraona i dał mu nadludzką potęgę… Dlatego, widzisz, ażeby stu choćby najdostojniejszych łotrów nie mogli zgubić<a href="#fn77" className="link-note">[77]</a> państwa.
      </p>
      <p data-index="24">
        <span 
          className="character-highlighted" 
        ...
        >
          Ramzes
        </span> podniósł się z krzesła i dodał:
      </p>
      <p data-index="25">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="29">
        W tym właśnie miejscu, tuż obok siebie, stały dwa czcigodne miasta: Tinis<a href="#fn78" className="link-note">[78]</a> i Abydos. Tam urodził się Menes, pierwszy faraon Egiptu; tam przed stoma tysiącami lat złożono do grobu święte zwłoki bożka Ozyrysa, którego w zdradziecki sposób zamordował brat Tyfon.
      </p>
      <p data-index="30">
        Tam wreszcie na pamiątkę owych wielkich wydarzeń wiekopomny faraon Seti<a href="#fn79" className="link-note">[79]</a> wybudował świątynię, do której zbiegali się pielgrzymi z całego Egiptu. Każdy prawowierny musiał choć raz w życiu dotknąć czołem tej błogosławionej ziemi. Prawdziwie zaś szczęśliwym był ten, czyja mumia mogła odbyć podróż do Abydos i choć z daleka zatrzymać się pod murami świątyni.
      </p>
      <p data-index="31">
        Mumia <span 
          className="character-highlighted" 
        ...
        >
          Ramzesa XII
        </span> przemieszkała tam parę dni; był to bowiem władca odznaczający się pobożnością. Nic też dziwnego, że i <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes XIII
        </span> rozpoczynał rządy od złożenia hołdu grobowi Ozyrysa.
      </p>
      <p data-index="32">
        Świątynia Setiego nie należała do najstarszych ani najwspanialszych w Egipcie, lecz odznaczała się czystością egipskiego stylu. Jego świątobliwość <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes XIII
        </span> zwiedzał ją i złożył w niej ofiary w towarzystwie arcykapłana <span 
          className="character-highlighted" 
          data-character="Sem" 
      ...
      <p data-index="40">
        Dopiero za obeliskami wznosiła się potężna brama świątyni mająca z obu boków olbrzymie gmachy w kształcie piramid ściętych, zwanych <strong>pylonami</strong>. Były to jakby dwie wieże barczyste, na których ścianach znajdowały się malowidła przedstawiające zwycięstwa Setiego albo ofiary, jakie składał bogom.
      </p>
      <p data-index="41">
        Tej bramy już nie wolno było przekraczać chłopom, tylko bogatemu mieszczaństwu i klasom uprzywilejowanym. Przez nią wchodziło się do <strong>perystylu</strong>, czyli dziedzińca otoczonego korytarzem wspartym na mnóstwie kolumn. Perystyl mógł pomieścić z dziesięć tysięcy pobożnych.
      </p>
      <p data-index="42">
        Z dziedzińca osoby stanu szlacheckiego mogły jeszcze wchodzić do pierwszej sali, <strong>hipostylu</strong>; miała ona sufit oparty na dwu szeregach wysokich kolumn i mogła pomieścić ze dwa tysiące uczestników nabożeństwa. Sala ta była ostatnim kresem dla ludzi świeckich. Najwięksi dostojnicy, lecz którzy nie otrzymali święceń, mieli prawo modlić się tylko tutaj i z tego miejsca patrzeć na zasłonięty posąg boga, który wznosił się w sali „boskiego objawienia\'.
      </p>
      <p data-index="43">
      ...
      <p data-index="46">
        Ściany i kolumny każdej sali były pokryte napisami i malowidłami objaśniającymi. W korytarzu otaczającym dziedziniec (perystyl) były nazwiska i portrety wszystkich faraonów od Menesa, pierwszego władcy Egiptu, do <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
          Ramzesa XII
        </span>. W hipostylu, czyli sali szlacheckiej, przedstawiono w sposób poglądowy jeografię<a href="#fn80" className="link-note">[80]</a> i statystykę Egiptu tudzież podbitych ludów. W sali „objawienia\' znajdował się kalendarz i rezultaty obserwacji astronomicznych; w komnacie „stołów ofiarnych\' i „odpoczynku\' figurowały obrazy dotyczące religijnych obrządków, a w sanktuarium — przepisy wywoływania istot zaziemskich i opanowania zjawisk natury.
      </p>
      <p data-index="47">
        Ten ostatni rodzaj wiedzy nadludzkiej zawierał się w tak powikłanych zdaniach, że nawet kapłani z czasów <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
          Ramzesa XII
        </span> nie rozumieli ich. Dopiero Chaldejczyk <span 
          className="character-highlighted" 
          data-character="Phut-Beroes" 
          data-src-listening="/Pharaon/phut-beroes-listens.mp4"
        >
          Beroes
        </span> miał wskrzesić obumierającą mądrość.
      </p>
      <p data-index="48">
        Odpocząwszy dwa dni w rządowym pałacu w Abydos, <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes XIII
        </span> wybrał się do świątyni. Miał na sobie białą koszulę, złoty pancerz, fartuszek w pomarańczowe i niebieskie pasy, stalowy miecz przy boku i złoty hełm na głowie. Wsiadł na wóz, którego konie, przybrane w pióra strusie, prowadzili nomarchowie, i z wolna pojechał do domu Ozyrysa otoczony świtą.
      </p>
      <p data-index="49">
      ...
      <p data-index="51">
        W perystylu arcykapłan zwrócił uwagę jego świątobliwości na misterne portrety faraonów i wskazał miejsce przeznaczone na jego wizerunek. W hipostylu objaśnił mu znaczenie map jeograficznych i statystycznych tablic. W komnacie „boskiego objawienia\' <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> ofiarował kadzidło olbrzymiemu posągowi Ozyrysa, a arcykapłan wskazał mu słupy poświęcone oddzielnym planetom: Merkuremu, Wenerze, Księżycowi, Marsowi, Jowiszowi i Saturnowi. Stały one dokoła posągu słonecznego bóstwa w liczbie siedmiu.
      </p>
      <p data-index="52">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n    — Mówisz mi — spytał <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> — że jest sześć planet, a tymczasem widzę siedem słupów…
      </p>
      <p data-index="53">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="57">
        Gdy faraon znalazł się w sali „odpoczynku\', usiadł na tronie, a jego zastępca religijny, <span 
          className="character-highlighted" 
          data-character="Sem" 
          data-src-listening="/Pharaon/sem-listens.mp4"
        >
          Sem
        </span>, przy dźwiękach muzyki i wśród dymu kadzideł, wszedł do sanktuarium, ażeby wynieść stamtąd bożka.
      </p>
      <p data-index="58">
      ...
      <p data-index="59">
        Kapłani upadli na twarz, a <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> pilniej wpatrzył się w przezroczyste zasłony. Jedna uchyliła się i faraon ujrzał nadzwyczajnej piękności dziecko, które spojrzało na niego tak mądrymi oczyma, że władca Egiptu uczuł nieomal trwogę.
      </p>
      <p data-index="60">
        \n    — Oto jest <span 
          className="character-highlighted" 
          data-character="Horus-dziecko-w-swiatyni-Setiego" 
          data-src-listening="/Pharaon/horus-dziecko-w-swiatyni-setiego.png"
        >
          Horus
        </span> — szeptali kapłani — <span 
          className="character-highlighted" 
          data-character="Horus-dziecko-w-swiatyni-Setiego" 
          data-src-listening="/Pharaon/horus-dziecko-w-swiatyni-setiego.png"
        >
          Horus
        </span>, wschodzące słońce… Jest on synem i ojcem Ozyrysa, i mężem swej matki, która jest jego siostrą.
      </p>
      <p data-index="61">
      ...
      <p data-index="62">
        Gdy procesja obeszła wszystkie sale i korytarze świątyni, bożek i <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> obaj wrócili do komnaty „odpoczynku\'. Wówczas zasłony okrywające łódź świętą odchyliły się po raz drugi i piękne dziecko — uśmiechnęło się do faraona.
      </p>
      <p data-index="63">
        Po czym łódź i bożka <span 
          className="character-highlighted" 
          data-character="Sem" 
          data-src-listening="/Pharaon/sem-listens.mp4"
        >
          Sem
        </span> odniósł do kaplicy.
      </p>
      <p data-index="64">
        „Może by zostać arcykapłanem?\' — pomyślał władca, któremu dziecko tak się podobało, że rad był widywać je jak najczęściej.
      </p>
      <p data-index="65">
        Lecz gdy wyszedł ze świątyni, zobaczył słońce i niezmierny tłum radującego się ludu, przyznał w duchu, że — nic nie rozumie. Ani skąd wzięło się owe<a href="#fn81" className="link-note">[81]</a> dziecko niepodobne do żadnego z egipskich? ani skąd ta nadludzka mądrość w jego oczach? ani — co to wszystko oznacza?…
      </p>
      <p data-index="66">
      ...
      <p data-index="69">
        Dobrze po południu <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> wrócił do swego pałacu, aby wysłuchać raportów. Gdy zaś wszyscy dostojnicy opuścili gabinet pana, przyszedł <span 
          className="character-highlighted" 
      ...
      <p data-index="70">
        ...
        >
          Samentu
        </span> pragnie złożyć hołd waszej świątobliwości.
      </p>
      <p data-index="71">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="74">
        Przed zachodem słońca pan odjechał z <span 
          className="character-highlighted" 
          data-character="Tutmozis" 
          data-src-listening="/Pharaon/tutmozis-listens.mp4"
        >
          Tutmozisem
        </span> do swoich wiernych wojsk i znalazł tam królewski namiot, przy którym z polecenia <span 
          className="character-highlighted" 
          data-character="Tutmozis" 
          data-src-listening="/Pharaon/tutmozis-listens.mp4"
        >
          Tutmozisa
        </span> wartę trzymali Azjaci.
      </p>
      <p data-index="75">
        Wieczorem przyszedł <span 
          className="character-highlighted" 
          data-character="Samentu" 
          data-src-listening="/Pharaon/samentu-listens.mp4"
        >
          Samentu
        </span> odziany w płaszcz pielgrzyma i ze czcią powitawszy jego świątobliwość, szepnął:
      </p>
      <p data-index="76">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="77">
        Na rozkaz faraona wybiegł <span 
          className="character-highlighted" 
          data-character="Tutmozis" 
          data-src-listening="/Pharaon/tutmozis-listens.mp4"
        >
          Tutmozis
        </span> i rzeczywiście znalazł obcego oficera.
      </p>
      <p data-index="78">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="79">
        ...
        >
          Eunana
        </span>, setnik pułku Izydy… Nieszczęśliwy <span 
          className="character-highlighted" 
          data-character="Eunana" 
          data-src-listening="/Pharaon/eunana-listens.mp4"
        >
          Eunana
        </span>, wasza dostojność nie pamięta mnie?… Więcej niż rok temu na manewrach pod Pi-Bailos odkryłem święte skarabeusze…
      </p>
      <p data-index="80">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/tutmozis-speaks.mp4" 
          data-is-talking="true"
        />\n    — Ach, to ty!… — przerwał <span 
          className="character-highlighted" 
          data-character="Tutmozis" 
          data-src-listening="/Pharaon/tutmozis-listens.mp4"
        >
          Tutmozis
        </span>. — Twój pułk przecież nie stoi w Abydos?
      </p>
      <p data-index="81">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="83">
        <span 
          ...
          data-src-talking="/Pharaon/eunana-speaks.mp4" 
          data-is-talking="true"
        />\n    — Ubłagałem starszych o kilkudniowy odpoczynek — odparł <span 
          className="character-highlighted" 
          data-character="Eunana" 
          data-src-listening="/Pharaon/eunana-listens.mp4"
        >
          Eunana
        </span> — i jak spragniony jeleń do źródła przybiegłem tutaj dzięki chyżości moich nóg.
      </p>
      <p data-index="84">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="86">
        ...
        >
          Tutmozis
        </span> markotny wrócił do namiotu i powtórzył faraonowi rozmowę z <span 
          className="character-highlighted" 
          data-character="Eunana" 
          data-src-listening="/Pharaon/eunana-listens.mp4"
        >
      ...
      <p data-index="87">
        ...
        >
          Eunana
        </span>?… — powtórzył pan. — Prawda, pamiętam go… Narobił nam kłopotu skarabeuszami, ale też i dostał pięćdziesiąt kijów z łaski <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
          Herhora
        </span>. I mówisz, że skarży się na kapłanów?… Daj go tu!…
      </p>
      <p data-index="88">
        Faraon kazał odejść <span 
          className="character-highlighted" 
          data-character="Samentu" 
          data-src-listening="/Pharaon/samentu-listens.mp4"
        >
          Samentowi
        </span> do drugiego przedziału w namiocie, a swego ulubieńca wysłał po <span 
          className="character-highlighted" 
          data-character="Eunana" 
          data-src-listening="/Pharaon/eunana-listens.mp4"
        >
      ...
      <p data-index="90">
        <span 
          ...
          data-src-talking="/Pharaon/eunana-speaks.mp4" 
          data-is-talking="true"
        />\n    — „Co dzień modlę się do Re Harmachis przy jego wschodzie i zachodzie i do Amona, i Re, i Ptaha, i do innych bogów i bogiń: Obyś ty zdrów był, władco Egiptu! Obyś został przy życiu! Oby ci się dobrze wiodło, a ja ażebym mógł choć blaski twoich pięt oglądać…<a href="#fn82" className="link-note">[82]</a>\'
      </p>
      <p data-index="91">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n    — Czego on chce? — spytał faraon <span 
          className="character-highlighted" 
          data-character="Tutmozis" 
          data-src-listening="/Pharaon/tutmozis-listens.mp4"
        >
          Tutmozisa
        </span>, pierwszy raz przestrzegając etykiety.
      </p>
      <p data-index="92">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/tutmozis-speaks.mp4" 
          data-is-talking="true"
        />\n    — Jego świątobliwość raczy zapytywać: czego chcesz? — powtórzył <span 
          className="character-highlighted" 
          data-character="Tutmozis" 
          data-src-listening="/Pharaon/tutmozis-listens.mp4"
        >
      ...
      <p data-index="93">
        ...
        >
          Eunana
        </span>, wciąż klęcząc, zwrócił się do ulubieńca i prawił:
      </p>
      <p data-index="94">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="97">
        „W dzień obracam serce moje do książek, a w nocy czytam; bo głupiec, który opuszcza książki tak prędko jak uciekająca gazela, jest podłego umysłu, równy osłowi<a href="#fn83" className="link-note">[83]</a>, który bierze cięgi, równy głuchemu, który nie słyszy i do którego trzeba mówić ręką. Mimo tę moją chęć do nauk, nie jestem zarozumiałym z własnej wiedzy, lecz radzę się wszystkich, bo od każdego coś nauczyć się można, a czcigodnych mędrców otaczam szacunkiem…\'
      </p>
      <p data-index="98">
      ...
      <p data-index="103">
        ...
        >
          Tutmozis
        </span> — przekonałeś jego świątobliwość, że jesteś biegły w księgach, a teraz — powiedz jak najkrócej: czego pragniesz?
      </p>
      <p data-index="104">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/eunana-speaks.mp4" 
          data-is-talking="true"
        />\n    — Strzała tak prędko nie dobiega celu, jak moja prośba doleci do boskich pięt jego świątobliwości — odparł <span 
          className="character-highlighted" 
          data-character="Eunana" 
          data-src-listening="/Pharaon/eunana-listens.mp4"
        >
          Eunana
        </span>. — Tak obmierzła mi służba u ogolonych łbów, taką goryczą kapłani napełnili moje serce, że — jeżeli nie będę przeniesiony do wojsk faraona, przebiję się własnym mieczem, przed którym nie raz i nie sto razy drżeli wrogowie Egiptu.
      </p>
      <p data-index="105">
      ...
      <p data-index="106">
        Ostatnie frazesy <span 
          className="character-highlighted" 
          data-character="Eunana" 
          data-src-listening="/Pharaon/eunana-listens.mp4"
        >
          Eunana
        </span> wypowiedział z takim wściekłym gniewem, że faraon rzekł po grecku do <span 
          className="character-highlighted" 
          data-character="Tutmozis" 
          data-src-listening="/Pharaon/tutmozis-listens.mp4"
        >
      ...
      <p data-index="108">
        <span 
          ...
          data-src-talking="/Pharaon/tutmozis-speaks.mp4" 
          data-is-talking="true"
        />\n    — Jego świątobliwość, pan obu światów, kazał przyjąć cię do swej gwardii — powtórzył <span 
          className="character-highlighted" 
          data-character="Tutmozis" 
          data-src-listening="/Pharaon/tutmozis-listens.mp4"
        >
      ...
      <p data-index="109">
        <span 
          ...
          data-src-talking="/Pharaon/eunana-speaks.mp4" 
          data-is-talking="true"
        />\n    — Zdrowie i życie moje należy do pana naszego <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzesa
        </span>… Oby żył wiecznie! — zawołał <span 
          className="character-highlighted" 
          data-character="Eunana" 
          data-src-listening="/Pharaon/eunana-listens.mp4"
        >
          Eunana
        </span> i ucałował dywan leżący pod królewskimi stopami.
      </p>
      <p data-index="110">
        Gdy uszczęśliwiony <span 
          className="character-highlighted" 
          data-character="Eunana" 
          data-src-listening="/Pharaon/eunana-listens.mp4"
        >
          Eunana
        </span> cofał się tyłem z namiotu, co parę kroków padając na twarz i błogosławiąc władcę, faraon rzekł:
      </p>
      <p data-index="111">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="112">
        <span 
          ...
          data-src-talking="/Pharaon/tutmozis-speaks.mp4" 
          data-is-talking="true"
        />\n    — Bodajby on miał tylko tę jedną wadę!… — szepnął <span 
          className="character-highlighted" 
          data-character="Tutmozis" 
          data-src-listening="/Pharaon/tutmozis-listens.mp4"
        >
        ...
        >
          Eunana
        </span> niemiłe zrobił wrażenie.
      </p>
      <p data-index="113">
        Pan wezwał do siebie <span 
          className="character-highlighted" 
          data-character="Samentu" 
          data-src-listening="/Pharaon/samentu-listens.mp4"
        >
      ...
      <p data-index="116">
        <span 
          ...
          data-src-talking="/Pharaon/samentu-speaks.mp4" 
          data-is-talking="true"
        />\n    — Prawie już znam drogę do skarbca w Labiryncie — odparł <span 
          className="character-highlighted" 
          data-character="Samentu" 
          data-src-listening="/Pharaon/samentu-listens.mp4"
        >
      ...
      <p data-index="119">
        <span 
          ...
          data-src-talking="/Pharaon/samentu-speaks.mp4" 
          data-is-talking="true"
        />\n    — A jednak musimy znaleźć i opanować tę drogę — rzekł <span 
          className="character-highlighted" 
          data-character="Samentu" 
          data-src-listening="/Pharaon/samentu-listens.mp4"
        >
      ...
      <p data-index="121">
        <span 
          ...
          data-src-talking="/Pharaon/samentu-speaks.mp4" 
          data-is-talking="true"
        />\n    — Nie zrobią tego, dopóki żyje <span 
          className="character-highlighted" 
        ...
        >
          Herhor
        </span> i ich poplecznicy. Wierzaj mi, panie, że tym dostojnikom chodzi o to, ażeby owinęli cię w powijaki jak niemowlę…
      </p>
      <p data-index="122">
      ...
      <p data-index="128">
        <span 
          ...
          data-src-talking="/Pharaon/samentu-speaks.mp4" 
          data-is-talking="true"
        />\n    — Gdy mumia wiecznie żyjącego ojca waszej świątobliwości była w świątyni Ozyrysa — odparł <span 
          className="character-highlighted" 
          data-character="Samentu" 
          data-src-listening="/Pharaon/samentu-listens.mp4"
        >
          Samentu
        </span>. — Towarzyszyłem czcigodnym zwłokom i będąc na nocnej służbie w sali „odpoczynku\', wszedłem do sanktuarium.
      </p>
      <p data-index="129">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n    — Tobie być jenerałem, nie arcykapłanem!… — zawołał śmiejąc się <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span>. — I już rozumiesz drogę Labiryntu?…
      </p>
      <p data-index="130">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="133">
        Droga ta — ciągnął <span 
          className="character-highlighted" 
          data-character="Samentu" 
          data-src-listening="/Pharaon/samentu-listens.mp4"
        >
          Samentu
        </span> — przechodzi w zygzak cztery razy przez cały Labirynt; zaczyna się na najwyższym piętrze, kończy w najniższym podziemiu i posiada jeszcze mnóstwo zakrętów. Dlatego jest tak długa.
      </p>
      <p data-index="134">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="142">
        ...
        >
          Samentu
        </span> pogardliwie wzruszył ramionami.
      </p>
      <p data-index="143">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="149">
        <span 
          ...
          data-src-talking="/Pharaon/samentu-speaks.mp4" 
          data-is-talking="true"
        />\n    — Niezawodnie są, a ja muszę je znaleźć — odparł <span 
          className="character-highlighted" 
          data-character="Samentu" 
          data-src-listening="/Pharaon/samentu-listens.mp4"
        >
          Samentu
        </span>. — Nie wejdę przecież, jak wasza świątobliwość, w dzień ani główną bramą…
      </p>
      <p data-index="150">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="157">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n    — Ale ciemność… ciemność… I mury, których nie można przebić, i głębia, i te setki dróg, gdzie człowiek musi się zabłąkać… Wierz mi, <span 
          className="character-highlighted" 
          data-character="Samentu" 
          data-src-listening="/Pharaon/samentu-listens.mp4"
        >
          Samentu
        </span>, że walka z ludźmi to zabawka; ale szamotanie się z cieniem i nieświadomością to straszna rzecz!…
      </p>
      <p data-index="158">
        <span 
          className="character-highlighted" 
      ...
      <p data-index="172">
        ...
        >
          Ramzes XIII
        </span> zrobił gest niezadowolenia.
      </p>
      <p data-index="173">
        <span 
          className="character-placeholder character-talking" 
        ...
        >
          Samentu
        </span> — rzekł — zdaje mi się, żeś twoje pieczary zwiedzał we śnie…
      </p>
      <p data-index="174">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="177">
        Było to moje ostatnie odkrycie — ciągnął <span 
          className="character-highlighted" 
          data-character="Samentu" 
          data-src-listening="/Pharaon/samentu-listens.mp4"
        >
          Samentu
        </span>. Nie wchodziłem już do jaskiń, alem dużo rozmyślał. Ozyrys — mówiłem — tworzy wielkie istoty: lwy, słonie, konie… zaś Set rodzi węża, nietoperza, krokodyla… Potwór, którego spotkałem, jest na pewno tworem Seta, a ponieważ przerasta wszystko, co znamy pod słońcem, więc Set jest mocniejszym bogiem aniżeli Ozyrys.
      </p>
      <p data-index="178">
      ...
      <p data-index="185">
        Lecz i olbrzymie słonie nie są najstarszymi potworami. Dawniej bowiem od nich żyły niezmierne gady: latające, pływające i chodzące. Przed gadami na tym świecie były tylko ślimaki i ryby, a przed nimi — same rośliny, ale takie, jakich dziś już nie ma<a href="#fn85" className="link-note">[85]</a>…
      </p>
      <p data-index="186">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="187">
        <span 
          ...
          data-src-talking="/Pharaon/samentu-speaks.mp4" 
          data-is-talking="true"
        />\n    — Jeszcze dawniej ziemia była pusta i próżna, a Duch Boży unosił się nad wodami…<a href="#fn86" className="link-note">[86]</a>
      </p>
      <p data-index="188">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="189">
        <span 
          ...
          data-src-talking="/Pharaon/samentu-speaks.mp4" 
          data-is-talking="true"
        />\n    — Za pozwoleniem waszej świątobliwości, dokończę, com zaczął — mówił <span 
          className="character-highlighted" 
          data-character="Samentu" 
          data-src-listening="/Pharaon/samentu-listens.mp4"
        >
          Samentu
        </span>. — Otóż kiedy w pieczarze Synaj zobaczyłem owego ogromnego trupa, zdjął mnie strach i przez parę lat nie byłbym poszedł do żadnej jaskini. Ale gdy kapłani Seta wytłumaczyli mi, skąd się wzięły tak dziwne istoty, trwoga moja znikła, a ciekawość wzmogła się. I dziś nie ma dla mnie milszej zabawy jak błąkać się po podziemiach i szukać dróg wśród ciemności. Z tego powodu Labirynt nie sprawi mi więcej trudów jak przechadzka po królewskim ogrodzie.
      </p>
      <p data-index="190">
        <span 
          className="character-placeholder character-talking" 
        ...
        >
          Samentu
        </span> — rzekł pan — bardzo cenię twoją nadludzką odwagę i mądrość. Opowiedziałeś mi tyle ciekawych rzeczy, że zaprawdę sam nabrałem ochoty do oglądania jaskiń i kiedyś może popłynę razem z tobą do Synaj.
      </p>
      <p data-index="191">
      ...
      <p data-index="192">
        <span 
          ...
          data-src-talking="/Pharaon/samentu-speaks.mp4" 
          data-is-talking="true"
        />\n    — To nigdy nie zawadzi — odparł kapłan. — Ale moja praca niemniej będzie potrzebną, bo <span 
          className="character-highlighted" 
          data-character="Mefres" 
          data-src-listening="/Pharaon/mefres-listens.mp4"
        >
        ...
        >
          Herhor
        </span> nie zgodzą się na wydanie skarbu.
      </p>
      <p data-index="193">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="194">
        <span 
          ...
          data-src-talking="/Pharaon/samentu-speaks.mp4" 
          data-is-talking="true"
        />\n    — Jak Egipt Egiptem — przekonywał go <span 
          className="character-highlighted" 
          data-character="Samentu" 
          data-src-listening="/Pharaon/samentu-listens.mp4"
        >
          Samentu
        </span> — nie było człowieka, który by posiadał tyle środków, co ja, do zwyciężenia w tej walce, która dla mnie nie jest nawet walką, ale zabawą.
      </p>
      <p data-index="195">
        Jednych straszy ciemność, którą ja lubię, a nawet widzę wśród niej. Inni nie potrafią kierować się pomiędzy licznymi komnatami i kurytarzami<a href="#fn87" className="link-note">[87]</a>, ja robię to z łatwością. Jeszcze inni nie znają tajemnic otwierania drzwi utajonych, z czym ja jestem obeznany.
      </p>
      <p data-index="196">
      ...
      <p data-index="200">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n    — Straszne czekałyby cię męki!… — szepnął <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
      ...
      <p data-index="203">
        <span 
          ...
          data-src-talking="/Pharaon/samentu-speaks.mp4" 
          data-is-talking="true"
        />\n    — Za co?… — spytał kapłan. — Dojdę do wielkiego celu: chcę w państwie zająć miejsce <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
      ...
      <p data-index="205">
        <span 
          ...
          data-src-talking="/Pharaon/samentu-speaks.mp4" 
          data-is-talking="true"
        />\n    — O ile nie zginę — odparł <span 
          className="character-highlighted" 
          data-character="Samentu" 
          data-src-listening="/Pharaon/samentu-listens.mp4"
        >
          Samentu
        </span>. — A że na szczyty gór wchodzi się nad przepaściami, że w tej wędrówce może się poślizgnąć noga i spadnę, cóż to znaczy? Ty, panie, zajmiesz się losem moich dzieci.
      </p>
      <p data-index="206">
        <span 
          className="character-placeholder character-talking" 
