...
export const Chapter56: React.FC = () => {
  return (
    <section data-chapter="56">
      <h4 data-index="0">Rozdział VII</h4>
      <p data-index="1">
        W połowie miesiąca Famenut (styczeń) zaczęła się wiosna. Cały Egipt zielenił się wschodzącą pszenicą, na czarnych zaś płatach ziemi snuły się gromady chłopów siejących
        łubin, bób, fasolę i jęczmień. W powietrzu unosił się zapach pomarańczowego kwiatu. Woda bardzo opadła i co dzień odsłaniała nowe kawałki gruntów.
      </p>
      <p data-index="2">
      ...
      <p data-index="3">
        Czcigodna mumia króla była już zamknięta w białym pudle, którego górna część doskonale odtwarzała rysy nieboszczyka. Faraon zdawał się patrzeć emaliowymi oczyma, a boska
        twarz wyrażała smutek łagodny, nie za światem, który opuścił, lecz nad ludźmi jeszcze skazanymi na utrapienie doczesnego żywota.
      </p>
      <p data-index="4">
        Na głowie wizerunek faraona miał czepiec egipski w białe i szafirowe pasy, na szyi sznury klejnotów, na piersiach obraz człowieka klęczącego z rozkrzyżowanymi rękoma, na
        nogach wizerunki bożków, świętych ptaków i oczu nie osadzonych w żadnej twarzy, lecz jakby wyglądających z przestrzeni.
      </p>
      <p data-index="5">
      ...
      <p data-index="6">
        Prócz tego przygotowano ciężki, bazaltowy sarkofag, który stanowił zewnętrzną trumnę mumii. Sarkofag miał także formy i rysy zmarłego faraona, był pokryty napisami i
        wizerunkami modlących się ludzi, świętych ptaków tudzież skarabeuszów.
      </p>
      <p data-index="7">Siedemnastego Famenut mumię wraz z jej kaplicą i sarkofagiem przeniesiono z dzielnicy zmarłych do królewskiego pałacu i ustawiono w największej sali.</p>
      <p data-index="8">
        Salę tą wnet zapełnili kapłani śpiewający hymny żałobne, dworzanie i słudzy zmarłego króla, a nade wszystko jego kobiety, które jęczały tak głośno, że ich krzyki słychać
      ...
      <p data-index="11">
        <strong>Chór I</strong>. „Ja jestem Tum, który jedynym jest…
      </p>
      <p data-index="12">
        <strong>Chór II</strong>. Jestem Re w pierwszym jego blasku…
      </p>
      <p data-index="13">
        <strong>Chór I</strong>. Jestem bogiem, który sam siebie stwarza…
      </p>
      <p data-index="14">
        <strong>Chór II</strong>. Który sam sobie daje imię, a nikt go nie wstrzyma między bogami…
      </p>
      <p data-index="15">
        <strong>Chór I</strong>. Znam imię wielkiego boga, który tam jest…
      </p>
      <p data-index="16">
        <strong>Chór II</strong>. Gdyż ja jestem wielki ptak Benu
        <a href="#fn64" className="link-note">
          [64]
        </a>
        , który próbuje to, co jest
      ...
      <p data-index="18">
        Na ten wóz włożono świątobliwą mumię, pomimo gwałtownego oporu kobiet dworskich. Jedne z nich czepiały się trumny, inne zaklinały kapłanów, ażeby nie zabierali im dobrego
        pana, inne drapały sobie oblicza i targały włosy, a nawet biły ludzi niosących zwłoki.
      </p>
      <p data-index="19">Krzyk był straszliwy.</p>
      <p data-index="20">
        Nareszcie wóz, przyjąwszy boskie ciało, ruszył wśród mnóstwa ludu, który zaległ ogromną przestrzeń od pałacu do Nilu. I tu byli ludzie pomazani błotem, podrapani, okryci
        żałobnymi płachtami, którzy zawodzili wniebogłosy. A obok nich, zgodnie z rytuałem żałobnym, na całej drodze były rozrzucone chóry.
      </p>
      <p data-index="21">
        <strong>Chór I</strong>. „Na Zachód, do mieszkania Ozyrysa, na Zachód idziesz ty, który byłeś najlepszym z ludzi, który nienawidziłeś fałszu.
      </p>
      <p data-index="22">
        <strong>Chór II</strong>. Na Zachód! nie zakwitnie już człowiek, który tak kochał prawdę i miał w obrzydzeniu kłamstwo.
      </p>
      <p data-index="23">
        <strong>Chór woźniców</strong>. Na Zachód, woły, które ciągniecie wóz żałobny, na Zachód!… Pan wasz idzie za wami.
      </p>
      <p data-index="24">
        <strong>Chór III</strong>. Na Zachód, na Zachód, do ziemi sprawiedliwych. Miejsce, które ukochałeś, jęczy i płacze po tobie.
      </p>
      <p data-index="25">
        <strong>Tłum ludu</strong>. Idź w pokoju do Abydos!… Idź w pokoju do Abydos!… Obyś doszedł w pokoju do Zachodu tebańskiego!…
      </p>
      <p data-index="26">
        <strong>Chór płaczek</strong>. O panie nasz, o panie nasz, kiedy ty odchodzisz na Zachód, sami bogowie płaczą.
      </p>
      <p data-index="27">
        <strong>Chór kapłanów</strong>. On jest szczęśliwy, najszanowniejszy między ludźmi, ponieważ los pozwala mu odpocząć w grobie, który sam przygotował…
      </p>
      <p data-index="28">
        <strong>Chór woźniców</strong>. Na Zachód, woły, które ciągniecie wóz żałobny, na Zachód!… Pan wasz idzie za wami…
      </p>
      <p data-index="29">
        <strong>Tłum ludu</strong>. Idź w pokoju do Abydos… Idź w pokoju do Abydos, ku Morzu Zachodniemu
      ...
      <p data-index="32">Po parugodzinnym pochodzie, któremu towarzyszył nieustanny krzyk, zwłoki zatrzymały się nad brzegiem Nilu.</p>
      <p data-index="33">Tu zdjęto je z wozu w formie łodzi i przeniesiono na prawdziwy statek złocony, rzeźbiony, pokryty malowidłami, zaopatrzony w białe i purpurowe żagle.</p>
      <p data-index="34">
      ...
      <p data-index="36">
        Podróż ciągnęła się bardzo długo. Do Tebów było ze sto mil, płynęło się w górę rzeki, wzdłuż której mumia musiała odwiedzić kilkanaście świątyń i przyjmować udział w
      ...
      <p data-index="38">
        Za zmarłym panem odjechali, każdy na własnym statku, wszyscy arcykapłani, wielu starszych kapłanów, najbogatsi właściciele ziemscy i większa część nomarchów. Toteż nowy
        faraon myślał nie bez goryczy, że jego orszak będzie bardzo nieliczny.
      </p>
      <p data-index="39">
      ...
      <p data-index="40">
        Był to dopiero początek. Gdy bowiem statek młodego pana wypłynął na Nil, wyjechała naprzeciw niego taka masa większych i mniejszych, ubogich i bogatych czółen, że prawie
        zasłoniły wodę. Siedziały w nich nagie rodziny chłopów i rzemieślników, strojni kupcy, jaskrawi Fenicjanie, zwinni żeglarze greccy, a nawet Asyryjczycy i Hetyci.
      </p>
      <p data-index="41">
        Tłum ten już nie krzyczał, ale wył; nie cieszył się, ale szalał. Co chwilę na statek królewski wdzierała się jakaś deputacja, aby ucałować pokład, którego dotykały nogi
        pańskie, i złożyć dary: garstkę zboża, kawałek tkaniny, prosty gliniany dzbanek, parę ptaszków, a nade wszystko wiązankę kwiatów. Toteż zanim faraon ominął Memfis, jego
        statek trzeba było kilka razy opróżnić z podarunków, ażeby nie zatonął.
      </p>
      <p data-index="42">Młodsi kapłani mówili między sobą, że oprócz Ramzesa Wielkiego żaden faraon nie był witany z tak olbrzymim zapałem.</p>
      <p data-index="43">
        W podobny sposób odbyła się cała podróż od Memfisu do Tebów, a szał ludu, zamiast słabnąć, potęgował się. Chłopi rzucili swoje pola, a rzemieślnicy warsztaty, aby nacieszyć
        się widokiem nowego władcy, o którego zamiarach już utworzyły się legendy. Spodziewano się ogromnych zmian, choć nikt nie wiedział jakich. To tylko było pewne, że surowość
      ...
      <p data-index="46">
        Kiedyś w tym miejscu była pustynia zaklęśnięta i otoczona amfiteatrem gór nagich. Dopiero faraon Amenhemat na 3500 lat przed Chrystusem
        <a href="#fn68" className="link-note">
          [68]
        </a>{" "}
        powziął zuchwały projekt zamienienia jej na żyzną okolicę.
      </p>
      <p data-index="47">
        W tym celu oddzielił od reszty wschodnią część zaklęśnięcia i otoczył ten kawałek potężną groblą. Miała ona wysokość piętrowego domu, grubości w podstawie około stu kroków
        i przeszło czterdzieści kilometrów długości.
      </p>
      <p data-index="48">
        Tym sposobem utworzono zbiornik mogący pomieścić ze trzy miliardy metrów kubicznych, trzy kilometry sześcienne wody, której powierzchnia zajmowała około trzystu kilometrów
        kwadratowych. Rezerwoar
        <a href="#fn69" className="link-note">
          [69]
        </a>{" "}
        ten służył do nawadniania czterechset tysięcy morgów gruntu, a oprócz tego, w czasach przyboru rzeki, wchłaniał w siebie nadmiar wody i znaczną część Egiptu zabezpieczał od
        nagłego zalewu.
      </p>
      <p data-index="49">
        To olbrzymie nagromadzenie wód nazywano jeziorem Moeris i zaliczano je do cudów świata. Dzięki niemu pustynna dolina zamieniła się na żyzny kraj Piom, gdzie żyło w
        dobrobycie około dwustu tysięcy mieszkańców. W prowincji tej, obok palm i pszenicy, hodowano najpiękniejsze róże, z których olejek rozchodził się po całym Egipcie i za jego
        granicami.
      </p>
      <p data-index="50">
        Istnienie jeziora Moeris było związane z innym cudem pracy egipskich inżynierów, z kanałem Józefa
        <a href="#fn70" className="link-note">
          [70]
        </a>
        .
      </p>
      <p data-index="51">
        Kanał ten, szeroki na dwieście kroków, ciągnął się przez kilkadziesiąt mil na zachodniej stronie Nilu. Odległy od rzeki o dwie mile, służył do nawadniania gruntów
        sąsiadujących z górami libijskimi i — prowadził wodę do jeziora Moeris.
      </p>
      <p data-index="52">
        Dokoła kraju Piom wznosiło się kilka starych piramid i mnóstwo mniejszych grobów. Zaś na jego wschodniej granicy, w pobliżu Nilu, stał słynny Labirynt (Lope-ro-hunt). Był
        on również zbudowany przez Amenhemata, a miał formę olbrzymiej podkowy, która zajmowała kawał gruntu na tysiąc kroków długi i sześćset szeroki.
      </p>
      <p data-index="53">
        Gmach ten był największą skarbnicą Egiptu. W nim spoczywały mumie wielu sławnych faraonów, znakomitych kapłanów, wodzów i budowniczych. Tu również leżały zwłoki czczonych
        zwierząt, a przede wszystkim krokodylów. Tu nareszcie chronił się nagromadzony w ciągu wieków majątek państwa egipskiego, o którym trudno mieć dziś pojęcie.
      </p>
      <p data-index="54">
        Labirynt nie był ani niedostępny z zewnątrz, ani zbyt pilnowany. Strzegł go mały oddział wojsk kapłańskich i kilku kapłanów wypróbowanej uczciwości. Bezpieczeństwo skarbca
        polegało właściwie na tym, że z wyjątkiem owych kilku osób nikt nie wiedział, gdzie go szukać wśród Labiryntu, który dzielił się na dwa piętra: nadziemne i podziemne, i — w
        każdym z nich — liczył po tysiąc pięćset komnat…
      </p>
      <p data-index="55">
        Każdy faraon, każdy arcykapłan, nareszcie każdy wielki skarbnik i najwyższy sędzia miał obowiązek natychmiast po objęciu urzędu własnymi oczyma obejrzeć majątek państwa.
        Lecz mimo to żaden z dostojników nie tylko nie trafiłby tam, ale nawet nie mógł zmiarkować: gdzie leży skarbiec? W korpusie głównym czy w którym ze skrzydeł, nad ziemią czy
        pod ziemią.
      </p>
      <p data-index="56">
        Byli tacy, którym zdawało się, że skarbiec naprawdę mieści się pod ziemią, daleko za obrębem właściwego Labiryntu. Nie brakło zaś i takich, którzy sądzili, że skarbiec leży
        pod dnem jeziora, aby w razie potrzeby można go wodą zalać. Wreszcie żaden dostojnik państwa nie lubił zajmować się tą kwestią, wiedząc, że pokuszenie się na majątek bogów
        pociąga za sobą zgubę świętokradcy.
      </p>
      <p data-index="57">
        Może zresztą niewtajemniczeni potrafiliby odkryć tam drogę, gdyby myśli ich nie paraliżowała obawa. Śmierć doczesna i wieczna groziła człowiekowi i jego rodzinie, który
      ...
      <p data-index="59">Był to bodajże najszczęśliwszy kąt Egiptu.</p>
      <p data-index="60">
        Lud przyjął faraona z ogromnym zapałem. Jego i świtę zasypywano kwiatami, ofiarowano mu kilka dzbanków najkosztowniejszych perfum i za dziesięć talentów złota i drogich
        kamieni.
      </p>
      <p data-index="61">
        Dwa dni zabawił pan w rozkosznej okolicy, gdzie radość zdawała się wykwitać z drzew, pływać w powietrzu, przeglądać w wodzie jeziora. Lecz przypomniano mu, że musi zwiedzić
        Labirynt.
      </p>
      <p data-index="62">
      ...
      <p data-index="63">
        Przy bramie wiekopomnego Lope-ro-hunt powitała go gromadka kapłanów o ascetycznej powierzchowności tudzież mały oddziałek wojska, w którym każdy żołnierz był zupełnie
        ogolony.
      </p>
      <p data-index="64">
      ...
      <p data-index="66">
        Przypatrzywszy się uważniej fizjognomiom tych dziwnych żołnierzy, którzy nie jadali mięsa i żyli w celibacie, faraon dojrzał w nich bystrość i spokojną energię. Poznał też,
        że jego święta osoba żadnego wrażenia nie wywołuje w tym miejscu.
      </p>
      <p data-index="67">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />
      ...
      <p data-index="73">Młody pan miał ochotę przynajmniej wypłazować pobożnego męża za taką odpowiedź. Ale pohamował się.</p>
      <p data-index="74">
      ...
      <p data-index="78">
        ...
        dół, i — znowu przez ciasny korytarz podążyli do komnaty, która nie miała żadnych drzwi.
      </p>
      ...
      <p data-index="80">
        ...
        <a href="#fn71" className="link-note">
          [71]
        </a>{" "}
      ...
      <p data-index="86">W małej komnacie bez drzwi zniżono pochodnię i faraon spostrzegł na ziemi wyschłe, czarne zwłoki, owinięte zbutwiałą szatą.</p>
      <p data-index="87">
        <span
          className="character-placeholder character-talking"
          data-character="Arcykaplan-Labiryntu"
      ...
      <p data-index="92">
        Faraon nie pytał, co się z nim stało. Miał wrażenie, że znajduje się w jakiejś głębi i że gmach przygniata go swym ciężarem. O zorientowaniu się wśród setek korytarzy, sal
        i komnat już nie myślał. A nawet nie pragnął wyjaśnić sobie: jakim cudem rozstępują się przed nimi kamienne ściany lub zapadają posadzki.
      </p>
      <p data-index="93">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />„
        <span className="character-highlighted" data-character="Samentu" data-src-listening="/Pharaon/samentu-listens.mp4">
      ...
      <p data-index="94">
        ...
        drzwi. Wówczas ogarniała go rozpacz: sięgał do miecza i gotów był ich porąbać. Ale wnet przypominał sobie, że bez ich pomocy nie wyjdzie stąd, i — spuszczał głowę.
      </p>
      <p data-index="95">
      ...
      <p data-index="96">Dusze bohaterskie miewają chwile głębokiego znękania, jakich nawet nie domyśla się człowiek zwykły.</p>
      <p data-index="97">
      ...
      <p data-index="98">
        Po chwili w jednej ze ścian odsłonił się wąski otwór, kapłani wrócili na swoje miejsca, a ich przewodnik kazał zapalić cztery pochodnie. Po czym wszyscy skierowali się do
        owego otworu i ostrożnie przecisnęli się przezeń.
      </p>
      <p data-index="99">
        <span
          className="character-placeholder character-talking"
      ...
      <p data-index="101">
        Więc były wozy, czółna, łóżka, stoły, skrzynie i trony złote lub złotą blachą obite tudzież inkrustowane: kością słoniową, perłową masą i kolorowym drzewem tak ozdobnie, że
        drobiazgi te artyści-rzemieślnicy wyrabiali przez dziesiątki lat. Były zbroje, hełmy, tarcze i kołczany lśniące od drogich kamieni. Były szczerozłote dzbany, misy i łyżki,
        kosztowne szaty i baldachimy.
      </p>
      <p data-index="102">Wszystko to, dzięki suchości i czystości powietrza, od wieków przechowywało się bez zmiany.</p>
      <p data-index="103">
      ...
      <p data-index="115">I tym razem kapłani rozbiegli się: dwaj znikli jakby we wnętrzu kolumn, a jeden po drabince wszedł na ścianę i coś robił około rzeźbionej figurki.</p>
      <p data-index="116">
      ...
      <p data-index="117">
        I to była rozległa komnata przepełniona bezcennymi materiałami. Stały w niej gliniane beczki pełne złotego piasku, bryły złota ułożone jak cegły i złote sztaby w wiązkach.
        Srebrne bryły ustawione pod jedną ścianą tworzyły niby mur szeroki na parę łokci, wysoki do sufitu.
      </p>
      <p data-index="118">
        We framugach i na kamiennych stołach leżały drogie kamienie wszystkich barw: rubiny, topazy, szmaragdy, szafiry, diamenty, wreszcie perły wielkości orzechów, a nawet
      ...
      <p data-index="135">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />
        „Zgromadzenie takie potrafię zebrać i skłonić go
