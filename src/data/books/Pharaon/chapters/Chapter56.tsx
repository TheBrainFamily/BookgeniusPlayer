...
export const Chapter56: React.FC = () => {
  return (
    <section data-chapter="56">
      ...
      <p data-index="2">
        Przygotowania do pogrzebu <span 
      ...
      <p data-index="5">
        Tak opakowane zwłoki króla spoczywały na kosztownym łożu, w małej cedrowej kaplicy, której ściany były pokryte napisami opiewającymi żywot i czyny zmarłego. Nad zwłokami unosił się cudowny jastrząb z ludzką głową, a przy łożu, dniem i nocą, czuwał kapłan przebrany za <span 
          className="character-highlighted" 
          data-character="Anubis-kaplan-w-ceremonii" 
          data-src-listening="/Pharaon/anubis-kaplan-w-ceremonii.png"
        >
          Anubisa
        </span>, bożka pogrzebu, z głową szakala.
      </p>
      <p data-index="6">
      ...
      <p data-index="16">
        <strong>Chór II</strong>. Gdyż ja jestem wielki ptak Benu<a href="#fn64" className="link-note">[64]</a>, który próbuje to, co jest<a href="#fn65" className="link-note">[65]</a>.\'
      </p>
      <p data-index="17">
      ...
      <p data-index="29">
        <strong>Tłum ludu</strong>. Idź w pokoju do Abydos… Idź w pokoju do Abydos, ku Morzu Zachodniemu<a href="#fn66" className="link-note">[66]</a>!\'
      </p>
      <p data-index="30">
      ...
      <p data-index="31">
        W pewnej odległości za wozem szedł <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes XIII
        </span> otoczony wielką świtą jenerałów<a href="#fn67" className="link-note">[67]</a>, a za nim królowa <span 
          className="character-highlighted" 
          data-character="Nikotris" 
          data-src-listening="/Pharaon/nikotris-listens.mp4"
        >
          Nikotris
        </span> oparta na dwu damach dworskich. Ani syn, ani matka nie płakali, ponieważ im było wiadomo (o czym nie wiedział lud prosty), że zmarły pan już znajduje się u boku Ozyrysa i z pobytu w ojczyźnie szczęśliwości jest tak zadowolony, że nie chciałby wrócić na ziemię.
      </p>
      <p data-index="32">
      ...
      <p data-index="34">
        Dworskie kobiety jeszcze raz próbowały odebrać mumię kapłanom; jeszcze raz odezwały się wszystkie chóry i wszystkie muzyki wojskowe. Potem na statek wiozący mumię królewską weszła pani <span 
          className="character-highlighted" 
          data-character="Nikotris" 
          data-src-listening="/Pharaon/nikotris-listens.mp4"
        >
          Nikotris
        </span> i kilkunastu kapłanów, lud począł rzucać bukiety i wieńce i — zaszumiały wiosła…
      </p>
      <p data-index="35">
        <span 
          className="character-highlighted" 
        ...
        >
          Ramzes XII
        </span> po raz ostatni opuścił swój pałac, dążąc Nilem do grobu w Tebach. Po drodze zaś, jako troskliwy władca, miał wstępować do wszystkich słynnych miejscowości, aby pożegnać się z nimi.
      </p>
      <p data-index="36">
      ...
      <p data-index="37">
        W kilka dni po wyjeździe <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
          Ramzesa XII
        </span> na wiekuisty spoczynek wyruszył za nim <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes XIII
        </span>, aby widokiem swoim wskrzesić martwe z żalu serca poddanych, przyjąć ich hołdy i złożyć ofiary bogom.
      </p>
      <p data-index="38">
      ...
      <p data-index="39">
        Stało się jednak inaczej. Przy boku <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzesa XIII
        </span> znaleźli się wszyscy jenerałowie, bardzo wielu urzędników, mnóstwo drobnej szlachty i — całe niższe duchowieństwo, co bardziej nawet zdziwiło, aniżeli ucieszyło faraona.
      </p>
      <p data-index="40">
      ...
      <p data-index="46">
        Kiedyś w tym miejscu była pustynia zaklęśnięta i otoczona amfiteatrem gór nagich. Dopiero faraon Amenhemat na 3500 lat przed Chrystusem<a href="#fn68" className="link-note">[68]</a> powziął zuchwały projekt zamienienia jej na żyzną okolicę.
      </p>
      <p data-index="47">
      ...
      <p data-index="50">
        Istnienie jeziora Moeris było związane z innym cudem pracy egipskich inżynierów, z kanałem Józefa<a href="#fn70" className="link-note">[70]</a>.
      </p>
      <p data-index="51">
      ...
      <p data-index="64">
        ...
        />\n      — Ci ludzie wyglądają jak kapłani!… — zawołał <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
      ...
      <p data-index="65">
        <span 
          ...
          data-is-talking="true"
        />\n      — Bo też każdy z nich odebrał niższe święcenia, a setnicy wyższe — odpowiedział <span 
          className="character-highlighted" 
          data-character="Arcykaplan-Labiryntu" 
      ...
      <p data-index="67">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />„Bardzom ciekawy, w jaki sposób trafi tutaj <span 
          className="character-highlighted" 
          data-character="Samentu" 
          data-src-listening="/Pharaon/samentu-listens.mp4"
        >
          Samentu
        </span>?…\' — rzekł do siebie pan.
      </p>
      <p data-index="68">
      ...
      <p data-index="70">
        Na prośbę kapłanów świta <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzesa XIII
        </span> została przed bramą, jakby pod dozorem żołnierzy z ogolonymi głowami.
      </p>
      <p data-index="71">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="72">
        <span 
          ...
          data-src-talking="/Pharaon/arcykaplan-labiryntu-speaks.mp4" 
          data-is-talking="true"
        />\n      — Nic on nam nie zaszkodzi — odparł <span 
          className="character-highlighted" 
          data-character="Arcykaplan-Labiryntu" 
          data-src-listening="/Pharaon/arcykaplan-labiryntu-listens.mp4"
        >
      ...
      <p data-index="74">
        Przez ogromny dziedziniec, między dwoma szeregami sfinksów, faraon i kapłani weszli do głównego korpusu. Tu, w sieni bardzo obszernej, lecz nieco przyćmionej, było ośmioro drzwi, a <span 
          className="character-highlighted" 
          data-character="Arcykaplan-Labiryntu" 
          data-src-listening="/Pharaon/arcykaplan-labiryntu-listens.mp4"
        >
      ...
      <p data-index="77">
        Każdy z pięciu kapłanów wziął po dwa pęki pochodni, ale zapalił światło tylko jeden. Obok niego stanął <span 
          className="character-highlighted" 
          data-character="Arcykaplan-Labiryntu" 
          data-src-listening="/Pharaon/arcykaplan-labiryntu-listens.mp4"
        >
          najwyższy dozorca
        </span>, trzymając w rękach duży sznur paciorków, na których wypisane były jakieś znaki. Za nimi zaś szedł <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> otoczony przez trzech pozostałych kapłanów.
      </p>
      <p data-index="78">
        <span 
          className="character-highlighted" 
      ...
      <p data-index="80">
        ...
        >
          Ramzes
        </span> chciał zdać sobie sprawę z kierunku, w jakim idą; lecz wnet splątała mu się uwaga. Widział tylko, że śpiesznie przechodzą duże sale, małe komnaty, ciasne korytarze, że wdrapują się pod górę lub zbiegają na dół, że niektóre sale mają mnóstwo drzwi, a inne wcale ich nie posiadają. Zarazem spostrzegł, że przewodnik przy każdym nowym wejściu przesuwa jedno ziarnko swego długiego różańca, a niekiedy przy blasku pochodni porównywa<a href="#fn71" className="link-note">[71]</a> znaki na paciorkach ze znakami na ścianach.
      </p>
      <p data-index="81">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="85">
        Kapłani milczeli, tylko niosący pochodnią oświetlił kolejno ściany, a <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> przypatrzywszy się wyznał w duchu, że chyba tu jeszcze nie byli.
      </p>
      <p data-index="86">
      ...
      <p data-index="87">
        ...
        >
          dozorca gmachu
        </span> — jest trup pewnego Fenicjanina, które za szesnastej dynastii probował wedrzeć się do Labiryntu i doszedł aż tutaj.
      </p>
      <p data-index="88">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="91">
        ...
        >
          dozorca
        </span> — jest trup kapłana nubijskiego, który za czasów dziada waszej świątobliwości probował tu wejść…
      </p>
      <p data-index="92">
      ...
      <p data-index="93">
        ...
        >
          Samentu
        </span> nic nie zrobi!… — mówił w duchu. — Albo zginie jak ci dwaj, o których muszę mu nawet powiedzieć.\'
      </p>
      <p data-index="94">
      ...
      <p data-index="97">
        Pochód trwał blisko godzinę, gdy nareszcie weszli do niskiej sali wspartej na ośmiokątnych słupach. Trzej kapłani otaczający faraona rozpierzchli się, przy czym <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> spostrzegł, że jeden z nich przytulił się do kolumny i — jakby znikł w jej wnętrzu.
      </p>
      <p data-index="98">
      ...
      <p data-index="100">
        Kapłani szybko zapalili pochodnie przytwierdzone do kolumn i ścian i <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> zobaczył szereg ogromnych izb przepełnionych najrozmaitszymi wyrobami bezcennej wartości. W zbiorze tym każda dynastia, jeżeli nie każdy faraon składał, co miał najosobliwszego i najdroższego.
      </p>
      <p data-index="101">
      ...
      <p data-index="103">
        Między osobliwościami faraon zauważył srebrny model asyryjskiego pałacu, ofiarowany <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
        ...
        >
          Arcykapłan
        </span> objaśniając faraonowi, który dar od kogo pochodzi, pilnie przypatrywał się jego fizjognomii. Ale zamiast podziwu dla skarbów dostrzegł niezadowolenie.
      </p>
      <p data-index="104">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="105">
        <span 
          ...
          data-src-talking="/Pharaon/arcykaplan-labiryntu-speaks.mp4" 
          data-is-talking="true"
        />\n      — Jest w nich wielka siła na wypadek, gdyby Egipt znalazł się w niebezpieczeństwie — odparł <span 
          className="character-highlighted" 
          data-character="Arcykaplan-Labiryntu" 
          data-src-listening="/Pharaon/arcykaplan-labiryntu-listens.mp4"
        >
          arcykapłan
        </span>. — Za kilka tych hełmów, wozów, mieczów możemy kupić sobie życzliwość wszystkich asyryjskich satrapów. A może nie oparłby się i <span 
          className="character-highlighted" 
          data-character="Krol-Assar" 
          data-src-listening="/Pharaon/krol-assar-listens.mp4"
        >
          król Assar
        </span>, gdybyśmy mu dostarczyli sprzętów do sali tronowej lub zbrojowni.
      </p>
      <p data-index="106">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="109">
        <span 
          ...
          data-src-talking="/Pharaon/arcykaplan-labiryntu-speaks.mp4" 
          data-is-talking="true"
        />\n      — Nie mój w tym rozum — odparł <span 
          className="character-highlighted" 
          data-character="Arcykaplan-Labiryntu" 
          data-src-listening="/Pharaon/arcykaplan-labiryntu-listens.mp4"
        >
          najwyższy dozorca
        </span>. — Pilnujemy, co nam oddano, i czynimy, jak kazano.
      </p>
      <p data-index="110">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="116">
        Znowu usunęły się ukryte drzwi i <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> wszedł do właściwego skarbca.
      </p>
      <p data-index="117">
      ...
      <p data-index="119">
        <span 
          ...
          data-src-talking="/Pharaon/arcykaplan-labiryntu-speaks.mp4" 
          data-is-talking="true"
        />\n      — Oto jest nasz majątek na wypadek nieszczęścia — rzekł <span 
          className="character-highlighted" 
          data-character="Arcykaplan-Labiryntu" 
          data-src-listening="/Pharaon/arcykaplan-labiryntu-listens.mp4"
        >
      ...
      <p data-index="122">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n      — Za kilkanaście lat — odparł <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> — podbiją nas nawet Izraelici, jeżeli nie uprzedzą ich Libijczycy i Etiopowie. A wówczas te piękne kamienie, rozbite na okruchy, pójdą na przyozdobienie żydowskich i murzyńskich sandałów…
      </p>
      <p data-index="123">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="124">
        ...
        >
          Ramzes
        </span> ostatecznie zrozumiał, że ma przed sobą fanatyków, którzy myślą tylko o jednym: ażeby nikogo nie dopuścić do owładnięcia skarbem.
      </p>
      <p data-index="125">
      ...
      <p data-index="134">
        ...
        >
          Ramzes
        </span> spuścił głowę, ażeby ukryć wyraz wielkiego zadowolenia. Już miał plan.
      </p>
      <p data-index="135">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />„Zgromadzenie takie potrafię zebrać i skłonić go<a href="#fn72" className="link-note">[72]</a> do jednomyślności… — mówił sobie. — Również zdaje mi się, że boski posąg Amona potwierdzi uchwałę, gdy jego kapłanów otoczę moimi Azjatami…\'
      </p>
      <p data-index="136">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="137">
        <span 
          ...
          data-src-talking="/Pharaon/arcykaplan-labiryntu-speaks.mp4" 
          data-is-talking="true"
        />\n      — Życzymy waszej świątobliwości — odparł <span 
          className="character-highlighted" 
          data-character="Arcykaplan-Labiryntu" 
          data-src-listening="/Pharaon/arcykaplan-labiryntu-listens.mp4"
        >
          dozorca
        </span> — abyś drugie tyle bogactw dołożył Labiryntowi… Co się zaś tyczy drogi do wyjścia stąd, jest tylko jedna i tą samą musimy wracać.
      </p>
      <p data-index="138">
        ...
        >
          Ramzesowi
        </span> trochę daktyli, drugi flaszę wina zaprawionego wzmacniającą substancją. Po czym faraon odzyskał siły i szedł wesoło.
      </p>
      <p data-index="139">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="146">
        <span 
          ...
          data-src-talking="/Pharaon/arcykaplan-labiryntu-speaks.mp4" 
          data-is-talking="true"
        />\n      — Ale można się i przywiązać do nich — odparł z uśmiechem <span 
          className="character-highlighted" 
          data-character="Arcykaplan-Labiryntu" 
          data-src-listening="/Pharaon/arcykaplan-labiryntu-listens.mp4"
        >
