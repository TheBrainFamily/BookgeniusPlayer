...
export const Chapter54: React.FC = () => {
  return (
    <section data-chapter="54">
      ...
      <p data-index="27">
        Prawda, że korpus kapłański, który był w głównym pałacu, został w nim i odprawiał obrządki religijne pod przewodnictwem dostojnego <span 
          className="character-highlighted" 
          data-character="Sem" 
          data-src-listening="/Pharaon/sem-listens.mp4"
        >
          Sema
        </span>. Ale ponieważ kapłani nie towarzyszyli faraonowi przy śniadaniu, obiedzie i kolacji, więc ich żywność stała się bardzo niewykwintną.
      </p>
      <p data-index="28">
        Na próżno święci mężowie przypominali, że muszą karmić przedstawicieli dziewiętnastu dynastii i mnóstwo bogów. Skarbnik zmiarkowawszy intencje faraona odpowiadał kapłanom, że dla bogów i przodków wystarczą kwiaty i wonności, a że sami prorocy, jak nakazuje moralność, powinni jadać jęczmienne placki i popijać wodą lub piwem. Dla poparcia swoich grubiańskich teorii skarbnik powoływał się na przykład arcykapłana <span 
          className="character-highlighted" 
          data-character="Sem" 
          data-src-listening="/Pharaon/sem-listens.mp4"
        >
          Sema
        </span>, który żył jak pokutnik, a co gorsze, mówił im, że jego świątobliwość, wraz z jenerałami, prowadzi żołnierską kuchnię.
      </p>
      <p data-index="29">
      ...
      <p data-index="30">
        I może uczyniliby tak natychmiast, gdyby najdostojniejsi <span 
          className="character-highlighted" 
        ...
        >
          Mefres
        </span> nie rozkazali im wytrwać na miejscu.
      </p>
      <p data-index="31">
        Ale i położenie <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
          Herhora
        </span> przy nowym panu nie mogło nazywać się pomyślnym. Do niedawna wszechwładny minister, który prawie nie opuszczał pokojów królewskich, siedział dziś samotny w swoim pałacyku i nieraz nie widywał nowego faraona przez całe dekady. Był on jeszcze ministrem wojny, ale już prawie nie wydawał rozkazów. Wszystkie bowiem interesa<a href="#fn51" className="link-note">[51]</a> wojskowe faraon załatwiał sam. Sam czytał raporty jenerałów, sam rozstrzygał wątpliwe kwestie, a jego adiutanci brali z ministerium wojny potrzebne dokumenta<a href="#fn52" className="link-note">[52]</a>.
      </p>
      <p data-index="32">
        Jego dostojność <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
          Herhor
        </span>, jeżeli kiedy był wezwany przez władcę, to chyba po to, ażeby usłyszeć wymówkę.
      </p>
      <p data-index="33">
      ...
      <p data-index="34">
        ...
        >
          Ramzes XIII
        </span> wstawał przed wschodem słońca, kąpał się i spalał kadzidło przed posągiem Ozyrysa. Natychmiast potem słuchał raportów: <span 
          className="character-highlighted" 
        ...
        >
          najwyższego pisarza
        </span> stodół i obór w całym kraju, <span 
          className="character-highlighted" 
        ...
        >
          ...
          className="character-highlighted" 
          data-character="Naczelnik-palacow-Ramzesa-XIII" 
          data-src-listening="/Pharaon/naczelnik-palacow-ramzesa-xiii.png"
        >
          naczelnika swoich pałaców
        </span>. Ten ostatni cierpiał najwięcej: nie było bowiem dnia, ażeby pan nie mówił mu, że utrzymanie dworu za dużo kosztuje i że jest w nim za wiele osób.
      </p>
      <p data-index="35">
        Istotnie, mieszkało w pałacu królewskim kilkaset kobiet zmarłego faraona z odpowiednią ilością dzieci i służby. Ciągle upominany <span 
          className="character-highlighted" 
          data-character="Naczelnik-palacow-Ramzesa-XIII" 
          data-src-listening="/Pharaon/naczelnik-palacow-ramzesa-xiii.png"
        >
          naczelnik dworu
        </span> z dnia na dzień wypędzał po kilkanaście osób, a innym ograniczał wydatki. Skutkiem czego po upływie miesiąca wszystkie damy dworu z krzykiem i płaczem pobiegły do mieszkania królowej <span 
          className="character-highlighted" 
          data-character="Nikotris" 
          data-src-listening="/Pharaon/nikotris-listens.mp4"
        >
          Nikotris
        </span>, błagając o ratunek.
      </p>
      <p data-index="36">
      ...
      <p data-index="37">
        Faraon wysłuchał jej ze zmarszczonym czołem i rozkazał <span 
          className="character-highlighted" 
          data-character="Naczelnik-palacow-Ramzesa-XIII" 
          data-src-listening="/Pharaon/naczelnik-palacow-ramzesa-xiii.png"
        >
          naczelnikowi dworu
        </span> już nie posuwać dalej oszczędności. Zarazem jednak powiedział najczcigodniejszej pani, że po pogrzebie ojca kobiety będą usunięte z pałacu i rozesłane po folwarkach.
      </p>
      <p data-index="38">
        <span 
      ...
      <p data-index="47">
        W ciągu niespełna dwu miesięcy jego świątobliwość uformował pięć nowych pułków, a raczej — wskrzesił te, które zwinięto za poprzedniego panowania. Usunął oficerów oddających się pijaństwu i kosterstwu<a href="#fn53" className="link-note">[53]</a> tudzież takich, którzy udręczali żołnierzy.
      </p>
      <p data-index="48">
      ...
      <p data-index="50">
        Wyszło też polecenie do rodzin stanu wojskowego, aby mężczyźni ich wprawiali się w rzucaniu pocisków, pod kierunkiem oficerów i dziesiętników armii regularnej. Rozkaz wykonano natychmiast, skutkiem czego Egipt, już we dwa miesiące po śmierci <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
          Ramzesa XII
        </span>, wyglądał jak obóz.
      </p>
      <p data-index="51">
      ...
      <p data-index="55">
        W tym samym dniu, kiedy balsamiści wydobyli ciało <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
          Ramzesa XII
        </span> z sodowej kąpieli, <span 
          className="character-highlighted" 
          data-character="Wielki-skarbnik-panstwowy" 
          data-src-listening="/Pharaon/wielki-skarbnik-panstwowy-listens.mp4"
        >
          wielki skarbnik
        </span> składając zwykły raport rzekł do faraona:
      </p>
      <p data-index="56">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="62">
        ...
        >
          skarbnik
        </span> — nie wiem dlaczego, znowu zmniejszyły się i nie napływają w takiej ilości, jak rachowałem. Ale i one rozeszły się… Racz, wasza świątobliwość, pamiętać, że mamy pięć nowych pułków. Więc około ośmiu tysięcy ludzi porzuciło swoje zajęcia i żyją na koszt państwa…
      </p>
      <p data-index="63">
        Faraon zamyślił się.
      </p>
      <p data-index="64">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— Musimy — odpowiedział — zaciągnąć nową pożyczkę. Porozumiej się z <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
          Herhorem
        </span> i <Mefresem>Mefresem</Mefresem>, aby nam dały świątynie.
      </p>
      <p data-index="65">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="66">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— Obrazili się prorocy!… — uśmiechnął się faraon. — W takim razie musimy wezwać pogan… Przyślij do mnie <span 
          className="character-highlighted" 
      ...
      <p data-index="68">
        <span 
          ...
          data-is-talking="true"
        />\n— Teraz już mogę umrzeć!… — zawołał <span 
          className="character-highlighted" 
          data-character="Dagon" 
          data-src-listening="/Pharaon/dagon-listens.mp4"
        >
          Dagon
        </span> — kiedy mój najłaskawszy władca zasiadł na tronie…
      </p>
      <p data-index="69">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="74">
        <span 
          ...
          data-src-talking="/Pharaon/dagon-speaks.mp4" 
          data-is-talking="true"
        />\n— Krew i życie nasze i dzieci naszych oddamy waszej świątobliwości — rzekł <span 
          className="character-highlighted" 
          data-character="Dagon" 
          data-src-listening="/Pharaon/dagon-listens.mp4"
        >
          Dagon
        </span>. — Ale pieniądze… Skąd my weźmiemy pieniędzy?…
      </p>
      <p data-index="75">
        Dawniej świątynie udzielały nam pożyczek na piętnaście lub dwadzieścia procentów<a href="#fn54" className="link-note">[54]</a> rocznie. Lecz od czasu gdy wasza świątobliwość, jeszcze jako następca tronu, był w świątyni Hator<a href="#fn55" className="link-note">[55]</a>, tam, pod Pi-Bast, kapłani zupełnie odmówili nam kredytu.
      </p>
      <p data-index="76">
      ...
      <p data-index="77">
        <span 
          ...
          data-src-talking="/Pharaon/dagon-speaks.mp4" 
          data-is-talking="true"
        />Godziny nasze na tej ziemi są policzone!… — mówił z płaczem <span 
          className="character-highlighted" 
          data-character="Dagon" 
          data-src-listening="/Pharaon/dagon-listens.mp4"
        >
      ...
      <p data-index="80">
        <span 
          ...
          data-src-talking="/Pharaon/dagon-speaks.mp4" 
          data-is-talking="true"
        />\n— Skąd weźmiemy panie?… — jęczał <span 
          className="character-highlighted" 
          data-character="Dagon" 
          data-src-listening="/Pharaon/dagon-listens.mp4"
        >
          Dagon
        </span>. — Wskaż nam, wasza świątobliwość, kupców, a sprzedamy im wszystkie nasze ruchomości i nieruchomości, byle spełnić twoje rozkazy…
      </p>
      <p data-index="81">
      ...
      <p data-index="83">
        <span 
          ...
          data-src-talking="/Pharaon/dagon-speaks.mp4" 
          data-is-talking="true"
        />\n— Tyr i Sydon!… — powtórzył <span 
          className="character-highlighted" 
          data-character="Dagon" 
          data-src-listening="/Pharaon/dagon-listens.mp4"
        >
          Dagon
        </span>. — Dziś cała Fenicja gromadzi złoto i klejnoty, ażeby opłacić się Asyryjczykom… Kręcą się już po naszym kraju wysłańcy <span 
          className="character-highlighted" 
          data-character="Krol-Assar" 
          data-src-listening="/Pharaon/krol-assar-listens.mp4"
        >
          króla Assara
        </span> i mówią, że byleśmy składali co roku hojny okup, to król i satrapowie nie tylko nie będą nas ciemiężyli, ale jeszcze nastręczą nam większe zarobki niż te, jakie mamy dziś z łaski waszej świątobliwości i Egiptu…
      </p>
      <p data-index="84">
      ...
      <p data-index="85">
        <span 
          ...
          data-src-talking="/Pharaon/dagon-speaks.mp4" 
          data-is-talking="true"
        />\n— Wreszcie, co ja mam zabierać waszej świątobliwości czas moim głupim gadaniem?… Jest tu, w Memfisie, książę <span 
          className="character-highlighted" 
          data-character="Hiram" 
          data-src-listening="/Pharaon/hiram-listens.mp4"
        >
          Hiram
        </span>… On może lepiej objaśni wszystko memu panu, bo to mędrzec i członek najwyższej rady naszych miast…
      </p>
      <p data-index="86">
        <span 
          className="character-highlighted" 
      ...
      <p data-index="87">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— A dawajże mi tu prędzej <span 
          className="character-highlighted" 
          data-character="Hiram" 
          data-src-listening="/Pharaon/hiram-listens.mp4"
        >
          Hirama
        </span> — odparł. — Bo ty, <span 
          className="character-highlighted" 
          data-character="Dagon" 
          data-src-listening="/Pharaon/dagon-listens.mp4"
        >
          Dagonie
        </span>, rozmawiasz ze mną nie jak bankier, ale jak pogrzebowa płaczka.
      </p>
      <p data-index="88">
      ...
      <p data-index="89">
        ...
        >
          Hiram
        </span> nie mógłby zaraz tu przyjść?… Prawda, że już późno… Ale on tak boi się kapłanów, że wolałby o nocnej porze złożyć hołd waszej świątobliwości…
      </p>
      <p data-index="90">
        Faraon przygryzł usta, ale zgodził się na ten projekt. Wysłał nawet z bankierem <span 
          className="character-highlighted" 
          data-character="Tutmozis" 
          data-src-listening="/Pharaon/tutmozis-listens.mp4"
        >
          Tutmozisa
        </span>, aby ten przyprowadził <span 
          className="character-highlighted" 
          data-character="Hiram" 
          data-src-listening="/Pharaon/hiram-listens.mp4"
        >
          Hirama
        </span> do pałacu tajemnymi wejściami.
      </p>
    </section>
  );
};
