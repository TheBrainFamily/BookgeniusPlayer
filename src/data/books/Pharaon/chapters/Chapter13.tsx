  ...
  return (
    <section data-chapter="13">
      ...
      <p data-index="1">
        ...
        , podjęte w celu odkrycia kapłana, który ocalił{" "}
      ...
      <p data-index="3">
        ...
        uwolnił ludzi, którym za napad na jego dom groziły kopalnie. Oprócz tego zbił urzędnika, który od chłopów chciał wydobyć niesprawiedliwy podatek. Dodawał w końcu nieznany
        człowiek, że{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          książę Ramzes{" "}
        </span>{" "}
      ...
      <p data-index="5">
        ...
        wcale o swoich chłopach nie mówił z{" "}
      ...
      <p data-index="6">
        ...
        bankier sam odwiedził{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          następcę tronu{" "}
        </span>
        , trzymając coś zasłoniętego w rękach. A gdy wszedł do pokoju{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          księcia{" "}
        </span>
      ...
      <p data-index="12">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />
        \n— A ja ci mówię, że to jest krew dzieci zabieranych rodzicom — odpowiedział gniewnie{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          następca tronu{" "}
        </span>
        .
      ...
      <p data-index="15">
        ...
        popłynął ze swoim kielichem do folwarku{" "}
        <span className="character-highlighted" data-character="Sara" data-src-listening="/Pharaon/sara-listens.mp4">
          Sary{" "}
        </span>
      ...
      <p data-index="16">
        ...
        — zaczął — oby Jehowa zlał na twoją rodzinę tyle błogosławieństw, ile dziś płynie wody w Nilu. My, Fenicjanie, i wy, Żydzi, jesteśmy przecie sąsiadami i braćmi. Ja zaś
        takim żarem miłosnym płonę do ciebie, że gdybyś nie należała do najdostojniejszego{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          pana naszego{" "}
        </span>
        , dałbym za ciebie{" "}
      ...
      <p data-index="17">
        ...
        \n— Niech mnie Bóg zachowa — odparła{" "}
        <span className="character-highlighted" data-character="Sara" data-src-listening="/Pharaon/sara-listens.mp4">
          Sara{" "}
        </span>{" "}
        — ażebym potrzebowała mieć innego{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          pana{" "}
        </span>{" "}
        aniżeli ten mój, który jest. Ale skądże to, zacny{" "}
        <span className="character-highlighted" data-character="Dagon" data-src-listening="/Pharaon/dagon-listens.mp4">
          Dagonie{" "}
        </span>
      ...
      <p data-index="20">
        ...
        siadając — niech będzie dla ciebie, a piołun niech moje zatruwa serce.{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          Pan nasz, książę Ramzes{" "}
        </span>{" "}
        (oby żył wiecznie!), ma lwie usta i sępią przebiegłość. Raczył mi wypuścić w dzierżawę swoje majątki, co żołądek mój napełniło radością; ale nie ufa mi tak, że ja ze
        zgryzoty po całych nocach nie sypiam, tylko wzdycham i łzami oblewam łoże moje, w którym obyś ty wespół ze mną spoczywała,{" "}
        <span className="character-highlighted" data-character="Sara" data-src-listening="/Pharaon/sara-listens.mp4">
          Saro{" "}
        </span>
        , zamiast mojej małżonki{" "}
        <span className="character-highlighted" data-character="Tamar" data-src-listening="/Pharaon/tamar-listens.mp4">
          Tamary{" "}
        </span>
      ...
      <p data-index="21">
        <span className="character-placeholder character-talking" data-character="Sara" data-src-talking="/Pharaon/sara-speaks.mp4" data-is-talking="true" />
        \n— Nie to chcieliście mówić — przerwała zarumieniona{" "}
        <span className="character-highlighted" data-character="Sara" data-src-listening="/Pharaon/sara-listens.mp4">
          Sara{" "}
        </span>
        .
      ...
      <p data-index="22">
        <span className="character-placeholder character-talking" data-character="Dagon" data-src-talking="/Pharaon/dagon-speaks.mp4" data-is-talking="true" />
        \n— Ja już nie wiem, co chcę mówić od czasu, gdym ujrzał ciebie i gdy{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          nasz pan{" "}
        </span>
        , śledząc moje czynności na folwarkach, pobił kijem i odebrał zdrowie mojemu pisarzowi, który zbierał od chłopów podatek. Przecie ten podatek nie dla mnie,{" "}
        <span className="character-highlighted" data-character="Sara" data-src-listening="/Pharaon/sara-listens.mp4">
          Saro{" "}
        </span>
        , tylko dla{" "}
        ...
        … Przecie nie ja będę jadł figi i pszenne chleby z tych dóbr, tylko ty,{" "}
        <span className="character-highlighted" data-character="Sara" data-src-listening="/Pharaon/sara-listens.mp4">
          Saro{" "}
        </span>
        , i{" "}
        ...
        … Przecie ja dałem pieniądze{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          panu{" "}
        </span>
        , a tobie klejnoty, więc dlaczego podłe chłopstwo egipskie ma zubożać{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          naszego pana{" "}
        </span>{" "}
        i ciebie,{" "}
        ...
        ?… Ażebyś zaś zrozumiała, jak mocno wzburzasz moją krew dla siebie, i ażebyś dowiedziała się, że z tych pańskich majątków ja nic mieć nie chcę, tylko wam wszystko oddaję,
        weźmij,{" "}
        <span className="character-highlighted" data-character="Sara" data-src-listening="/Pharaon/sara-listens.mp4">
          Saro{" "}
        </span>
      ...
      <p data-index="23">
        ...
        wydobył z białej chusty kielich nie przyjęty przez{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          księcia{" "}
        </span>
        .
      ...
      <p data-index="24">
        ...
        — mówił — ażebyś ty ten złoty kielich miała w domu i dawała z niego pić{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          naszemu panu{" "}
        </span>
        . Ty oddaj ten szczerozłoty kielich twojemu ojcu{" "}
        <span className="character-highlighted" data-character="Gedeon" data-src-listening="/Pharaon/gedeon-listens.mp4">
          Gedeonowi{" "}
        </span>
        , którego kocham jak brata. I ty,{" "}
        <span className="character-highlighted" data-character="Sara" data-src-listening="/Pharaon/sara-listens.mp4">
          Saro{" "}
        </span>
        , powiedz ojcu twemu takie słowa: „
        <span className="character-highlighted" data-character="Dagon" data-src-listening="/Pharaon/dagon-listens.mp4">
          Dagon{" "}
        </span>
        , twój bliźnięcy brat, nieszczęśliwy dzierżawca majątków{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          następcy tronu{" "}
        </span>
        , jest zrujnowany. Więc pij, mój ojcze, z tego kielicha i myśl o twoim bliźniaczym bracie{" "}
        <span className="character-highlighted" data-character="Dagon" data-src-listening="/Pharaon/dagon-listens.mp4">
          Dagonie{" "}
        </span>
        , i proś Jehowy, ażeby{" "}
        ...
        , nie rozbijał jemu pisarzów i nie buntował chłopów, którzy już i tak nie chcą płacić podatku.\' Ty zaś,{" "}
        <span className="character-highlighted" data-character="Sara" data-src-listening="/Pharaon/sara-listens.mp4">
          Saro{" "}
        </span>
        , wiedz o tym, że gdybyś kiedy dopuściła mnie do poufałości ze sobą, dałbym tobie dwa talenty, a twemu ojcu talent. I jeszcze wstydziłbym się, że daję ci tak mało, boś ty
        warta, ażeby pieścił cię sam{" "}
        ...
        , i najbogatsi bankierowie feniccy. W tobie jest taki smak, że ja, gdy widzę cię — omdlewam, a gdy cię nie widzę, zamykam oczy i oblizuję się. Ty jesteś słodsza od fig,
        bardziej pachnąca od róż… Ja bym dał tobie pięć talentów… Weź ten kielich,{" "}
        <span className="character-highlighted" data-character="Sara" data-src-listening="/Pharaon/sara-listens.mp4">
          Saro{" "}
        </span>
        …
      ...
      <p data-index="30">
        ...
        , zapłacisz mi za ten kielich innym sposobem, nie mówiąc{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          twojemu panu{" "}
        </span>
        … Przecie taka piękna jak ty kobieta musi posiadać złoto i klejnoty i powinna mieć swego bankiera, który by jej dostarczał pieniądze, kiedy jej się podoba, nie zaś tylko
        wówczas, gdy{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          jej pan{" "}
        </span>{" "}
      ...
      <p data-index="33">
        ...
        !… Ja tylko chciałem przekonać się, czy ty jesteś wierna{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          naszemu panu{" "}
        </span>
      ...
      <p data-index="35">
        <span className="character-placeholder character-talking" data-character="Dagon" data-src-talking="/Pharaon/dagon-speaks.mp4" data-is-talking="true" />
        \n— A cha! cha!… — śmiał się Fenicjanin. — Jaka szkoda, że tego nie słyszał i nie widział{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          nasz pan{" "}
        </span>
        … Ale ja jemu kiedy opowiem, gdy będzie dobrze usposobiony, że ty nie tylko jesteś mu wierna jak pies, ale nawet nie chciałaś przyjąć złotego kielicha, ponieważ on nie
        kazał ci przyjmować prezentów… A ten kielich, wierz mi,{" "}
        <span className="character-highlighted" data-character="Sara" data-src-listening="/Pharaon/sara-listens.mp4">
          Saro{" "}
        </span>
      ...
      <p data-index="36">
        ...
        posiedział jeszcze chwilę, podziwiając cnotę i posłuszeństwo{" "}
        <span className="character-highlighted" data-character="Sara" data-src-listening="/Pharaon/sara-listens.mp4">
          Sary{" "}
        </span>
        , wreszcie pożegnał się z nią bardzo czule, wsiadł w swoją łódź z namiotem i odpłynął do Memfis. Im czółno dalej odsuwało się od folwarku, z twarzy Fenicjanina znikał
        uśmiech, a występował wyraz gniewu. A gdy dom{" "}
        <span className="character-highlighted" data-character="Sara" data-src-listening="/Pharaon/sara-listens.mp4">
          Sary{" "}
        </span>{" "}
        ukrył się za drzewami,{" "}
        <span className="character-highlighted" data-character="Dagon" data-src-listening="/Pharaon/dagon-listens.mp4">
          Dagon{" "}
        </span>{" "}
      ...
      <p data-index="37">
        <span className="character-placeholder character-talking" data-character="Dagon" data-src-talking="/Pharaon/dagon-speaks.mp4" data-is-talking="true" />
        \n— O Baal Sydon, o Astoreth!… pomścijcie moją zniewagę nad przeklętą córką Judy… Niech przepadnie jej zdradziecka piękność jak kropla deszczu w pustyni… Niechaj choroby
        stoczą jej ciało, a szaleństwo opęta duszę… Niech{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          jej pan{" "}
        </span>{" "}
        wygna ją z domu jak parszywą świnię… A jak dzisiaj odtrąciła mój kielich, tak niech przyjdzie czas, ażeby ludzie odtrącali jej wyschłą rękę, gdy będzie żebrać, spragniona,
        o kubek mętnej wody…
      </p>
      <p data-index="38">
      ...
      <p data-index="40">
        ...
        przyszedł do swojej willi, zastał w pokoju sypialnym piękną szesnastoletnią tancerkę fenicką, która za cały strój miała złotą obręcz na głowie i delikatny jak pajęczyna
        szal na ramionach.
      </p>
      <p data-index="41">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />
      ...
      <p data-index="42">
        ...
        \n— Jestem kapłanką i twoją służebnicą, a przysłał mnie pan{" "}
        <span className="character-highlighted" data-character="Dagon" data-src-listening="/Pharaon/dagon-listens.mp4">
          Dagon{" "}
        </span>
      ...
      <p data-index="44">
        <span className="character-placeholder character-talking" data-character="Pieszczota" data-src-talking="/Pharaon/pieszczota-speaks.mp4" data-is-talking="true" />
        \n— O tak… Siądź tutaj — mówiła, sadowiąc go na fotelu — ja stanę na palcach, ażeby zrobić się wyższą aniżeli twój gniew, i tym szalem, który jest poświęcony, będę odpędzać
        od ciebie złe duchy… A kysz!… a kysz!… — szeptała, tańcząc wkoło{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          Ramzesa{" "}
        </span>
        . — Niech moje ręce zdejmą ponurość z włosów twoich… niech moje pocałunki przywrócą jasne spojrzenie oczom twym… niech bicie mego serca napełni muzyką uszy twoje,{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          panie Egiptu{" "}
        </span>
      ...
      <p data-index="45">
        ...
        , obejmowała go za szyję, całowała w oczy. Wreszcie zmęczona siadła u nóg{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          księcia{" "}
        </span>{" "}
      ...
      <p data-index="46">
        <span className="character-placeholder character-talking" data-character="Pieszczota" data-src-talking="/Pharaon/pieszczota-speaks.mp4" data-is-talking="true" />
        \n— Już nie gniewasz się na twego sługę{" "}
        <span className="character-highlighted" data-character="Dagon" data-src-listening="/Pharaon/dagon-listens.mp4">
          Dagona{" "}
        </span>
