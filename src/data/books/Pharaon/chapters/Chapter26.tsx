...
export const Chapter26: React.FC = () => {
  return (
    <section data-chapter="26">
      <h4 data-index="0">Rozdział I</h4>
      <p data-index="1">
        Niedaleko miasta Pi-Bast<a href="#fn183" className="link-note"></a> znajdowała się wielka świątynia bogini Hator<a href="#fn184" className="link-note"></a>.
      </p>
      <p data-index="2">
        W miesiącu Paoni (marzec-kwiecień), w dniu porównania wiosennego, około dziewiątej wieczór, gdy gwiazda Syriusz miała się ku zachodowi, pod bramą świątyni stanęli dwaj
        podróżni kapłani i jeden pokutnik. Szedł on boso, miał popiół na głowie i był przykryty grubą płachtą, którą twarz zasłaniał.
      </p>
      <p data-index="3">
        Pomimo widnej nocy fizjognomii<a href="#fn185" className="link-note"></a> podróżnych nie można było poznać, stali bowiem w cieniu dwu olbrzymich posągów bóstwa z krowią
        głową, które pilnowały wejścia do świątnicy i łaskawymi oczyma strzegły nomesu Habu od pomoru, złego wylewu i południowych wiatrów.
      </p>
      <p data-index="4">
        Odpocząwszy nieco, pokutnik upadł piersiami na ziemię i długo modlił się. Potem podniósł się, ujął miedzianą kołatkę i uderzył. Potężny dźwięk metalowy obiegł wszystkie
        dziedzińce, odbił się od grubych murów świątyni i poleciał ponad łany pszenicy, nad gliniane chaty chłopów, nad srebrzyste wody Nilu, gdzie słabym okrzykiem odpowiedziało
        mu zbudzone ptactwo.
      </p>
      <p data-index="5">Po długiej chwili za bramą rozległ się szmer i pytanie:</p>
      <p data-index="6">— Kto nas budzi?</p>
      <p data-index="7">
      ...
      <p data-index="8">— Po co przyszedłeś?</p>
      <p data-index="9">
      ...
      <p data-index="10">— Jakie masz prawa?</p>
      <p data-index="11">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />—
        Otrzymałem niższe święcenie i na wielkich procesjach wewnątrz świątyni noszę pochodnię.
      </p>
      <p data-index="12">Brama szeroko otworzyła się. Na środku stał kapłan w białej szacie, który wyciągnąwszy rękę, rzekł powoli i wyraźnie:</p>
      <p data-index="13">
      ...
      <p data-index="14">A gdy pokutnik upadł mu do nóg, kapłan, czyniąc jakieś znaki nad jego głową, szeptał:</p>
      <p data-index="15">— W imię Tego, który jest, był i będzie… Który wszystko stworzył… Którego tchnienie napełnia świat widzialny i niewidzialny i jest życiem wiecznym…</p>
      <p data-index="16">
      ...
      <p data-index="23">
        Była chwila, że chciał opuścić świątynię natychmiast, a potem przyszła mu myśl, że mogą nie otworzyć bramy. Widok brudnych nóg, popiołu, który sypał mu się z włosów,
      ...
      <p data-index="27">
        Poszedł tam. Ode drzwi panował mrok, a gdzieś bardzo daleko płonęło kilka lamp, jakby unoszących się w powietrzu. Wpatrzywszy się, dojrzał między wejściem i światłami cały
        las gęsto ustawionych, grubych kolumn, których wierzchołki rozpływały się w ciemności. W głębi, może o paręset kroków od niego, niewyraźnie widać było olbrzymie nogi
        siedzącej bogini i jej ręce oparte na kolanach, od których słabo odbijał się blask lamp.
      </p>
      <p data-index="28">
        Nagle usłyszał szmer. Z daleka, z bocznej nawy, wysunął się szereg białych figurek idących parami. Była to nocna procesja kapłanów, którzy oddawali hołd posągowi bogini
      ...
      <p data-index="40">Wtem zdało mu się, że z tyłu głowy delikatnie dotknęła go jakaś ręka… Obejrzał się, nie było nikogo, więc szedł dalej.</p>
      <p data-index="41">Tym razem jakieś dwie ręce schwyciły go za głowę, a trzecia, duża, oparła się na plecach…</p>
      <p data-index="42">
      ...
      <p data-index="45">
        ...
        święta bogini, ratuj!… — szepnął.
      </p>
      <p data-index="46">
        W tej chwili zatrzymał się: o kilka kroków przed nim były wielkie drzwi świątyni, przez które zaglądało gwiaździste niebo. Odwrócił głowę — między lasem olbrzymich kolumn
        płonęły lampy, a blask ich słabo odbijał się od spiżowych kolan świętej Hator.
      </p>
      <p data-index="47">
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          Książę{" "}
      ...
      <p data-index="50">Kiedy na drugi dzień obudził się, był już innym człowiekiem: poznał moc bogów i otrzymał obietnicę łaski.</p>
      <p data-index="51">
        Od tej pory, przez długi szereg dni, z ochotą i wiarą oddawał się ćwiczeniom pobożnym. W swojej celi długie godziny spędzał na modlitwach, dał sobie ogolić włosy,
        przywdział strój kapłański i cztery razy na dobę uczęszczał do chóru najmłodszych kapłanów.
      </p>
      <p data-index="52">
        Jego życie przeszłe, wypełnione zabawami, budziło w nim odrazę, a niewiara, której nabył wśród rozpustnej młodzieży i cudzoziemców, napełniała go strachem. I gdyby mu dziś
        dano do wyboru: tron czy kapłański urząd? zawahałby się.
      </p>
      <p data-index="53">
        Pewnego dnia{" "}
      ...
      <p data-index="55">
        Była to wielka sala oświetlona przez otwór w dachu. Na matach siedziało kilkudziesięciu nagich uczniów z woskowanymi tabliczkami w rękach. Jedna ściana była z gładkiego
      ...
      <p data-index="59">
        ...
        ziemi, ona jest ważniejszą od wszelkich innych zajęć. Ten, który korzysta ze sztuki pisania, jest szanowanym od dzieciństwa; on spełnia wielkie posłannictwa. Lecz ten,
        który nie bierze w niej udziału, żyje w nędzy.
      </p>
      <p data-index="60">
        Nauki szkolne są ciężkie jak góry; ale jeden ich dzień wystarczy wam na całą wieczność. Więc prędko, jak najprędzej poznajcie się z nimi i pokochajcie… Stan pisarza jest
        książęcym stanem, jego kałamarz i księga dają mu przyjemności i bogactwa!…
      </p>
      <p data-index="61">
        Po szumnej przemowie o dostojeństwie nauk, czego od trzech tysięcy lat bez zmiany słuchali egipscy uczniowie, mistrz wziął kredkę i na alabastrowej ścianie zaczął pisać —
        alfabet. Każda litera wyrażała się za pomocą kilku symbolów hieroglificznych lub kilku znaków demotycznych<a href="#fn189" className="link-note"></a>. Rysunek oka, ptaka
        lub pióra oznaczał — A. Owca albo doniczka — B, człowiek stojący lub czółno — K, wąż — R, człowiek siedzący albo gwiazda — S. Obfitość znaków wyrażających każdą literę
        sprawiała, że nauka czytania i pisania była bardzo mozolnym zajęciem.
      </p>
      <p data-index="62">
        Toteż{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
      ...
      <p data-index="63">
        ...
        arytmetyczne stanowiły wyższy kurs i wykonywały się przy pomocy kulek.
      </p>
      <p data-index="64">
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          Ramzes{" "}
      ...
      <p data-index="65">
        Był to zarazem szpital, a raczej wielki ogród zasadzony mnóstwem drzew i zasiany wonnymi ziołami. Chorzy całe dnie przepędzali w powietrzu i słońcu, na łóżkach, w których
        zamiast materacy było wyciągnięte płótno.
      </p>
      <p data-index="66">
        Gdy{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
      ...
      <p data-index="70">
        „Uzdrowiło Izydę, uzdrowiło Izydę, uzdrowiło Horusa… O Izydo, wielka czarodziejko, uzdrów mnie, wyzwól ze wszystkich złych, szkodliwych, czerwonych rzeczy, od gorączki boga
        i gorączki bogini…
      </p>
      <p data-index="71">
      ...
      <p data-index="73">
        <span
          ...
          data-character="Wielki-lekarz-swiatyni-Hator"
          data-src-talking="/Pharaon/wielki-lekarz-swiatyni-hator.png"
      ...
      <p data-index="75">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />—
        Powiedz mi, święty ojcze: co to jest sztuka lekarska i na czym polegają jej sposoby? Bo ja słyszałem, że choroba jest to zły duch, który osiedla się w człowieku i dręczy go
        z głodu, dopóki nie dostanie właściwej sobie żywności. I że jeden zły duch, czyli choroba, karmi się miodem, inny oliwą, a inny — zwierzęcymi odchodami. Lekarz więc
        powinien — naprzód wiedzieć; jaki duch zamieszkał w chorym, a następnie — jakich ten duch potrzebuje pokarmów, ażeby nie trapił człowieka?…
      </p>
      <p data-index="76">Kapłan zamyślił się i odparł:</p>
      <p data-index="77">
        <span
          className="character-placeholder character-talking"
          data-character="Wielki-lekarz-swiatyni-Hator"
      ...
      <p data-index="78">
        Wyobraź sobie, że człowiek jest chory na wątrobę. Otóż my, kapłani, wiemy, że wątroba znajduje się pod wpływem gwiazdy Peneter-Dewa
        <a href="#fn192" className="link-note"></a> i że leczenie musi zależyć od tej gwiazdy.
      </p>
      <p data-index="79">
        Lecz tu mędrcy dzielą się na dwie szkoły. Jedni twierdzą, że potrzeba choremu na wątrobę podawać wszystko to, nad czym Peneter-Dewa ma władzę, a zatem: miedź, lapis-lazuli,
        wywary z kwiatów, przede wszystkim z werweny i waleriany, nareszcie różne części ciała turkawki i kozła. Inni zaś lekarze sądzą, że gdy wątroba jest chora, to właśnie
        trzeba ją leczyć środkami przeciwnymi. A ponieważ przeciwnikiem Peneter-Dewy jest Sebeg<a href="#fn193" className="link-note"></a>, więc lekarstwami będą: żywe srebro,
        szmaragd i agat, leszczyna i podbiał tudzież części ciała żaby i sowy utarte na proszek.
      </p>
      <p data-index="80">
        Lecz nie jest to jeszcze wszystko. Trzeba bowiem pamiętać o dniu, miesiącu i porze dnia, każdy bowiem z tych przeciągów czasu zostaje pod wpływem gwiazdy, która może
        wspierać lub osłabiać działanie lekarstwa. Trzeba nareszcie pamiętać: jaka gwiazda i jaki znak Zodiaku panuje nad chorym. Dopiero gdy lekarz wszystkie te rzeczy weźmie pod
      ...
      <p data-index="81">
        ...
        czy wszystkim chorym pomagacie w świątyni?
      </p>
      <p data-index="82">Kapłan potrząsnął głową.</p>
      <p data-index="83">
        <span
          className="character-placeholder character-talking"
          data-character="Wielki-lekarz-swiatyni-Hator"
          ...
          data-is-talking="true"
        />
        — Nie — rzekł. — Umysł ludzki, który musi ogarnąć tyle szczegółów, o jakich mówiłem, bardzo łatwo myli się. A co gorsza: duchy zawistne, geniusze innych świątyń, zazdrosne
        o swoją sławę, niejednokrotnie przeszkadzają lekarzowi i psują skutek lekarstw. Ostateczny więc wypadek może być rozmaitym: jeden chory całkiem przychodzi do zdrowia, inny
        tylko poprawia się, a trzeci pozostaje bez zmiany. Choć zdarzają się i tacy, którzy rozchorowują się jeszcze gorzej albo nawet umierają… Wola bogów!…
      </p>
      <p data-index="84">
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          Książę{" "}
