...
export const Chapter67: React.FC = () => {
  return (
    <section data-chapter="67">
      ...
      <p data-index="2">
        Kilkumiesięczna władza namiestnika była wielce pomyślną dla Egiptu
        <a href="#fn134" className="link-note">
          [134]
        </a>
        .{" "}
        <span className="character-highlighted" data-character="Herhor" data-src-listening="/Pharaon/herhor-listens.mp4">
      ...
      <p data-index="3">
        W ciągu tych krótkich rządów sprawiedliwość wypełniała się szybko, ale bez okrucieństwa, i lada kto nie śmiał bić egipskiego chłopa, który mógł odwoływać się do sądu,
      ...
      <p data-index="5">Dzięki tym środkom w ciągu trzech miesięcy nastał w państwie spokój i dobrobyt, a ludzie mówili:</p>
      <p data-index="6">
      ...
      <p data-index="10">Trwała dziwnie krótko, jakby rezultat jej z góry był przygotowany.</p>
      <p data-index="11">
      ...
      <p data-index="14">Między zebranymi przeleciał szmer.</p>
      <p data-index="15">
      ...
      <p data-index="23">
        <span className="character-placeholder character-talking" data-character="Herhor" data-src-talking="/Pharaon/herhor-speaks.mp4" data-is-talking="true" />— Ponieważ małżonka
        moja i jedyna dziedziczka tronu zrzekła się swoich praw, ponieważ tym sposobem skończyło się panowanie dwudziestej dynastii, musimy więc wybrać nowego władcę…
      </p>
      <p data-index="24">
      ...
      <p data-index="28">
        <span className="character-placeholder character-talking" data-character="Nitager" data-src-talking="/Pharaon/nitager-speaks.mp4" data-is-talking="true" />— Nigdy chyba nie
        zabraknie ludzi chętnych do tytułu faraona. Może nawet mielibyśmy ich nad potrzebę. Szczęściem, sami bogowie usuwając niebezpiecznych współzawodników ukazali nam człowieka
        najgodniejszego władzy. I zdaje mi się, że uczynię roztropnie, gdy zamiast przyjmować łaskawie ofiarowaną mi koronę, odpowiem:
      </p>
      <p data-index="29">
      ...
      <p data-index="34">
        <span className="character-placeholder character-talking" data-character="Herhor" data-src-talking="/Pharaon/herhor-speaks.mp4" data-is-talking="true" />— Nie podpisałeś
        mego wyboru, nie złożyłeś mi hołdu, i lękam się, czy nie będę musiał oblegać cię kiedy w świątyni Ptah…
      </p>
      <p data-index="35">
      ...
      <p data-index="36">
        <span className="character-placeholder character-talking" data-character="Pentuer" data-src-talking="/Pharaon/pentuer-speaks.mp4" data-is-talking="true" />— Wybacz, wasza
        świątobliwość — odpowiedział kapłan — ale życie dworskie tak mnie znużyło, że jedynym dziś moim pragnieniem jest — uczyć się mądrości.
      </p>
      <p data-index="37">
      ...
      <p data-index="44">I dotknął ręką pokornie schylonej głowy kapłana.</p>
    </section>
  );
};
