  ...
  return (
    <section data-chapter="58">
      ...
      <p data-index="1">
        ...
        i Kaneh
        <a href="#fn89" className="link-note">
          [89]
        </a>
        , które leżały prawie naprzeciw siebie: jedno na wschodnim, drugie na zachodnim brzegu Nilu.
      </p>
      <p data-index="2">
        W Tan-ta-ren były dwa miejsca znakomite: sadzawka, w której hodowano krokodyle, i świątynia Hator posiadająca wyższą szkołę. Tu uczono medycyny, pieśni pobożnych, sposobów
      ...
      <p data-index="11">
        ...
        krokodylom mamy dobrą wodę w Nilu, którą bez ich pomocy trulibyśmy się…
      </p>
      <p data-index="12">
      ...
      <p data-index="13">Oto sekret naszych świątyń przeznaczonych dla zwierząt i naszego nabożeństwa do nich. Okadzamy to, co lud powinien szanować, bo ma z tego pożytek.</p>
      <p data-index="14">
        W świątyni Hator{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          faraon{" "}
      ...
      <p data-index="27">
        Tam nie było sławnych świątyń, okadzanych krokodylów i złotych tablic z gwiazdami. Natomiast kwitnęło garncarstwo i handel. Stamtąd szły dwa trakty do portów Morza
        Czerwonego: Koseir
        <a href="#fn91" className="link-note">
          [91]
        </a>{" "}
        i Berenice
        <a href="#fn92" className="link-note">
          [92]
        </a>
        , tudzież gościniec do gór porfirowych, skąd przywożono posągi i wielkie bryły budulca.
      </p>
      <p data-index="28">
      ...
      <p data-index="30">
        W owej epoce Teby były miastem ogromnym i zajmowały około dwunastu kilometrów kwadratowych powierzchni. Posiadały one największą w Egipcie świątynię Amona tudzież mnóstwo
      ...
      <p data-index="37">Nie odbyło się to jednak natychmiast.</p>
      <p data-index="38">Z pałacu przewieziono zmarłego do świątyni Ramzesa, gdzie dobę odpoczywał. Następnie z ogromnym przepychem wyprowadzono mumię do świątyni Amona-Ra.</p>
      <p data-index="39">Szczegóły obrzędu pogrzebowego były takie same jak w Memfis, choć w nierównie większych proporcjach.</p>
      <p data-index="40">
        Pałace królewskie, które na prawym brzegu Nilu leżały w stronie południowej miasta, ze świątynią Amona-Ra, która znajdowała się w północnej jego części, łączyła jedyna w
        swoim rodzaju droga. Była to aleja długa na dwa kilometry, bardzo szeroka, wysadzona nie tylko ogromnymi drzewami, ale jeszcze podwójnym rzędem sfinksów. Jedne z nich miały
        przy lwich ciałach głowy ludzkie, inne — głowy baranie. Posągów tych wzdłuż drogi stało kilkaset.
      </p>
      <p data-index="41">
        Po obu stronach alei cisnęły się nieprzebrane tłumy ludu z Teb i okolic; środkiem zaś gościńca posuwał się orszak pogrzebowy. Więc szły muzyki rozmaitych pułków, oddziały
        płaczek, chóry śpiewaków, wszystkie cechy rzemieślnicze i kupieckie, deputacje kilkudziesięciu nomesów ze swoimi bogami i chorągwiami, deputacje kilkunastu narodów
      ...
      <p data-index="43">Z pylonów wszystkich świątyń tebańskich odzywały się odgłosy podobne do grzmotu tudzież potężne a rzewne dźwięki blach spiżowych.</p>
      <p data-index="44">
        Pomimo że aleja sfinksów była wolna i szeroka, mimo że pochód odbywał się pod kierunkiem egipskich jenerałów, a więc w największym porządku, niemniej na przejście owych dwu
      ...
      <p data-index="48">
        Jak Luksor był całą dzielnicą pałaców królewskich w południowej, tak Karnak
        <a href="#fn94" className="link-note">
          [94]
        </a>{" "}
        był dzielnicą bogów w północnej stronie miasta. Głównym zaś ogniskiem Karnaku była świątynia Amona-Ra.
      </p>
      <p data-index="49">
        Sam ten gmach zajmował cztery morgi powierzchni, a otaczające go ogrody i stawy około czterdziestu morgów. Przed świątynią stały dwa pylony, wysokie na dziesięć piątr
        <a href="#fn95" className="link-note">
          [95]
        </a>
        . Podwórze, otoczone wspartym na kolumnach kurytarzem
        <a href="#fn96" className="link-note">
          [96]
        </a>
        , zajmowało blisko dwie morgi, zaś sala kolumnowa, w której gromadziły się stany uprzywilejowane, miała morgę rozległości. Nie był to już gmach, ale — okolica.
      </p>
      <p data-index="50">
        Owa sala, czyli hipostyl, miała przeszło sto pięćdziesiąt kroków długości i siedemdziesiąt pięć szerokości, jej zaś sufit opierał się na stu trzydziestu czterech kolumnach.
        Spomiędzy nich dwanaście środkowych słupów miało po piętnaście kroków obwodu i pięć do sześciu piętr
        <a href="#fn97" className="link-note">
          [97]
        </a>{" "}
        wysokości!…
      </p>
      <p data-index="51">Posągi rozmieszczone w świątyni, obok pylonów i nad świętym stawem, miały odpowiednie proporcje.</p>
      <p data-index="52">
      ...
      <p data-index="59">
        ...
        będzie łatwiej uporać się z jego budowniczymi?…
      </p>
      <p data-index="60">
      ...
      <p data-index="63">Ale uspokoił się. Była to tylko formalność, tak wreszcie stara jak egipskie dynastie. Nie chodziło w niej naprawdę o sąd, ale o pochwałę dla zmarłego.</p>
      <p data-index="64">
        Na znak dany przez{" "}
        <span className="character-highlighted" data-character="Herhor" data-src-listening="/Pharaon/herhor-listens.mp4">
          Herhora{" "}
      ...
      <p data-index="71">Oto w tym celu, ażeby poprawić świat, który jest bardzo zepsuty skutkiem upadku wiary.</p>
      <p data-index="72">Kto bowiem dziś zajmuje się pobożnością, kto myśli o spełnianiu woli bogów?</p>
      <p data-index="73">
        Na dalekiej północy widzimy duży naród asyryjski, który wierzy tylko w siłę miecza, a zamiast mądrością i nabożeństwem, zajmuje się podbijaniem ludów. Bliżej nas siedzą
        Fenicjanie, dla których bogiem jest złoto, a nabożeństwem oszukiwanie i lichwa. Inne wreszcie ludy, jak Chetowie
        <a href="#fn100" className="link-note">
          [100]
        </a>{" "}
        na wschodzie, Libijczycy na zachodzie, Etiopowie na południu i Grecy na Morzu Śródziemnym, są to barbarzyńcy i rabusie. Zamiast pracować kradną, a zamiast ćwiczyć się w
        mądrości piją, grają w kości albo wysypiają się jak strudzone bydlęta.
      </p>
      <p data-index="74">Na świecie jest jeden tylko naród prawdziwie pobożny i mądry — egipski; lecz zobaczcie, co się i tutaj dzieje?</p>
      <p data-index="75">
        Skutkiem napływu cudzoziemców, pozbawionych wiary, religia u nas upadła. Szlachta i dostojnicy przy kubkach wina drwią z bogów i wiecznego życia, a lud obrzuca błotem
        święte posągi i nie składa ofiar świątyniom.
      </p>
      <p data-index="76">
        Miejsce pobożności zajął zbytek, mądrości — rozpusta. Każdy chce nosić ogromne peruki, namaszczać się osobliwymi woniami, posiadać tkane złotem koszule i fartuszki, stroić
        się w łańcuchy i bransolety wysadzane drogimi kamieniami. Placek pszenny już mu nie wystarcza: on chce ciastka z mlekiem i miodem; piwem myje nogi, zaś pragnienie gasi
      ...
      <p data-index="81">
        „Horus wół, Apis silny, który połączył korony królestwa, krogulec złoty rządzący szablą, zwycięzca dziewięciu narodów, król Wyższego i Niższego Egiptu, władca dwu światów,
        syn słońca Amen-mer-Ramessu, ukochany przez Amon-Ra, pan i władca Tebaidy, syn Amon-Ra, przybrany za syna przez Horusa, a spłodzony przez Hormacha, król Egiptu, władca
        Fenicji, panujący nad dziewięcioma narodami
      ...
      <p data-index="83">Niebawem nabożeństwo skończyło się i zebrani opuścili świątynię.</p>
      <p data-index="84">
      ...
      <p data-index="87">
        ...
        zasłonę, widzieli, że istota owa wisiała w powietrzu bez podparcia poruszając przy tym ustami i oczyma.
      </p>
      <p data-index="88">
        Nastąpił dalszy ciąg pogrzebu i łódź złota powiozła zmarłego już na drugą stronę Nilu. Pierwej jednak, otoczona ogromnym orszakiem: kapłanów, płaczek, wojska i ludu, wśród
        kadzideł, muzyki, płaczu i śpiewu przejechała główną ulicą Tebów.
      </p>
      <p data-index="89">
        Była to chyba najpiękniejsza ulica w egipskim państwie: szeroka, gładka, wysadzona drzewami. Cztero-, a nawet pięciopiętrowe domy jej od góry do dołu były wyłożone mozaiką
        lub pokryte kolorowanymi płaskorzeźbami. Co wyglądało tak, jakby na owych budowlach zawieszono olbrzymie, barwne dywany lub zasłonięto je kolosalnymi obrazami, które
        przedstawiały pracę kupców, rzemieślników, żeglarzy tudzież dalekie kraje i ludy.
      </p>
      <p data-index="90">Słowem, była to nie ulica, ale raczej niezmierna galeria obrazów, barbarzyńskich pod względem rysunku, jaskrawych pod względem kolorów.</p>
      <p data-index="91">
      ...
      <p data-index="92">
        W tym miejscu wśród rzeki znajdowała się duża wyspa, do której prowadził most zbudowany na czółnach. Ażeby uniknąć wypadku, jenerałowie komenderujący procesją jeszcze raz
        uszykowali orszak, ustawili po czterech ludzi w szeregu i nakazali im posuwać się bardzo wolno, unikając rytmicznych stąpań. W tym celu muzyki idące na czele gromady
        intonowały pieśni, każdą w innym takcie.
      </p>
      <p data-index="93">Po paru godzinach procesja przeszła pierwszy most, potem wyspę, potem drugi most i — znalazła się na lewym, zachodnim brzegu Nilu.</p>
      <p data-index="94">Jeżeli wschodnią połowę Tebów można nazwać miastem bogów i królów, to zachodnia była dzielnicą pamiątkowych świątyń i grobów.</p>
      <p data-index="95">
        Orszak posuwał się od Nilu w stronę gór, drogą środkową. Na południe od tej drogi stała na wzgórzu świątynia upamiętniająca zwycięstwa Ramzesa III, której ściany były
        pokryte wizerunkami ludów podbitych: Chetów
        <a href="#fn102" className="link-note">
          [102]
        </a>
        , Amorejczyków, Filistynów, Etiopów, Arabów, Libijczyków. Trochę poniżej wznosiły się dwa kolosalne posągi Amenhotepa II, których wysokość, mimo siedzącej postawy,
        odpowiada pięciu piętrom. Jedna z tych statui odznaczała się cudowną własnością: gdy padły promienie wschodzącego słońca, posąg wydawał dźwięki niby arfa
        <a href="#fn103" className="link-note">
          [103]
        </a>
        , której struny zrywają.
      </p>
      <p data-index="96">
        Jeszcze bliżej drogi, wciąż na lewo od niej, stało Rameseum, niezbyt wielka, ale piękna świątynia Ramzesa II. Jej przysionku pilnowały cztery posągi stojące, z królewskimi
        insygniami w rękach. Na dziedzińcu zaś wznosił się również posąg Ramzesa II, wysoki na cztery piętra.
      </p>
      <p data-index="97">
        Droga szła wciąż łagodnie pod górę i coraz wyraźniej widać było bardzo spadziste wzgórza podziurawione jak gąbka: były to groby egipskich dostojników. Przy wejściu do nich,
        między stromymi skałami, leżała bardzo oryginalna świątynia królowej Hatasu
        <a href="#fn104" className="link-note">
          [104]
        </a>
        . Budynek ten miał czterysta pięćdziesiąt kroków długości. Z dziedzińca otoczonego murem wchodziło się po schodach na dziedziniec otoczony kolumnami, pod którym była
        świątynia podziemna. Z dziedzińca zaś kolumnowego wchodziło się znowu po schodach do świątyni już wykutej w skale, pod którą były znowu podziemia.
      </p>
      <p data-index="98">
        Tym sposobem świątynia miała dwie kondygnacje: niższą i wyższą, z których jeszcze każda dzieliła się na górną i dolną. Schody były ogromne, opatrzone zamiast poręczy dwoma
        rzędami sfinksów; wejścia na każde schody pilnowały po dwa siedzące posągi.
      </p>
      <p data-index="99">
        Od świątyni Hatasu zaczynał się ponury wąwóz, który od grobów dygnitarzy prowadził do grobów królewskich. Zaś między dwoma tymi dzielnicami znajdował się wykuty w skale
        grób arcykapłana Retemenofa
        <a href="#fn105" className="link-note">
          [105]
        </a>
        : komnaty i korytarze tworzące go zajmowały około dwu morgów podziemnej powierzchni.
      </p>
      <p data-index="100">
        Droga w wąwozie staje się tak stromą, że wołom ciągnącym muszą pomagać ludzie i popychać łódź żałobną. Orszak posuwa się jakby po gzymsie wykutym z boku skały, wreszcie
        zatrzymuje się na obszernym placu o kilkanaście piętr
        <a href="#fn106" className="link-note">
          [106]
        </a>{" "}
        nad dnem wąwozu.
      </p>
      ...
      <p data-index="102">
        Przy blasku jaskrawych pochodni widać ściany wszystkich komnat pokryte modlitwami i obrazami, które odtwarzają wszystkie zajęcia i rozrywki zmarłego: polowania, budowę
        świątyń i kanałów, triumfalne przejazdy, uroczystości odprawiane na cześć bogów, walki wojsk z nieprzyjaciółmi, pracę ludu…
      </p>
      <p data-index="103">
      ...
      <p data-index="112">
        <strong>Płaczki</strong>. O ty, którego otaczało tylu sług, będziesz teraz w ziemi, która nakazuje samotność… Ty, który miałeś cienkie szaty i lubiłeś czystą bieliznę,
        leżysz teraz we wczorajszej odzieży!…
      </p>
      <p data-index="113">
        <strong>Chór I</strong>. W pokoju, w pokoju na Zachód, o panie nasz, idź w pokoju… Ujrzymy cię znowu, gdy dzień wieczności nadejdzie, albowiem idziesz do kraju, który łączy
        z sobą wszystkich ludzi
      ...
      <p data-index="123">
        <strong>Chór II</strong>. O wy, żyjący na ziemi, którzy tędy przechodzić będziecie, jeżeli wam życie miłe, a śmierć obrzydła, jeżeli pragniecie, ażeby dostojeństwa wasze
        przeszły na wasze potomstwo, odmawiajcie tę modlitwę, za pochowanym tu nieboszczykiem…
      </p>
      <p data-index="124">
        <span className="character-placeholder character-talking" data-character="Mefres" data-src-talking="/Pharaon/mefres-speaks.mp4" data-is-talking="true" />
        <strong>Mefres</strong>. O wy wielcy, wy prorocy, wy książęta, pisarze i faraonowie, wy inni ludzie, którzy za milion lat po mnie przyjdziecie, gdyby kto z was na miejscu
        mego nazwiska położył swoje, Bóg go skarze zniszczeniem jego osoby na tej ziemi…
      ...
      <p data-index="125">
        ...
        ludzką formę. Następnie pomimo krzyku, rozpaczy i oporu płaczek zanieśli ogromny ten ciężar do grobu.
      </p>
      <p data-index="126">
        Minąwszy przy świetle pochodni kilka korytarzy i komnat, zatrzymali się w jednej, gdzie była studnia. W otwór ten spuścili sarkofag i sami weszli za nim do podziemiów
        <a href="#fn111" className="link-note">
          [111]
        </a>{" "}
        dolnych. Tam ustawili sarkofag w ciasnym pokoiku i szybko zamurowali otwór tak, że najwprawniejsze oko nie odkryłoby wejścia do grobu. Następnie wrócili na górę i z równą
      ...
      <p data-index="130">Uczta zaczęła się świętym tańcem, któremu towarzyszył śpiew jednej z najwyższych kapłanek:</p>
      <p data-index="131">
      ...
      <p data-index="133">
        „Świat jest ciągłą zmianą i ciągłym odnawianiem. Mądry to układ losu, godne podziwu postanowienie Ozyrysa, że w miarę jak ciało z ubiegłych czasów ulega zniszczeniu i
        ginie, zostają po nim inne ciała…
      </p>
      <p data-index="134">
        Faraonowie, ci bogowie, którzy byli przed nami, spoczywają w swych piramidach; mumie i sobowtóry ich zostały. Choć pałace, które zbudowali, nie znajdują się już na dawnych
        miejscach, nie ma ich wcale…
      </p>
      <p data-index="135">
        Nie rozpaczaj więc, ale oddaj się swoim żądzom i szczęściu, i nie zużywaj twego serca, aż przyjdzie dla ciebie dzień, kiedy błagać będziesz, a Ozyrys, bóg, którego serce
        już nie bije, nie zechce wysłuchać próśb i błagań…
      </p>
      <p data-index="136">
        Żale całego świata nie wrócą szczęścia człowiekowi, który leży w mogile; używaj więc dni szczęścia i nie bądź leniwym w radości. Zaprawdę, nie ma człowieka, który by mógł
        zabrać z sobą dobro swoje na tamten świat — zaprawdę nie ma człowieka, który by tam poszedł i wrócił!…
