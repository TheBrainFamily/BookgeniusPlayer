...
export const Chapter46: React.FC = () => {
  return (
    <section data-chapter="46">
      ...
      <p data-index="1"> W nocy warty dały znać, że tłum żebrzących o łaskę Libijczyków już wszedł do wąwozu. Jakoż nad pustynią widać było łunę ich ognisk.</p>
      <p data-index="2">
        {" "}
      ...
      <p data-index="5"> O kilkaset kroków od Egipcjan, przy wyjściu z glaukońskiego wąwozu, stała smutna gromada Libijczyków błagających zwycięzcy o miłosierdzie.</p>
      <p data-index="6">
        {" "}
        Kiedy{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
      ...
      <p data-index="7">
        {" "}
        <span className="character-placeholder character-talking" data-character="Musawasa" data-src-talking="/Pharaon/musawasa.png" data-is-talking="true" />— Zaprawdę mówię wam,
        jest to krzyk wojska, które miłuje swego wodza!…
      </p>
      <p data-index="8">
        {" "}
      ...
      <p data-index="9">
        {" "}
        — Czy nie myślisz, że w takiej chwili roztropniej uczynimy, ufając chyżości naszych koni, aniżeli łasce faraonowego syna?… Ma to być wściekły lew, który nawet głaszcząc
      ...
      <p data-index="18">
        {" "}
        <span className="character-placeholder character-talking" data-character="Pentuer" data-src-talking="/Pharaon/pentuer-speaks.mp4" data-is-talking="true" />— Niech oblicze
        twoje nie pokaże im ani srogości, ani uciechy. Raczej bądź spokojny jak bóg Amon, który pogardza swymi wrogami i nie cieszy się z lada jakich triumfów…
      </p>
      <p data-index="19">
        {" "}
      ...
      <p data-index="21">
        {" "}
        <span className="character-placeholder character-talking" data-character="Musawasa" data-src-talking="/Pharaon/musawasa.png" data-is-talking="true" />— Jam jest twój sługa
        — odparł zapytany i znowu rzucił się na ziemię.
      </p>
      <p data-index="22">
        {" "}
        Gdy mu kazano wstać,{" "}
      ...
      <p data-index="23">
        ...
        mogłeś dopuścić się tak ciężkiego grzechu i podnieść rękę na ziemię bogów? Czyliżby opuściła cię dawna roztropność?
      </p>
      <p data-index="24">
        {" "}
        <span className="character-placeholder character-talking" data-character="Musawasa" data-src-talking="/Pharaon/musawasa.png" data-is-talking="true" />— Panie! — odparł
        chytry Libijczyk — żal pomieszał rozumy wygnanym żołnierzom jego świątobliwości, więc biegli na własną zgubę, ciągnąc za sobą mnie i moich. I wiedzą bogowie, jak długo
        ciągnęłaby się ta brzydka wojna, gdyby na czele armii wiecznie żyjącego faraona nie stanął sam Amon w twojej postaci. Jak pustynny wicher spadłeś, kiedy cię nie oczekiwano,
        tam, gdzie cię nie oczekiwano, a jak byk łamie trzcinę, tak ty skruszyłeś zaślepionego nieprzyjaciela. Po czym wszystkie ludy nasze zrozumiały, że nawet straszne pułki
        libijskie dopóty są coś warte, dopóki rzuca nimi twoja ręka.
      </p>
      <p data-index="25">
        {" "}
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />—
      ...
      <p data-index="27">
        {" "}
        Rozkaż tylko podwładnym twoim, aby byli sprawiedliwymi dla zawojowanego i do potęgi twej przyłączonego ludu. Niech twoi naczelnicy rządzą nami sumiennie i sprawiedliwie, a
        nie według złych chęci swoich, donosząc o nas fałszywie i pobudzając niełaskę twoją przeciw nam i dzieciom naszym. Rozkaż im, namiestniku dobrotliwego faraona, aby rządzili
        nami według woli twojej, oszczędzając swobodę, mienie, język i obyczaje ojców i przodków naszych.
      </p>
      <p data-index="28">
        {" "}
        Niech prawa twoje będą dla wszystkich poddanych ci ludów równe, niech urzędnicy twoi nie pobłażają jednym, a nie będą zbyt srogimi dla drugich. Niech wyroki ich będą dla
        wszystkich jednakie. Niech pobierają opłatę przeznaczoną na twe potrzeby i twój użytek, lecz nie podnoszą od nas innej w tajemnicy przed tobą, takiej, która nie wejdzie do
      ...
      <p data-index="33"> A teraz pokażcie mi dary przeznaczone dla jego świątobliwości, abym osądził, czy poruszą serce wszechmocnego faraona.</p>
      <p data-index="34">
        {" "}
        W tej chwili{" "}
      ...
      <p data-index="40"> — Zrobisz cud?</p>
      <Pentuer data-index="41"> </Pentuer>
      <p data-index="42"> — Czyliżbym potrafił? Pokażę mu tylko, że na tym świecie wielkiej radości towarzyszą wielkie strapienia.</p>
      ...
      <p data-index="45"> Odezwały się trąby i bębny i rozpoczęto pochód triumfalny.</p>
      <p data-index="46">
        {" "}
        Na czele szli nadzy niewolnicy z darami, pilnowani przez możnych Libijczyków. Więc niesiono złote i srebrne bogi, szkatułki napełnione wonnościami, emaliowane naczynia,
        tkaniny, sprzęty, wreszcie złote misy zasypane rubinami, szafirami i szmaragdami. Niewolnicy niosący je mieli ogolone głowy i opaski na ustach, ażeby który nie ukradł
        cennego klejnotu.
      </p>
      <p data-index="47">
        {" "}
      ...
      <p data-index="54"> — Nie poruszaj się, panie, i nie okazuj tysiącom twoich niewolników, że masz smutek w dniu triumfu…</p>
      <p data-index="55">
        {" "}
      ...
      <p data-index="57"> — Bogowie — szeptał prorok — ukarali zdradziecką Fenicjankę…</p>
      ...
      <p data-index="61"> — Złapana, ale musiano ją wysłać do wschodnich kolonii… Spadł bowiem na nią trąd…</p>
      ...
      <p data-index="65"> — Bądź spokojny, panie: gdybyś się zaraził, już byś go miał…</p>
      <p data-index="66">
        {" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          Książę
      ...
      <p data-index="73">
        {" "}
        Teraz nadciągnęła gromada Libijczyków prowadzących osobliwe zwierzęta. Na czele szedł jednogarbny wielbłąd z białawym włosem, jeden z pierwszych, jakiego złapano w pustyni.
        Za nim dwa nosorożce, stado koni i oswojony lew w klatce. A dalej mnóstwo klatek z różnobarwnymi ptakami, małpkami i małymi pieskami, przeznaczonymi dla dam dworskich. W
      ...
      <p data-index="79"> Następca poruszył się.</p>
      ...
      <p data-index="83"> — Czy także uciekła?…</p>
      <Pentuer data-index="84"> </Pentuer>
      <p data-index="85"> — Zmarła w więzieniu…</p>
      <Ksiaze-Ramzes data-index="86"> </Ksiaze-Ramzes>
      <p data-index="87"> — O bogowie!… Któż śmiał ją wtrącić?…</p>
      <Pentuer data-index="88"> </Pentuer>
      <p data-index="89"> — Sama oskarżyła się o zabójstwo syna twego…</p>
      <Ksiaze-Ramzes data-index="90"> </Ksiaze-Ramzes>
      <p data-index="91"> — Co?…</p>
      <p data-index="92">
        {" "}
      ...
      <p data-index="104"> — Hamuj się, panie, jak przystało na zwycięskiego wodza…</p>
      <Ksiaze-Ramzes data-index="105"> </Ksiaze-Ramzes>
      <p data-index="106"> — Czyliż podobna zwyciężyć taką boleść!… O niemiłosierni bogowie!…</p>
      ...
      <p data-index="111"> Teraz ukazali się egipscy żołnierze, niosący pełne kosze rąk uciętych poległym Libijczykom.</p>
      <p data-index="112">
        {" "}
        Na ten widok{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
      ...
      <p data-index="114">
        {" "}
        Tym nieprzewidzianym wypadkiem zakończył się pierwszy triumf następcy egipskiego tronu. Ale łzy, jakie wylał nad uciętymi rękoma, mocniej aniżeli zwycięska bitwa
        przywiązały do niego Libijczyków. Nikt też nie dziwił się, że dokoła ognisk zasiedli w zgodzie żołnierze egipscy i Libijczycy, dzieląc się chlebem i pijąc wino z tych
        samych kubków. Miejsce wojny i nienawiści, które miały trwać całe lata, zajęło głębokie uczucie spokoju i zaufania.
      </p>
      <p data-index="115">
        {" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
      ...
      <p data-index="117">
        {" "}
        <span className="character-placeholder character-talking" data-character="Kalipos" data-src-talking="/Pharaon/kalipos-speaks.mp4" data-is-talking="true" />— Przychodzimy
      ...
      <Ksiaze-Ramzes data-index="119"> </Ksiaze-Ramzes>
      <p data-index="120">
        {" "}
      ...
      <Kalipos data-index="122"> </Kalipos>
      <p data-index="123">
        {" "}
        — Panie nasz, pozwól otworzyć serce przed tobą. Dobrze wiemy, że zrobienie mumii jest dla człowieka korzystniejszym niż spalenie go. Gdy bowiem dusza spalonego natychmiast
        przenosi się do krajów wiekuistych, dusza zabalsamowanego może tysiące lat żyć na tej ziemi i cieszyć się jej pięknością.
      </p>
      <p data-index="124">
        {" "}
      ...
      <Ksiaze-Ramzes data-index="126"> </Ksiaze-Ramzes>
      <p data-index="127"> — Czyńcie — rzekł — jak uważacie za potrzebne.</p>
      <Kalipos data-index="128"> </Kalipos>
      <p data-index="129"> — A jeżeli nie wydadzą nam ciała?…</p>
      <Ksiaze-Ramzes data-index="130"> </Ksiaze-Ramzes>
      <p data-index="131"> — Tylko przygotujcie stos, a resztą sam się zajmę.</p>
      <p data-index="132">
        {" "}
        Grecy wyszli,{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
