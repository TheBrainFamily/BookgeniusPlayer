...
export const Chapter46: React.FC = () => {
  return (
    <section data-chapter="46">
      ...
      <p data-index="35">— Boję się, ażeby młodemu panu naszemu triumf nie za mocno uderzył do głowy. Czy nie sądzisz, że byłoby roztropnym przerwać w jaki sposób uroczystość?…</p>
      <p data-index="36">
        — Przeciwnie — odparł{" "}
        <span className="character-highlighted" data-character="Pentuer" data-src-listening="/Pharaon/pentuer-listens.mp4">
          Pentuer{" "}
      ...
      <p data-index="37">— Zrobisz cud?</p>
      <p data-index="38">— Czyliżbym potrafił? Pokażę mu tylko, że na tym świecie wielkiej radości towarzyszą wielkie strapienia.</p>
      <p data-index="39">
      ...
      <p data-index="40">Odezwały się trąby i bębny i rozpoczęto pochód triumfalny.</p>
      <p data-index="41">
      ...
      <p data-index="46">— Nie poruszaj się, panie, i nie okazuj tysiącom twoich niewolników, że masz smutek w dniu triumfu…</p>
      <p data-index="47">
      ...
      <p data-index="48">— Bogowie — szeptał prorok — ukarali zdradziecką Fenicjankę…</p>
      <p data-index="49">
        — Złapana?… — spytał{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          książę{" "}
      ...
      <p data-index="50">— Złapana, ale musiano ją wysłać do wschodnich kolonii… Spadł bowiem na nią trąd…</p>
      <p data-index="51">
        — O bogowie!… — szepnął{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          Ramzes{" "}
      ...
      <p data-index="61">Następca poruszył się.</p>
      <p data-index="62">
        — Twoja druga kobieta,{" "}
      ...
      <p data-index="63">— Czy także uciekła?…</p>
      <p data-index="64">— Zmarła w więzieniu…</p>
      <p data-index="65">— O bogowie!… Któż śmiał ją wtrącić?…</p>
      <p data-index="66">— Sama oskarżyła się o zabójstwo syna twego…</p>
      <p data-index="67">— Co?…</p>
      <p data-index="68">
      ...
      <p data-index="75">— Hamuj się, panie, jak przystało na zwycięskiego wodza…</p>
      <p data-index="76">— Czyliż podobna zwyciężyć taką boleść!… O niemiłosierni bogowie!…</p>
      <p data-index="77">
        — Dziecko zabił{" "}
        <span className="character-highlighted" data-character="Lykon" data-src-listening="/Pharaon/lykon-listens.mp4">
          Lykon{" "}
      ...
      <p data-index="79">Teraz ukazali się egipscy żołnierze, niosący pełne kosze rąk uciętych poległym Libijczykom.</p>
      <p data-index="80">
        Na ten widok{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          książę Ramzes{" "}
      ...
      <p data-index="92">— Czyńcie — rzekł — jak uważacie za potrzebne.</p>
      <p data-index="93">— A jeżeli nie wydadzą nam ciała?…</p>
      <p data-index="94">— Tylko przygotujcie stos, a resztą sam się zajmę.</p>
      <p data-index="95">
        Grecy wyszli,{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          książę{" "}
