...
export const Chapter11: React.FC = () => {
  return (
    <section data-chapter="11">
      ...
      <p data-index="37">
        <span className="character-placeholder character-talking" data-character="Dutmoze" data-src-talking="/Pharaon/dutmoze-speaks.mp4" data-is-talking="true" />
        ...
        prędzej można zobaczyć sygnał w Memfisie.\' Więc poszliśmy na górę, skąd łatwiej można zobaczyć sygnał w Memfisie. Wtedy do mojej żony zbliżył się jakiś żołnierz i mówi:
        „Pójdź ze mną w ten ogród, to znajdziemy winogron albo i co jeszcze.\' Więc moja żona poszła w ogród z owym żołnierzem, a ja wpadłem w wielki gniew i zaglądałem do nich
        przez mur. Czy jednak rzucali kamienie do domu{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          księcia{" "}
        </span>
      ...
      <p data-index="45">
        <span className="character-placeholder character-talking" data-character="Dutmoze" data-src-talking="/Pharaon/dutmoze-speaks.mp4" data-is-talking="true" />
        \n — Po cóż bym rzucał, panie życia i śmierci? Gdybym trafił żonę, sobie zrobiłbym niepokój na cały tydzień, a gdyby żołnierza, dostałbym pięścią w brzuch, ażby mi język
      ...
      <p data-index="48">
        <span className="character-placeholder character-talking" data-character="Anupa" data-src-talking="/Pharaon/anupa-speaks.mp4" data-is-talking="true" />
        \n — Oko słońca — odparł chłop — naczynie mądrości, ty wiesz najlepiej, że ja napadu nie robiłem. Tylko przyszedł do mnie sąsiad i mówi: „
        <span className="character-highlighted" data-character="Anupa" data-src-listening="/Pharaon/anupa-listens.mp4">
          Anupa{" "}
        </span>
        , chodź na górę, bo Nil przybiera.\' A ja mówię: czy aby przybiera? A on mówi: „Jesteś głupszy od osła, bo przecież osioł usłyszałby muzykę na górze, a ty nie słyszysz.\'
        Ja zaś odpowiadam: głupi jestem, bom się pisać nie uczył, ale za pozwoleniem, co innego jest muzyka, a co innego przybór. A on na to: „Gdyby nie było przyboru, ludzie nie
      ...
      <p data-index="52">
        <span className="character-placeholder character-talking" data-character="Anupa" data-src-talking="/Pharaon/anupa-speaks.mp4" data-is-talking="true" />
        \n — Za pozwoleniem waszej czujności, to nie był kapłan, ale chyba jakiś duch, który pilnuje domu{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          księcia następcy{" "}
        </span>{" "}
        (oby żył wiecznie!…).\n
      ...
      <p data-index="60">
        <span className="character-placeholder character-talking" data-character="Anupa" data-src-talking="/Pharaon/anupa-speaks.mp4" data-is-talking="true" />
        \n — Gdzież bym śmiał rzucać kamienie w ogród{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          następcy tronu{" "}
        </span>
      ...
      <p data-index="67">
        \n — Spojrzyj, najdostojniejszy, na tą skrzynię. Jest ona pełna papirusów, na których spisano akta sprawy. Sędzia z Memfisu co dzień otrzymuje raporty o jej przebiegu i
        donosi jego świątobliwości. W cóż obróciłaby się praca tylu uczonych pisarzy i wielkich mężów, gdyby oskarżonych uwolnić?\n
      </p>
      <p data-index="68">
        <span className="character-placeholder character-talking" data-character="Ksiaze-Ramzes" data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" data-is-talking="true" />
      ...
      <p data-index="77">
        <span className="character-placeholder character-talking" data-character="Wielki-pisarz" data-src-talking="/Pharaon/wielki-pisarz-speaks.mp4" data-is-talking="true" />
        \n — My, dostojny panie, wiedzieć o tym nie możemy, gdyż o winie lub niewinności rozstrzyga prawo i sąd. Jedno dla mnie jest pewnym, że państwo nie może ścierpieć, ażeby
        wpadano do czyjegoś ogrodu, a tym bardziej, ażeby podnoszono rękę na własność{" "}
        <span className="character-highlighted" data-character="Ksiaze-Ramzes" data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4">
          następcy tronu{" "}
        </span>
        .\n
