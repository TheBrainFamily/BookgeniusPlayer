...
export const Chapter18: React.FC = () => {
  return (
    <section data-chapter="18">
      ...
      <p data-index="1">
        Od dnia kiedy został namiestnikiem Dolnego Egiptu, zaczęło się dla <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzesa
        </span> życie niesłychanie uciążliwe, jakiego nie domyślał się nawet, pomimo że urodził się i wyrósł wśród królewskiego dworu.
      </p>
      <p data-index="2">
        Wprost tyranizowano go, a katami byli interesanci różnych gatunków i rozmaitych klas społecznych.
      </p>
      <p data-index="3">
        Już w pierwszym dniu, na widok tłumu ludzi, którzy, cisnąc się i popychając, mimowolnie wydeptywali mu trawniki, łamali drzewa, nawet psuli mur otaczający, <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          następca
        </span> do swej willi zażądał warty. Ale trzeciego dnia musiał uciec ze swego domu w obręb właściwego pałacu, gdzie z powodu gęstej straży, a nade wszystko wysokich murów, dostęp dla zwykłych ludzi był utrudniony.
      </p>
      <p data-index="4">
        W ciągu dekady, poprzedzającej wyjazd, przed oczyma <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzesa
        </span> przesunęli się przedstawiciele całego Egiptu, jeżeli nie całego ówczesnego świata.
      </p>
      <p data-index="5">
      ...
      <p data-index="6">
        Ludzie ci nie żądali niczego, wypowiadali tylko swoją radość. Ale <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          książę
        </span>, słuchając ich od rana do południa i od południa do wieczora, czuł zamęt w głowie i drżenie we wszystkich członkach.
      </p>
      <p data-index="7">
      ...
      <p data-index="8">
        Jeszcze nie skończyła się procesja hołdowników, a już nadciągnęła armia proszących. Inwalidzi, wdowy i sieroty po oficerach domagali się pensji; szlachetni panowie — dworskich urzędów dla synów. Inżynierowie przynosili projekta nowych sposobów irygacji, lekarze środki przeciw wszelkim chorobom, wróżbici horoskopy. Krewni więźniów podawali prośby o zmniejszenie kary, skazani na śmierć o darowanie życia, chorzy błagali, aby <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          następca
        </span> dotknął ich lub udzielił im swej śliny.
      </p>
      <p data-index="9">
        Zgłaszały się wreszcie piękne kobiety tudzież matki dorodnych córek, pokornie i natrętnie prosząc, aby <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          namiestnik
        </span> przyjął je do swego domu. Niektóre oznaczały wysokość żądanej pensji, zachwalały swoje dziewictwo i talenta.
      </p>
      <p data-index="10">
        Po dziesięciu dniach przypatrywania się co chwilę nowym osobom i twarzom i wysłuchiwania próśb, które zaspokoić mógłby chyba majątek całego świata i boska potęga, książę <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> wyczerpał się. Nie mógł sypiać, był tak rozdrażniony, że irytował go brzęk muchy, i chwilami nie rozumiał: o czym mówią do niego?
      </p>
      <p data-index="11">
        W tym położeniu znowu <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
          Herhor
        </span> przyszedł mu z pomocą. Możnym kazał zapowiedzieć, że <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          książę
        </span> już nie przyjmuje interesantów, a na lud, który, mimo kilkukrotnych wezwań do rozejścia się, wciąż czekał, wysłał kompanię numidyjskich żołnierzy z kijami. Tym udało się bez porównania łatwiej aniżeli <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzesowi
        </span> zadowolnić ludzką pożądliwość. Zanim bowiem minęła godzina, interesanci znikli z placu niby mgła, a ten i ów przez parę dni następnych okładał wodą głowę lub inną rozbitą część ciała.
      </p>
      <p data-index="12">
        Po tej próbie piastowania najwyższej władzy <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          książę
        </span> uczuł głęboką wzgardę dla ludzi i wpadł w apatię.
      </p>
      <p data-index="13">
        Dwa dni leżał na kanapie, z rękoma pod głową, bezmyślnie patrząc w sufit. Już nie dziwił się, że jego świątobliwy <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
          ojciec
        </span> przepędza czas pod ołtarzami bogów, lecz nie mógł pojąć, jakim sposobem <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
          Herhor
        </span> daje sobie radę z nawałem podobnych interesów, które, jak burza, nie tylko przewyższają siły człowieka, lecz nawet mogą zmiażdżyć.
      </p>
      <p data-index="14">
      ...
      <p data-index="15">
        Był tak zatrwożony bezsilnością na stanowisku władcy, że — wezwał <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
          Herhora
        </span> i jękliwym głosem opowiedział mu swoje strapienie.
      </p>
      <p data-index="16">
        <span 
          className="character-highlighted" 
        ...
        >
          Mąż stanu
        </span> z uśmiechem słuchał biadań młodego sternika nawy państwowej, wreszcie rzekł:
      </p>
      <p data-index="17">
        <span 
      ...
      <p data-index="20">
        ...
        >
          książę
        </span>, wszystko chciałeś wykonać sam; sam wysłuchać i załatwić wszelkie interesa. To przechodzi człowiecze siły.
      </p>
      <p data-index="21">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— Jakże miałem robić inaczej, jeżeli między proszącymi znajdowali się niewinnie pokrzywdzeni albo zasługa nie wynagrodzona? Przecież fundamentem państwa jest sprawiedliwość — odparł <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
      ...
      <p data-index="22">
        ...
        >
          książę
        </span> możesz wysłuchać dziennie bez zmęczenia? — spytał <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
      ...
      <p data-index="24">
        <span 
          ...
          data-src-talking="/Pharaon/herhor-speaks.mp4" 
          data-is-talking="true"
        />\n— Toś szczęśliwy. Ja słucham najwyżej sześciu lub dziesięciu, lecz nie są nimi interesanci, tylko — wielcy pisarze, nadzorcy i ministrowie. Każdy z nich nie donosi mi drobiazgów, lecz rzeczy najważniejsze, jakie dzieją się: w armii, w dobrach <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
          faraona
        </span>, w sprawach religijnych, w sądach, w nomesach, w ruchach Nilu. Dlatego zaś nie donoszą mi błahostek, że każdy z nich, zanim przyszedł do mnie, musiał wysłuchać dziesięciu pisarzy mniejszych. Każdy mniejszy pisarz i dozorca zebrał wiadomości od dziesięciu podpisarzy i poddozorców, a tamci znowu wysłuchali raporty od dziesięciu niższych urzędników.
      </p>
      <p data-index="25">
        Tym sposobem ja i <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
          jego świątobliwość
        </span>, rozmawiając tylko z dziesięcioma ludźmi dziennie, wiemy, co ważnego stało się w stu tysiącach punktów kraju i świata.
      </p>
      <p data-index="26">
        Wartownik, który czuwa na kawałku ulicy w Memfis, widzi tylko parę domów. Dziesiętnik zna całą ulicę, setnik oddział miasta, naczelnik całe miasto. <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
          Faraon
        </span> zaś stoi ponad nimi wszystkimi, niby na najwyższym pylonie świątyni Ptah, i widzi nie tylko Memfis, ale jeszcze miasta: Sochem, On, Cherau, Turra, Tetaui, ich okolice i kawałek pustyni zachodniej.
      </p>
      <p data-index="27">
        Z tej wysokości <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
          jego świątobliwość
        </span> nie spostrzega wprawdzie ludzi skrzywdzonych albo nie nagrodzonych, ale dojrzy tłum gromadzących się bez zajęcia robotników. Nie zobaczy żołnierza w szynkowni, ale pozna, czy pułk odbywa musztrę. Nie widzi, co gotuje na obiad jakiś chłop albo mieszczanin, ale dostrzeże pożar zaczynający się w dzielnicy.
      </p>
      <p data-index="28">
        Ten porządek państwowy — mówił ożywiając się <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
          Herhor
        </span> — jest naszą chwałą i potęgą. A kiedy Snofru, jeden z faraonów najpierwszej dynastii, spytał pewnego kapłana, jaki by sobie pomnik wystawić? — ten odpowiedział:
      </p>
      <p data-index="29">
      ...
      <p data-index="34">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— Więc dzisiaj my napadnijmy ich, korzystając z nieładu! — zawołał <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
      ...
      <p data-index="35">
        <span 
          ...
          data-src-talking="/Pharaon/herhor-speaks.mp4" 
          data-is-talking="true"
        />\n— Jeszcze nie wyleczyliśmy się z poprzednich naszych zwycięstw — odparł zimno <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
          Herhor
        </span> i zaczął żegnać <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
      ...
      <p data-index="36">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— Alboż zwycięstwa osłabiły nas?… — wybuchnął <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          następca
        </span>. — Alboż nie zwieźliśmy skarbów?…
      </p>
      <p data-index="37">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/herhor-speaks.mp4" 
          data-is-talking="true"
        />\n— A czy nie psuje się topór, którym ścinamy drzewo?… — zapytał <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
      ...
      <p data-index="38">
        ...
        >
          Książę
        </span> zrozumiał, że wielki <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
          minister
        </span> chce spokoju za wszelką cenę, pomimo że sam jest naczelnikiem armii.
      </p>
      <p data-index="39">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="40">
        Na parę dni przed wyjazdem <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> wezwany został do <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
        ...
        >
          Faraon
        </span> siedział na fotelu w marmurowej sali, w której nie było nikogo, a czterech wejść strzegły nubijskie warty.
      </p>
      <p data-index="41">
        Obok fotelu królewskiego stał taboret dla <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          księcia
        </span> i mały stolik założony dokumentami pisanymi na papirusie. Na ścianach były kolorowane płaskorzeźby przedstawiające zajęcia rolne, a w rogach sali sztywne posągi Ozyrysa, z melancholijnym uśmiechem na ustach.
      </p>
      <p data-index="42">
        Kiedy <span 
          className="character-highlighted" 
      ...
      <p data-index="43">
        ...
        >
          książę
        </span>, twoje dokumenta, jako wódz i namiestnik. Cóż, podobno pierwsze dni władzy zmęczyły cię?…
      </p>
      <p data-index="44">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="45">
        <span 
          ...
          data-src-talking="/Pharaon/ramzes-xii-speaks.mp4" 
          data-is-talking="true"
        />\n— Pochlebca!… — uśmiechnął się <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
          pan
        </span>. — Pamiętaj, że nie chcę, ażebyś się zapracowywał… Baw się, młodość potrzebuje rozrywki… Nie znaczy to jednak, ażebyś nie miał ważnych spraw do załatwienia.
      </p>
      <p data-index="46">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="53">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— Stanie się, jak rozkazujesz, <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
      ...
      <p data-index="56">
        Otóż Asyria, mój <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          książę
        </span>, jest taką górą. Przez całe wieki panuje w niej spokój i cisza, lecz nagle zrywa się wewnętrzna burza, nie wiadomo skąd wylewają się wielkie armie i niszczą spokojnych sąsiadów.
      </p>
      <p data-index="57">
      ...
      <p data-index="58">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— Czy potrafię?… — cicho spytał <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
      ...
      <p data-index="59">
        <span 
          ...
          data-src-talking="/Pharaon/ramzes-xii-speaks.mp4" 
          data-is-talking="true"
        />\n— Trzeba nauczyć się patrzeć — mówił <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
          władca
        </span>. — Jeżeli chcesz co dobrze poznać, nie poprzestawaj na świadectwie własnych oczu, ale zapewnij sobie pomoc kilku par cudzych.
      </p>
      <p data-index="60">
      ...
      <p data-index="64">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— Między ludźmi, u których mam zasięgać zdania o Asyrii nie wspomniałeś, <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
          ojcze
        </span>, Greków — wtrącił <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
      ...
      <p data-index="65">
        ...
        >
          Pan
        </span> pokiwał głową z dobrotliwym uśmiechem.
      </p>
      <p data-index="66">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="70">
        ...
        >
          ojcze
        </span>, zdajesz się nie ufać Grekom?
      </p>
      <p data-index="71">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="76">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— A co mam sądzić o Fenicjanach? — spytał <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
      ...
      <p data-index="79">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— A Żydzi?… — szepnął <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          książę
        </span>, spuszczając oczy.
      </p>
      <p data-index="80">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="81">
        ...
        >
          Faraon
        </span> był już zmęczony. Więc <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          książę
        </span> padł przed nim na twarz, a otrzymawszy uściśnienie ojcowskie, udał się do <span 
          className="character-highlighted" 
      ...
      <p data-index="82">
        ...
        >
          Pani
        </span> siedząc w swym gabinecie tkała cienkie płótno na suknie dla bogów, a jej damy służebne szyły i haftowały odzież albo robiły bukiety. Młody kapłan przed posągiem Izydy palił kadzidło.
      </p>
      <p data-index="83">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— Przychodzę — rzekł <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          książę
        </span> — podziękować ci, <span 
          className="character-highlighted" 
          data-character="Nikotris" 
          data-src-listening="/Pharaon/nikotris-listens.mp4"
        >
      ...
      <p data-index="84">
        ...
        >
          Królowa
        </span> powstała i objąwszy syna za szyję, mówiła ze łzami:
      </p>
      <p data-index="85">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="86">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— Przepraszam… przepraszam!… — mówił <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
      ...
      <p data-index="87">
        ...
        >
          Pani
        </span> wyprowadziła go do ogródka, w którym rosły osobliwe kwiaty, a gdy zostali bez świadków — rzekła:
      </p>
      <p data-index="88">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="89">
        ...
        >
          Sarze
        </span>? — spytał zdziwiony <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span>. — Ona brzemienna?… Nic mi o tym nie wspomniała…
      </p>
      <p data-index="90">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="91">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— Ależ ja jej nie mam zamiaru brać!… — zawołał <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          książę
        </span>. — Tylko… dlaczego ona kryje się przede mną… jakby dziecko nie było moim?…
      </p>
      <p data-index="92">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/nikotris-speaks.mp4" 
          data-is-talking="true"
        />\n— Nie bądźże podejrzliwym!… — zgromiła go <span 
          className="character-highlighted" 
          data-character="Nikotris" 
          data-src-listening="/Pharaon/nikotris-listens.mp4"
        >
          pani
        </span>. — Jest to zwykła wstydliwość młodych dziewcząt… Wreszcie może ukrywała swój stan z obawy, abyś jej nie porzucił?…
      </p>
      <p data-index="93">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— Przecież nie wezmę jej do mego dworu! — przerwał <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          książę
        </span> z taką niecierpliwością, że oczy <span 
          className="character-highlighted" 
          data-character="Nikotris" 
          data-src-listening="/Pharaon/nikotris-listens.mp4"
        >
          królowej
        </span> uśmiechnęły się, ale przysłoniła je rzęsami.
      </p>
      <p data-index="94">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="95">
        ...
        >
          Ramzes
        </span>. — Mój pierwszy syn, choć nie będzie posiadał praw książęcych, musi być tak postawiony, abym ja go się nie wstydził ani on nie miał żalu do mnie.
      </p>
      <p data-index="96">
        Po pożegnaniu się z <span 
          className="character-highlighted" 
          data-character="Nikotris" 
          data-src-listening="/Pharaon/nikotris-listens.mp4"
        >
        ...
        >
          Ramzes
        </span> chciał jechać do <span 
          className="character-highlighted" 
          data-character="Sara" 
          data-src-listening="/Pharaon/sara-listens.mp4"
        >
          Sary
        </span> i w tym celu wrócił do swoich pokojów.
      </p>
      <p data-index="97">
        Wstrząsały nim dwa uczucia: gniew na <span 
          className="character-highlighted" 
          data-character="Sara" 
          data-src-listening="/Pharaon/sara-listens.mp4"
        >
          Sarę
        </span>, że ukrywała przed nim powody swej słabości, i — duma, że on ma być ojcem.
      </p>
      <p data-index="98">
      ...
      <p data-index="99">
        ...
        >
          Książę
        </span> był zachwycony i rozrzewniony. Chciał zobaczyć <span 
          className="character-highlighted" 
          data-character="Sara" 
          data-src-listening="/Pharaon/sara-listens.mp4"
        >
          Sarę
        </span>, zgromić ją, a potem uściskać i obdarować. Gdy jednak wrócił do swojej części pałacu, zastał dwu nomarchów z Dolnego Egiptu, którzy przyszli zdać mu raport o nomesach. A gdy wysłuchał ich, był już zmęczony. Nadto miał u siebie wieczorne przyjęcie, na które nie chciał się spóźnić.
      </p>
      <p data-index="100">
      ...
      <p data-index="102">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— Masz ty tą klatkę, którą dała ci <span 
          className="character-highlighted" 
          data-character="Sara" 
          data-src-listening="/Pharaon/sara-listens.mp4"
        >
          Sara
        </span> wówczas, kiedyśmy witali <span 
          className="character-highlighted" 
          data-character="Ramzes-XII" 
          data-src-listening="/Pharaon/ramzes-xii-listens.mp4"
        >
      ...
      <p data-index="107">
        ...
        >
          Wasza dostojność
        </span>. Powiedziałem kucharzowi, że ptaki te pochodzą od pani <span 
          className="character-highlighted" 
          data-character="Sara" 
          data-src-listening="/Pharaon/sara-listens.mp4"
        >
          Sary
        </span>; więc on tylko dla <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          waszej dostojności
        </span> robił z nich pieczenie i pasztety.
      </p>
      <p data-index="108">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— A niechże was krokodyl pożre! — zawołał skłopotany <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
      ...
      <p data-index="109">
        Kazał przyjść do siebie <span 
          className="character-highlighted" 
          data-character="Tutmozis" 
          data-src-listening="/Pharaon/tutmozis-listens.mp4"
        >
          Tutmozisowi
        </span> i jego natychmiast wysłał do <span 
          className="character-highlighted" 
          data-character="Sara" 
          data-src-listening="/Pharaon/sara-listens.mp4"
        >
          Sary
        </span>. Opowiedział mu historią z gołębiami i ciągnął:
      </p>
      <p data-index="110">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="111">
        <span 
          ...
          data-src-talking="/Pharaon/ksiaze-ramzes-speaks.mp4" 
          data-is-talking="true"
        />\n— Ale, ale… namów ją też, aby odsunęła od siebie choć trochę Żydów, a przyjęła choć paru Egipcjan i Egipcjanek. Nie chcę, aby mój syn przyszedł na świat w tym towarzystwie i może jeszcze bawił się z żydowskimi dziećmi. Nauczyliby go podawać <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          ojcu
        </span> najgorsze daktyle!…
      </p>
    </section>
  );
};
