...
export const Chapter28: React.FC = () => {
  return (
    <section data-chapter="28">
      ...
      <p data-index="1">Kiedy wieczorem kapłani i następca wrócili na dziedziniec, zapalono kilkaset pochodni tak jasnych, że było widno jak w dzień.</p>
      <p data-index="2">
        Na znak{" "}
      ...
      <p data-index="5">
        Za dziewiętnastej dynastii mieszkało tam dwadzieścia tysięcy ludzi, którzy płacili podatku trzysta pięćdziesiąt talentów rocznie. Dziś mieszka zaledwie piętnaście tysięcy,
        i ci, naturalnie, płacą na rzecz skarbu tylko dwieście siedemdziesiąt talentów. Tymczasem faraon, zamiast dwustu siedemdziesięciu, otrzymuje sto siedemdziesiąt talentów!…
      </p>
      <p data-index="6">
      ...
      <p data-index="7">
        Za dziewiętnastej dynastii było w powiecie około stu urzędników i ci brali po tysiąc drachm rocznej pensji. Dziś na tym samym terytorium, pomimo ubytku ludności, znajduje
        się przeszło dwustu urzędników, którzy biorą po dwa tysiące pięćset drachm na rok.
      </p>
      <p data-index="8">
        Jego dostojności{" "}
        <span className="character-highlighted" data-character="Herhor" data-src-listening="/Pharaon/herhor-listens.mp4">
      ...
      <p data-index="11">Wielkie milczenie panowało wśród dostojników: niejeden bowiem miał krewnego na urzędzie, w dodatku dobrze płatnym.</p>
      <p data-index="12">
        Ale{" "}
        <span className="character-highlighted" data-character="Pentuer" data-src-listening="/Pharaon/pentuer-listens.mp4">
          Pentuer
      ...
      <p data-index="18">Z ust obecnych wyrwał się okrzyk zdziwienia. Mieli przed sobą jasno oświetlony żywy obraz, do którego wchodziło około stu figurantów.</p>
      <p data-index="19">
        Obraz dzielił się na trzy kondygnacje: dolną, gdzie stali rolnicy, wyższą — urzędnicy, i najwyższą, gdzie znajdował się złoty tron faraona oparty na dwu lwach, których
      ...
      <p data-index="20">
        ...
        Ich żony zajmują się przygotowywaniem pokarmu i odzieży lub myciem sprzętów dla rodziny; dzieci — bawią się lub chodzą do szkoły.
      </p>
      <p data-index="21">
        Ówczesny chłop, jak widzicie, jadał chleb pszenny, bób, mięso, ryby i owoce, a pijał piwo i wino. Spojrzyjcie, jak piękne były dzbany i misy! Przypatrzcie się czepkom,
        fartuszkom i pelerynom mężczyzn: wszystko ozdobione różnokolorowym haftem. Jeszcze piękniej haftowano koszule kobiet… A czy uważacie, jak one starannie czesały się, jakie
        nosiły szpilki, zausznice, pierścienie i bransolety? Ozdoby te są robione z brązu i kolorowej emalii; trafia się jednak między nimi i złoto, choćby w postaci drucika.
      </p>
      <p data-index="22">
        Podnieście teraz oczy wyżej, na urzędników. Chodzą oni w pelerynach, ale każdy chłop w dniu świątecznym przywdziewał taką samą. Żywią się zupełnie tak samo jak chłopi, to
        jest dostatnio, ale skromnie. Sprzęty mają trochę ozdobniejsze od chłopskich i częściej trafiają się w ich skrzyniach złote pierścienie. Podróże odbywają na osłach lub
      ...
      <p data-index="23">
        ...
        przedmioty najpiękniejsze i najkosztowniejsze odsunęli wyżej, dla tronu. Platforma, gdzie znajdował się symbol władzy faraona, była zasypana produktami tworzącymi jakby
        pagórek.
      </p>
      <p data-index="24">
      ...
      <p data-index="27">
        Nie widać przy nich wołów ani osłów, bo i na co, jeżeli pług ich ciągnie żona i dzieci?… Ich motyki i łopaty są drewniane, co łatwo psuje się i powiększa pracę. Odzieży nie
        mają żadnej, tylko kobiety chodzą w grubych koszulach i nawet we śnie nie widują tych haftów, jakimi stroili się ich dziadowie i babki.
      </p>
      <p data-index="28">
        Spojrzyjcie, co jada chłop. Czasem jęczmień i suszone ryby, zawsze ziarna lotosu, rzadko pszenny placek, nigdy mięsa, piwa lub wina. Spytacie: gdzie podziały się jego
        naczynia i sprzęty? Nie ma żadnych prócz dzbanka na wodę, bo też i nic więcej nie zmieściłoby się w norze, którą zamieszkuje…
      </p>
      <p data-index="29">
        Przebaczcie mi to, na co teraz zwrócę waszą uwagę. Tam kilkoro dzieci leżą na ziemi: oznacza to, że pomarły… Dziwna rzecz, jak często teraz umierają chłopskie dzieci — z
        głodu i pracy! I te są jeszcze najszczęśliwsze: inne bowiem, które zostały przy życiu, idą pod kij dozorcy albo sprzedają się Fenicjanom niby jagnięta…
      </p>
      ...
      <p data-index="32">
        ...
        <a href="#fn203" className="link-note"></a> ustawiali obok tronu, ale — w ilości znacznie mniejszej. Na kondygnacji królewskiej już nie było pagórka produktów. Za to
      ...
      <p data-index="34">
        Dał znak i stała się rzecz nieoczekiwana. Jakieś ręce poczęły zabierać: zboże, owoce, tkaniny z platformy faraona i urzędników. A gdy ilość towarów bardzo zmniejszyła się,
      ...
      <p data-index="38">— Tak!… To szakale!… Przekleństwo im!… Wygnać nędzników!… — wołali kapłani. — Oni to najwięcej szkód wyrządzają państwu…</p>
      <p data-index="39">Nie wszyscy jednak wołali w ten sposób.</p>
      <p data-index="40">
        Gdy ucichło,{" "}
        <span className="character-highlighted" data-character="Pentuer" data-src-listening="/Pharaon/pentuer-listens.mp4">
          Pentuer
      ...
      <p data-index="43">
        Albo sprzęty: to krzesełko wyłożone jest dziesięcioma tysiącami kawałków złota, perłowej masy i kolorowych drzew… Zobaczcie ówczesne szaty: jaki haft, jaka delikatność
        tkanin, ile kolorów… A miecze brązowe, a szpilki, bransolety, zausznice, a narzędzia rolnicze i rzemieślnicze… Wszystko to robione u nas, za dziewiętnastej dynastii.
      </p>
      ...
      <p data-index="51">
        ...
        sami wyręczają go w wypłacie w ten sposób, że dłużnik, za każdy talent pożyczony, oddaje im w dzierżawę, na trzy lata, trzydziestu dwu ludzi i dwie miary ziemi…
      </p>
      <p data-index="52">
      ...
      <p data-index="56">
        Czy wy oceniacie, dostojni, całą nikczemność Fenicjan w podobnym handlu? Ten mały kawałek złota naprawdę nie posiada żadnych cennych zalet: jest żółty, ciężki, nie
        śniedzieje i — na tym koniec. Ale człowiek nie odzieje się złotem i nie zaspokoi nim głodu ani pragnienia… Gdybym posiadał bryłę złota wielkości piramidy, będę obok niej
        takim nędzarzem jak Libijczyk błąkający się po zachodniej pustyni, gdzie nie ma daktyla ani wody.
      </p>
      <p data-index="57">
        I patrzcie, za bryłkę tego jałowego materiału Fenicjanin bierze kawał ziemi, który może wykarmić i odziać trzydziestu dwu ludzi, a nadto — bierze i tych ludzi!… Przez lat
        trzy uzyskuje władzę nad istotami, które umieją uprawiać i obsiewać grunta, zbierać ziarno, robić mąkę i piwo, tkać odzież, budować domy i sprzęty…
      </p>
      <p data-index="58">
        Jednocześnie faraon czy nomarcha jest pozbawiony na trzy lata usług tych ludzi. Nie płacą mu oni podatku, nie noszą ciężarów za wojskiem, lecz pracują na dochody łakomego
        Fenicjanina.
      </p>
      <p data-index="59">
        Wiecie, dostojnicy, że obecnie nie ma roku, ażeby w tym czy owym nomesie nie wybuchnął bunt chłopów, wyniszczonych głodem, przeciążonych pracą, bitych kijami. I otóż część
        tych ludzi ginie, inni dostają się do kopalń, a kraj wyludnia się coraz bardziej, dlatego tylko że Fenicjanin dał komuś bryłkę złota!… Czy można wyobrazić sobie większe
        nieszczęście?… I czy w podobnych warunkach Egipt nie będzie co roku tracił ziemi i ludzi? Szczęśliwe wojny podkopały nasz kraj, ale dobija go fenicki handel złotem.
      </p>
      ...
      <p data-index="62">
        ...
        zalewających ojczyznę.
      </p>
      <p data-index="63">
        Skarb faraonów był wówczas pełny, gdy mieliśmy dużo ziemi i ludności. Trzeba zatem wydrzeć pustyni te grunta urodzajne, jakie nam pożarła, a z ludu zdjąć te ciężary, które
      ...
      <p data-index="65">
        ...
        przed wojnami dziewiętnastej dynastii, jeżeli pragniesz, aby faraon, jego pisarze i wojsko opływali w dostatki, zapewnij krajowi długoletnią spokojność, a ludowi dobrobyt.
        Niech znowu dorośli jedzą mięso i ubierają się w haftowane szaty, i niech dzieci, zamiast jęczeć pod plagami i umierać z pracy, bawią się lub chodzą do szkoły.
      </p>
      ...
      <p data-index="77">
        ...
        <a href="#fn207" className="link-note"></a>.
      </p>
      <p data-index="78">
      ...
      <p data-index="84">
        Na ich widok błyskawica oświeciła umysł następcy: prawie utracił przytomność ze wzruszenia. Egipt potrzebuje ludzi, dużo ludzi, setki tysięcy, a nawet milion i dwa miliony
        ludzi… I otóż ludzie są!… Trzeba tylko wkroczyć do Azji, zabierać wszystko, co się spotka na drodze i — odsyłać do Egiptu… Dopóty zaś nie kończyć wojny, dopóki nie zbierze
        się tylu, ażeby każdy chłop egipski miał swego niewolnika…
      </p>
      <p data-index="85">
      ...
      <p data-index="88">Z czego wypadłoby, że za pomocą nowej wojny nie można podźwignąć Egiptu.</p>
      <p data-index="89">
        „
        <span className="character-highlighted" data-character="Pentuer" data-src-listening="/Pharaon/pentuer-listens.mp4">
          Pentuer
      ...
      <p data-index="92">Kapłani, ludzie najmędrsi i najświętsi!</p>
      <p data-index="93">
      ...
      <p data-index="101">— Tak, nie wolno nikomu zdradzać świętych tajemnic… Rozumie się… Przed każdą większą uroczystością przypominamy to młodym kandydatom na kapłanów…</p>
      <p data-index="102">
      ...
      <p data-index="105">
        — Pewien kapłan egipski, zwiedzając świątynie pogańskiego kraju Aram<a href="#fn210" className="link-note"></a>, przy jednej z nich spotkał człowieka, który wydał mu się
      ...
      <p data-index="111">
        Że oni łudzą prostaków, o tym wiedział. Pamiętał przecie, będąc w kapłańskiej szkole, procesję świętego wołu Apisa. Lud był pewny, że Apis prowadzi kapłanów; tymczasem
      ...
      <p data-index="116">Przede wszystkim jasno pojmował, czego potrzeba Egiptowi: więcej gruntów i więcej ludzi.</p>
      <p data-index="117">
      ...
      <p data-index="121">
        A jeżeli bóstwa nie pozwalają profanom zbliżać się do swoich ołtarzy, jeżeli tak pilnie czuwają nad świątyniami, dlaczego nie mieliby czuwać nad Egiptem, który jest
        największą ich świątynią?
      </p>
      <p data-index="122">
      ...
      <p data-index="123">Czy wojna z Azją naprawdę mogłaby zaszkodzić Egiptowi?</p>
      <p data-index="124">Czy kapłani w tej sprawie mogliby oszukiwać jego, następcę faraona?</p>
    </section>
  );
};
