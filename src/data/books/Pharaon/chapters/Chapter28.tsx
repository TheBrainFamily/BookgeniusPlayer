...
export const Chapter28: React.FC = () => {
  return (
    <section data-chapter="28">
      ...
      <p data-index="2">
        ...
        >
          Mefresa
        </span> znowu wystąpiła procesja muzykantów, tancerek i młodszych kapłanów z posągiem bogini Hator z krowią głową. A gdy odpędzono złe duchy, <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
          Pentuer
        </span> znowu zaczął kazanie.
      </p>
      <p data-index="3">
        <span 
      ...
      <p data-index="4">
        Za przykład opowiem wam, co jego dostojność <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
          Herhor
        </span> odkrył w powiecie Zajęczym<a href="#fn201" className="link-note"></a>.
      </p>
      <p data-index="5">
      ...
      <p data-index="6">
        — Dlaczego?… — spytał dostojny <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
          Herhor
        </span> — a oto, co pokazało śledztwo.
      </p>
      <p data-index="7">
      ...
      <p data-index="8">
        Jego dostojności <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
          Herhorowi
        </span> nie wiadomo, czy tak jest w każdym powiecie. To przecież pewne, że skarb faraona, zamiast dziewięćdziesięciu ośmiu, ma tylko siedemdziesiąt cztery tysiące talentów rocznie…
      </p>
      <p data-index="9">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-is-talking="true"
        />\n— Powiedz, ojcze święty: pięćdziesiąt tysięcy… — wtrącił <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
      ...
      <p data-index="10">
        <span 
          ...
          data-src-talking="/Pharaon/pentuer-speaks.mp4" 
          data-is-talking="true"
        />\n— I to objaśnię — odparł kapłan. — W każdym razie zapamiętaj, <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          książę
        </span>, iż skarb faraona oddaje dziś dwadzieścia cztery tysiące talentów urzędnikom, gdy za dynastii dziewiętnastej wydawał tylko dziesięć tysięcy.
      </p>
      <p data-index="11">
      ...
      <p data-index="16">
        ...
        >
          Pentuer
        </span> po stopniach amfiteatru zeszedł na dziedziniec, a za nim <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
        ...
        >
          Mefres
        </span> i reszta kapłanów.
      </p>
      <p data-index="17">
        Zatrzymali się przed długą zasłoną z mat, która tworzyła jakby parkan. Na znak <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
          Pentuera
        </span> przybiegło kilkunastu młodych kapłanów z jarzącymi pochodniami. Drugi znak — i część zasłony spadła.
      </p>
      <p data-index="18">
      ...
      <p data-index="23">
        ...
        >
          Pentuer
        </span> klasnął i w żywym obrazie zapanował ruch. Chłopi zaczęli podawać urzędnikom kosze winogron, wory jęczmienia, grochu i pszenicy, dzbany wina, piwa, mleka i miodu, mnóstwo zwierzyny i liczne sztuki białych lub kolorowych tkanin. Urzędnicy odebrali te produkta<a href="#fn202" className="link-note"></a>, część ich zostawiali sobie, ale przedmioty najpiękniejsze i najkosztowniejsze odsunęli wyżej, dla tronu. Platforma, gdzie znajdował się symbol władzy faraona, była zasypana produktami tworzącymi jakby pagórek.
      </p>
      <p data-index="24">
        <span 
          className="character-placeholder character-talking" 
          ...
          data-src-talking="/Pharaon/pentuer-speaks.mp4" 
          data-is-talking="true"
        />\n— Widzicie, dostojni — rzekł <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
          Pentuer
        </span> — że w owych czasach, kiedy chłopi byli syci i zamożni, skarb jego świątobliwości ledwo mógł pomieścić dary poddanych. A teraz zobaczcie: co jest dzisiaj…
      </p>
      <p data-index="25">
      ...
      <p data-index="26">
        <span 
          ...
          data-src-talking="/Pharaon/pentuer-speaks.mp4" 
          data-is-talking="true"
        />\n— Oto są teraźniejsi chłopi — mówił <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
          Pentuer
        </span>, a w głosie jego czuć było wzburzenie. — Ciało ich składa się ze skóry i kości, wyglądają jak chorzy, są brudni i już zapomnieli namaszczać się oliwą. Za to grzbiety ich są poranione kijami.
      </p>
      <p data-index="27">
      ...
      <p data-index="33">
        <span 
          ...
          data-src-talking="/Pharaon/pentuer-speaks.mp4" 
          data-is-talking="true"
        />\n— Oto jest Egipt dzisiejszy — mówił <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
          Pentuer
        </span>. — Nędzni chłopi, bogaci pisarze, skarb nie tak pełny jak dawniej. A teraz…
      </p>
      <p data-index="34">
      ...
      <p data-index="37">
        <span 
          ...
          data-src-talking="/Pharaon/pentuer-speaks.mp4" 
          data-is-talking="true"
        />\n— Tak jest, święci ojcowie — rzekł <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
          Pentuer
        </span>. — To są ręce ukrytych między nami Fenicjan. Obdzierają oni króla i pisarzy, a chłopów zabierają w niewolę, gdyż im już nic wydrzeć nie można…
      </p>
      <p data-index="38">
      ...
      <p data-index="40">
        ...
        >
          Pentuer
        </span> kazał zanieść pochodnie w inną stronę dziedzińca i tam zaprowadził swoich słuchaczy. Nie było tu żywych obrazów, ale jakby wystawa przemysłowa.
      </p>
      <p data-index="41">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="54">
        <span 
          ...
          data-src-talking="/Pharaon/pentuer-speaks.mp4" 
          data-is-talking="true"
        />\n— Powiedziałem, że dwie miary gruntu i trzydziestu dwu ludzi bierze Fenicjanin na trzy lat<a href="#fn204" className="link-note"></a> dzierżawy, za pożyczenie jednego talentu złotem. Przypatrzcie się, jaki to kawał ziemi i jaka gromada ludzi, a teraz — spojrzyjcie na moją rękę…
      </p>
      <p data-index="55">
      ...
      <p data-index="61">
        ...
        >
          Pentuer
        </span> chwilę odpoczął, potem zwrócił się do <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
      ...
      <p data-index="64">
        Kapłani znowu zaczęli się niepokoić z obawy, aby <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
          Pentuer
        </span> po raz drugi nie wspomniał o klasie pisarzy.
      </p>
      <p data-index="65">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="70">
        Uciszył ich arcykapłan <span 
          className="character-highlighted" 
          data-character="Mefres" 
          data-src-listening="/Pharaon/mefres-listens.mp4"
        >
          Mefres
        </span>, który ze łzami w oczach zwrócił się do <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
      ...
      <p data-index="73">
        Przeciągły okrzyk reszty słuchaczów<a href="#fn205" className="link-note"></a> poparł błogosławieństwo najwyższego dostojnika. Kapłani tym więcej byli zadowoleni, że nieustannie wisiała nad nimi trwoga, aby <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
          Pentuer
        </span> po raz drugi nie zaczepił o kwestię pisarzy. Ale mędrzec umiał być powściągliwym: wskazał wewnętrzną ranę państwa, lecz nie zaognił jej i dlatego odniósł zupełny triumf.
      </p>
      <p data-index="74">
        <span 
          className="character-highlighted" 
        ...
        >
          Ramzes
        </span> nie dziękował <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
          Pentuerowi
        </span>, tylko przytulił jego głowę do swej piersi. Nikt jednak nie wątpił, że kazanie wielkiego proroka wstrząsnęło duszę następcy i jest ziarnem, z którego może wyrosnąć chwała i pomyślność Egiptu.
      </p>
      <p data-index="75">
        Nazajutrz <span 
          className="character-highlighted" 
        ...
        >
          Pentuer
        </span>, nie żegnając się, o wschodzie słońca opuścił świątynię i odjechał do Memfis.
      </p>
      <p data-index="76">
        <span 
          className="character-highlighted" 
        ...
        >
          Ramzes
        </span> przez kilka dni z nikim nie rozmawiał: siedział w celi albo przechadzał się po cienistych korytarzach i rozmyślał. W jego duszy odbywała się praca.
      </p>
      <p data-index="77">
        W gruncie rzeczy <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
          Pentuer
        </span> nie powiedział nic nowego: wszyscy narzekali na ubytek ziemi i ludności w Egipcie, na nędzę chłopów, nadużycia pisarzów<a href="#fn206" className="link-note"></a> i wyzysk Fenicjan. Ale kazanie proroka uporządkowało w nim dotychczasowe bezładne wiadomości, nadało dotykalne formy i lepiej oświetliło pewne fakta<a href="#fn207" className="link-note"></a>.
      </p>
      <p data-index="78">
        Fenicjanie przerazili go: <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          książę
        </span> nie oceniał dotychczas ogromu nieszczęść wyrządzonych przez ten naród jego państwu. Zgroza była tym silniejszą, że przecie on sam własnych poddanych wypuścił w dzierżawę <span 
          className="character-highlighted" 
          data-character="Dagon" 
          data-src-listening="/Pharaon/dagon-listens.mp4"
        >
          Dagonowi
        </span> i — był świadkiem, w jaki sposób bankier wybierał od nich należności!…
      </p>
      <p data-index="79">
        Lecz to splątanie <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          księcia
        </span> z wyzyskiem Fenicjan wywołało dziwny skutek: <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> — nie chciał myśleć o Fenicjanach, a ile razy zapalił się w nim gniew na tych ludzi, tyle razy gasiło go uczucie wstydu. W pewnej części był on ich wspólnikiem.
      </p>
      <p data-index="80">
        Natomiast <span 
          className="character-highlighted" 
        ...
        >
          książę
        </span> doskonale zrozumiał ważność ubytku ziemi i ludności i na te punkta<a href="#fn208" className="link-note"></a> położył główny nacisk w swych samotnych medytacjach.
      </p>
      <p data-index="81">
      ...
      <p data-index="83">
        Wypadek nasunął mu odpowiedź. Pewnego wieczora <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          książę
        </span> przechadzając się po ogrodach świątyni spotkał gromadę niewolników, których jenerał<a href="#fn209" className="link-note"></a> Nitager pochwycił na granicy wschodniej i przysłał bogini Hator. Ludzie ci byli doskonale zbudowani, pracowali więcej niż Egipcjanie, a ponieważ ich karmiono dobrze, więc byli nawet zadowoleni ze swego losu.
      </p>
      <p data-index="84">
      ...
      <p data-index="86">
        ...
        >
          Książę
        </span> był zachwycony, choć następnego dnia zbudziła się w nim nowa wątpliwość.
      </p>
      <p data-index="87">
        <span 
          className="character-highlighted" 
        ...
        >
          Pentuer
        </span> z wielkim naciskiem głosił, a jeszcze dawniej <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
          Herhor
        </span> twierdził to samo, że źródłem nieszczęść Egiptu były — zwycięskie wojny.
      </p>
      <p data-index="88">
      ...
      <p data-index="89">
        ...
        >
          Pentuer
        </span> jest wielki mędrzec i <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
          Herhor
        </span> wielki mędrzec — myślał <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          książę
        </span>. — Jeżeli oni uważają wojnę za szkodliwą, jeżeli tak samo sądzi arcykapłan <span 
          className="character-highlighted" 
          data-character="Mefres" 
          data-src-listening="/Pharaon/mefres-listens.mp4"
        >
          Mefres
        </span> i inni kapłani, to może naprawdę wojna jest rzeczą niebezpieczną?…
      </p>
      <p data-index="90">
      ...
      <p data-index="91">
        ...
        >
          Książę
        </span> był głęboko strapiony. Wymyślił prosty sposób podźwignięcia Egiptu, a tymczasem kapłani utrzymywali, że właśnie to mogłoby do reszty zrujnować Egipt.
      </p>
      <p data-index="92">
        Kapłani, ludzie najmędrsi i najświętsi!
      </p>
      <p data-index="93">
        Lecz trafił się wypadek, który nieco ochłodził wiarę <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          księcia
        </span> w prawdomówność kapłanów, a raczej — rozbudził w nim dawniejszą do nich nieufność.
      </p>
      <p data-index="94">
      ...
      <p data-index="98">
        — Aha!… — odparł lekarz. — Jest tu loch, do którego przed kazaniem <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
          Pentuera
        </span> wlewaliśmy roztopioną smołę…
      </p>
      <p data-index="99">
        <span 
          className="character-placeholder character-talking" 
      ...
      <p data-index="100">
        Lekarz uśmiechnął się. Był to człowiek dobry i wesoły. Toteż widząc oburzenie <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          księcia
        </span>, rzekł po pewnym namyśle:
      </p>
      <p data-index="101">
      ...
      <p data-index="102">
        Ton jego był tak szczególny, że <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> zażądał objaśnień.
      </p>
      <p data-index="103">
      ...
      <p data-index="104">
        ...
        >
          Ramzes
        </span> przyrzekł, lekarz opowiedział:
      </p>
      <p data-index="105">
        — Pewien kapłan egipski, zwiedzając świątynie pogańskiego kraju Aram<a href="#fn210" className="link-note"></a>, przy jednej z nich spotkał człowieka, który wydał mu się bardzo tłustym i zadowolonym, choć nosił nędzne szaty.
      </p>
      <p data-index="106">
      ...
      <p data-index="109">
        Tak bywa w pogańskim kraju Aram — zakończył lekarz, kładąc palec na usta. — Pamiętaj, <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          książę
        </span>, coś mi obiecał i myśl o naszej smole roztopionej, co ci się podoba…
      </p>
      <p data-index="110">
        Opowiadanie to znowu poruszyło <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          księcia
        </span>. Czuł pewną ulgę, że w świątyni nie zamordowano człowieka, lecz i ocknęły się w nim wszystkie dawne podejrzenia do kapłanów.
      </p>
      <p data-index="111">
      ...
      <p data-index="113">
        ...
        >
          książę
        </span> miał silne poszlaki, że chciano go oszukać. Już był oszustwem człowiek jęczący w podziemiach, niby to oblewany smołą przez kapłanów. Ale mniejsza o niego. Ważnym było to, o czym <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          książę
        </span> przekonał się niejednokrotnie, że <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
          Herhor
        </span> nie chciał wojny. <span 
          className="character-highlighted" 
          data-character="Mefres" 
          data-src-listening="/Pharaon/mefres-listens.mp4"
        >
          Mefres
        </span> także nie chciał wojny, a <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
          Pentuer
        </span> był jednego pomocnikiem, drugiego ulubieńcem.
      </p>
      <p data-index="114">
        Taka walka toczyła się w <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          księciu
        </span>: to zdawało mu się, że wszystko rozumie, to znowu ogarniała go ciemność; raz był pełen nadziei, drugi raz wątpił o wszystkim. Z godziny na godzinę, z dnia na dzień dusza jego przybierała i opadała jak wody Nilu przez ciąg całego roku.
      </p>
      <p data-index="115">
        Powoli jednak <span 
          className="character-highlighted" 
        ...
        >
          Ramzes
        </span> odzyskał równowagę, a gdy nadszedł czas opuszczenia świątyni, miał już sformułowane pewne poglądy.
      </p>
      <p data-index="116">
        Przede wszystkim jasno pojmował, czego potrzeba Egiptowi: więcej gruntów i więcej ludzi.
      </p>
      <p data-index="117">
        Po wtóre wierzył, że najprostszym sposobem zdobycia ludzi jest — wojna z Azją. <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
          Pentuer
        </span> jednak dowodził mu, że wojna może tylko powiększyć klęski państwa. Rodzi się tedy nowa kwestia: czy <span 
          className="character-highlighted" 
          data-character="Pentuer" 
          data-src-listening="/Pharaon/pentuer-listens.mp4"
        >
          Pentuer
        </span> mówił prawdę, czy kłamał?
      </p>
      <p data-index="118">
        Jeżeli mówił prawdę, pogrążał <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          księcia
        </span> w rozpaczy: <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> bowiem nie widział innego sposobu podźwignięcia państwa, tylko wojnę. Bez wojny Egipt z roku na rok będzie tracił ludność, a skarb faraona będzie powiększał swoje długi. Aż cały ten proces skończy się jakąś okropną katastrofą, może nawet za przyszłego panowania.
      </p>
      <p data-index="119">
        A jeżeli <span 
          className="character-highlighted" 
        ...
        >
          Pentuer
        </span> kłamał? Dlaczego by to robił? Oczywiście namówiony przez <span 
          className="character-highlighted" 
          data-character="Herhor" 
          data-src-listening="/Pharaon/herhor-listens.mp4"
        >
        ...
        >
          Mefresa
        </span> i całe ciało kapłańskie. Z jakiej jednak racji kapłani nie chcieli wojny, co mieli w tym za interes? Przecie każda wojna im i faraonowi największe przynosiła zyski.
      </p>
      <p data-index="120">
        Czy zresztą kapłani mogli go oszukiwać w sprawie tyle doniosłej? Prawda, że robili tak bardzo często, lecz w wypadkach drobnych, nie zaś kiedy chodziło o przyszłość i byt państwa. Nie można też twierdzić, że oszukiwali zawsze. Są oni przecie sługami bogów i stróżami wielkich tajemnic. W ich świątyniach mieszkają duchy, o czym <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> sam się przekonał pierwszej nocy po osiedleniu się w tym miejscu.
      </p>
      <p data-index="121">
      ...
      <p data-index="122">
        Gdy w kilka dni później <span 
          className="character-highlighted" 
          data-character="Ksiaze-Ramzes" 
          data-src-listening="/Pharaon/ksiaze-ramzes-listens.mp4"
        >
          Ramzes
        </span> po uroczystym nabożeństwie, wśród błogosławieństwa kapłanów, opuszczał świątynię Hator, nurtowały w nim dwa pytania:
      </p>
      <p data-index="123">
