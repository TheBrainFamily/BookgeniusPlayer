...
**Output HTML:**
```html
<p data-speaker="alice">'But they were <em>in</em> the well,' <span data-c="alice">Alice</span> said to the <span data-c="dormouse">Dormouse</span>, ignoring the remark.</p>
...
**Output HTML:**
```html
<p data-speaker="pani-parsons dzieci-parsons">— Sto lat! — zaśpiewała <span data-c="pani-parsons">pani Parsons</span> z <span data-c="dzieci-parsons">dziećmi</span>.</p>
```
