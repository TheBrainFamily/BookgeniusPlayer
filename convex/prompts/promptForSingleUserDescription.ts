export const promptForSingleUserDescription = (
  bookName: string,
  character: string,
  bookContext: string,
) => `# Task

Analyze the provided book ${bookName} context to extract and synthesize **purely physical descriptions** for the character ${character}. Focus _only_ on visual appearance.

## **Output Goal: Character-Centric Visual Guide**

Generate a JSON object containing the character ${character} visual guide. This guide is intended for generating static character portraits to help readers remember who is who.
